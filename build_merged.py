...
CH4_PUBS_EXTRA = """
  <h3 id="pubs-objects">Publications Platform — Key Objects Reference</h3>
  <p>Publications management spans two systems: <strong>Vault Publications</strong> (Veeva) and
  <strong>iEnvision / Datavision</strong> (independent SaaS platforms used by many pharma
  Medical Affairs teams for publication planning and submission tracking). Together they provide
  end-to-end traceability from publication plan through journal acceptance.</p>

  <div class="crm-obj-grid" style="margin:24px 0;">
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">📋</div>
        <div>
          <div class="crm-obj-name">Publication Plan</div>
          <div class="crm-obj-api">Vault Publications · iEnvision</div>
        </div>
      </div>
      <div class="crm-obj-desc">Annual strategic document listing all planned publications with:
      product, data source (trial, RWE, meta-analysis), publication type (manuscript, abstract,
      poster), target venue (journal or congress), planned submission date, status, and lead
      author. Reviewed and approved by Medical Affairs leadership at the start of each planning
      cycle. Drives resource allocation for medical writers and KOL authors.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">📝</div>
        <div>
          <div class="crm-obj-name">Manuscript / Abstract</div>
          <div class="crm-obj-api">Vault Publications · Document lifecycle</div>
        </div>
      </div>
      <div class="crm-obj-desc">The publication document itself, versioned through the full
      lifecycle: Draft → Author Review → Internal Review → Submission → Revision → Acceptance.
      Full audit trail maintained. All author revisions tracked with timestamps. Ghost-writing
      is prohibited under ICMJE guidelines — medical writers are acknowledged separately.
      Final accepted version archived and linked to MSL reprint orders.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">📬</div>
        <div>
          <div class="crm-obj-name">Submission Tracker</div>
          <div class="crm-obj-api">Vault Publications · iEnvision</div>
        </div>
      </div>
      <div class="crm-obj-desc">Tracks journal submission lifecycle: submission date, editorial
      decision (Accept / Revise / Reject), revision response deadline, final acceptance date,
      and publication DOI. Congresses tracked separately with abstract submission portal
      deadlines. Status feeds into the Publication Plan dashboard so Medical Affairs leadership
      has real-time visibility of the full publication portfolio.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">👩‍🔬</div>
        <div>
          <div class="crm-obj-name">Author Profile / COI</div>
          <div class="crm-obj-api">iEnvision · KOL author record</div>
        </div>
      </div>
      <div class="crm-obj-desc">KOL author record capturing ICMJE authorship criteria met
      (intellectual contribution, draft review, approval, accountability), financial disclosures,
      and Conflict of Interest (COI) declarations. COI declarations are collected per publication
      and per journal — requirements differ by journal. Required by all major journals and
      enforced by the ICMJE Recommendations. Linked to the HCP record in Veeva Network
      and Veeva CRM.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">📦</div>
        <div>
          <div class="crm-obj-name">Reprint Order</div>
          <div class="crm-obj-api">Veeva CRM · Medical call record</div>
        </div>
      </div>
      <div class="crm-obj-desc">Once a manuscript is accepted and published, MSLs can order
      reprints for unsolicited HCP dissemination. Reprint Orders are created in Veeva CRM
      (Medical call record type) and linked to the accepted manuscript in Vault Publications.
      Compliance rule: reprints may only be provided following an unsolicited request — proactive
      distribution to HCPs without a request constitutes promotional activity and is prohibited
      for MSLs. All reprint distributions are logged for Sunshine Act spend reporting.</div>
    </div>
  </div>

  <div class="callout callout-info" style="margin:24px 0;">
    <strong>ICMJE Authorship Standard:</strong> All listed authors must meet four criteria:
    (1) substantial contribution to conception or design, or data acquisition/analysis;
    (2) drafting or critically revising the manuscript; (3) final approval of the published
    version; (4) accountability for all aspects of the work. Contributors who meet only some
    criteria are acknowledged but not listed as authors. This rule exists specifically to
    prevent ghost-writing and honorary authorship.
  </div>
"""
...
<svg viewBox="0 0 1060 310" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;display:block;">
  ...
  <!-- title -->
  <text x="530" y="24" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700" letter-spacing="2" font-family="sans-serif">DRUG DEVELOPMENT PIPELINE</text>
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     R&D REGULATORY
     ═══════════════════════════════════════════════════════════════════════════ -->
<h2 id="ch2-rd-regulatory">R&amp;D Regulatory: The Compliance Backbone of Drug Development</h2>

<p>R&amp;D Regulatory Affairs is the function that translates scientific data into regulatory language and navigates the relationship between the pharmaceutical company and health authorities worldwide. Every IND, every protocol amendment, every safety report, every NDA module — Regulatory Affairs owns the strategy, the content, and the submission. Without this function, a molecule that cures disease cannot legally reach a single patient. Regulatory is also the function most directly exposed to legal, financial, and reputational risk: a rejected NDA, a Complete Response Letter, or an FDA Warning Letter can cost hundreds of millions of dollars and set a programme back by years.</p>

<h3 id="ch2-reg-strategy">Regulatory Strategy: Deciding the Path Before Running the Race</h3>
<p>Regulatory strategy is set before Phase I begins and is continuously revised through development. It answers the questions: Which health authority pathway? Which approval type? Which data package? What special designations might accelerate review?</p>

<div class="crm-obj-grid" style="margin:24px 0;">
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#0a1830">🗺️</div>
      <div>
        <div class="crm-obj-name">Regulatory Strategy Document (RSD)</div>
        <div class="crm-obj-api">Authored by Regulatory Affairs · Reviewed at each phase gate · Aligned with TPP</div>
      </div>
    </div>
    <div class="crm-obj-desc">The RSD is the master planning document for every regulatory interaction across a programme's lifecycle. It defines: target indication and patient population; proposed labelling language (the desired prescribing information before the FDA has reviewed it); submission sequence (US first? Simultaneous global? Rolling submission?); special designation strategy (Fast Track, Breakthrough, Priority Review, Accelerated Approval, Orphan Drug); health authority meeting schedule (Pre-IND, End-of-Phase-2, Pre-NDA); risk items and contingency plans. The RSD is a living document — every significant clinical finding, every health authority feedback, and every competitive approval triggers a review and possible revision.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#1a2500">🏷️</div>
      <div>
        <div class="crm-obj-name">Special Regulatory Designations</div>
        <div class="crm-obj-api">FDA programmes · Significant timeline and review advantages</div>
      </div>
    </div>
    <div class="crm-obj-desc"><strong>Fast Track Designation</strong> — allows rolling NDA submission (modules submitted as completed rather than waiting for the complete package); available when the drug treats a serious condition and may fill an unmet need. <strong>Breakthrough Therapy Designation (BTD)</strong> — intensive FDA guidance and collaboration throughout development; preliminary clinical evidence shows substantial improvement over available therapy on a clinically significant endpoint; most impactful designation for development speed and quality. <strong>Priority Review</strong> — review clock shortened from 12 months to 6 months; granted automatically with BTD or separately for drugs offering major advance. <strong>Accelerated Approval</strong> — approval based on a surrogate endpoint reasonably likely to predict clinical benefit; requires a confirmatory post-marketing trial; common in oncology. <strong>Orphan Drug Designation</strong> — disease affects fewer than 200,000 US patients; provides 7-year market exclusivity, 50% tax credit on clinical trial costs, reduced filing fees.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#2a1000">🌐</div>
      <div>
        <div class="crm-obj-name">Global Regulatory Sequencing</div>
        <div class="crm-obj-api">ICH harmonisation · Regional variations · Simultaneous global filing</div>
      </div>
    </div>
    <div class="crm-obj-desc">ICH (International Council for Harmonisation) guidelines — particularly ICH E6 (GCP), ICH E8 (clinical study design), ICH E9 (statistical principles), ICH M4 (CTD structure) — allow a single core data package to support submissions worldwide. However, regional requirements still differ: the EU requires a Marketing Authorisation Application (MAA) to EMA with a CHMP opinion; Japan requires a JNDA to PMDA often requiring bridging studies; China's NMPA requires domestic clinical data for many products. Regulatory Affairs must decide whether to pursue simultaneous global submission (maximises speed to all markets) or sequential (US approval first as anchor, then use FDA approval data to support ex-US submissions). The decision depends on commercial priority, data maturity, and available regulatory affairs resources.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#1a0a30">🤝</div>
      <div>
        <div class="crm-obj-name">Health Authority Meetings</div>
        <div class="crm-obj-api">Pre-IND · Type A/B/C meetings · End-of-Phase-2 · Pre-NDA</div>
      </div>
    </div>
    <div class="crm-obj-desc">Direct FDA meetings are among the most strategically important events in drug development. <strong>Pre-IND Meeting</strong> — before IND submission; aligns on pre-clinical data package adequacy and proposed Phase I design. <strong>End-of-Phase-2 (EOP2) Meeting (Type B)</strong> — the most critical meeting; FDA confirms whether Phase III design, endpoints, and statistical plan are adequate to support NDA; agreement at EOP2 is a near-guarantee that the Phase III programme will generate approvable data (if results are positive). <strong>Pre-NDA Meeting (Type B)</strong> — confirms submission package completeness, format requirements, and potential issues before the clock starts. <strong>Type A Meetings</strong> — dispute resolution, Complete Response Letter (CRL) meetings, fast-track rolling review meetings. All meeting requests, briefing documents, FDA responses, and minutes are formal regulatory records managed in Veeva RIM.</div>
  </div>
</div>

<h3 id="ch2-reg-clinical-ops">Regulatory Operations in Clinical Development</h3>
<p>During clinical development, Regulatory Affairs manages a continuous stream of submissions, amendments, and safety reporting obligations — all governed by 21 CFR Parts 312 (IND) and 314 (NDA) and ICH guidelines.</p>

<div class="crm-obj-grid" style="margin:24px 0;">
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#0a2020">📄</div>
      <div>
        <div class="crm-obj-name">IND Management &amp; Annual Reporting</div>
        <div class="crm-obj-api">21 CFR 312 · Continuous obligation from first-in-human through NDA</div>
      </div>
    </div>
    <div class="crm-obj-desc">Once an IND is open, the sponsor has continuous reporting obligations. <strong>IND Safety Reports (ISRs)</strong> — expedited 7-day or 15-day reports for unexpected serious adverse reactions (SUSARs) identified during any clinical trial under the IND, worldwide. <strong>IND Annual Report</strong> — submitted within 60 days of the IND anniversary; summarises all clinical activity, safety findings, non-clinical studies, manufacturing changes, and planned development activity. <strong>Protocol Amendments</strong> — required before any substantial change to a study protocol (new patient population, new endpoints, new dose levels); FDA has 30 days to put the amendment on clinical hold or it is automatically effective. <strong>Information Amendments</strong> — new chemistry/manufacturing/controls data, new non-clinical data, new investigator information. Each of these submissions becomes a permanent, inspection-ready part of the regulatory record managed in the Trial Master File and Veeva RIM.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#0a1820">🔬</div>
      <div>
        <div class="crm-obj-name">Clinical Trial Regulatory Package</div>
        <div class="crm-obj-api">Protocol, ICF, IB, IMPD — all must be approved before first patient enrolled</div>
      </div>
    </div>
    <div class="crm-obj-desc">For each clinical trial, Regulatory Affairs manages the preparation and approval of a core document package before the first patient can be enrolled. <strong>Clinical Protocol</strong> — the master study design document; defines objectives, endpoints, eligibility criteria, treatment plan, statistical analysis plan, and safety monitoring. <strong>Informed Consent Form (ICF)</strong> — approved by Institutional Review Board (IRB)/Ethics Committee; must reflect current Investigator's Brochure safety information; updated when new safety information emerges. <strong>Investigator's Brochure (IB)</strong> — comprehensive compilation of clinical and non-clinical data relevant to the study; updated annually; the reference safety document for ICF and SUSAR reporting. <strong>Investigational Medicinal Product Dossier (IMPD)</strong> — required in EU; covers quality/manufacturing data for the investigational product. These documents are stored in the eTMF and must be current, complete, and version-controlled at all times.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#200a10">🔴</div>
      <div>
        <div class="crm-obj-name">Safety Reporting: SUSAR &amp; DSUR</div>
        <div class="crm-obj-api">Global obligation · ICH E2A · 7-day and 15-day expedited reporting</div>
      </div>
    </div>
    <div class="crm-obj-desc"><strong>Suspected Unexpected Serious Adverse Reactions (SUSARs)</strong> are the most time-critical regulatory obligation in clinical development. A SUSAR is a serious adverse event that is both unexpected (not in the current IB reference safety information) and suspected to be causally related to the investigational product. Fatal or life-threatening SUSARs must be reported to FDA within 7 calendar days; all other SUSARs within 15 calendar days. The same SUSAR must be reported to ethics committees and investigators at all study sites. <strong>Development Safety Update Report (DSUR)</strong> — annual cumulative safety review for all IND studies; aligns with ICH E2F; submitted to FDA and all relevant health authorities. Pharmacovigilance and Regulatory Affairs jointly manage this process, with safety data flowing from the clinical database through signal detection systems to the regulatory submission workflows.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#1a1500">📊</div>
      <div>
        <div class="crm-obj-name">NDA/BLA Submission Architecture (CTD)</div>
        <div class="crm-obj-api">ICH M4 · Five-module Common Technical Document · eCTD format</div>
      </div>
    </div>
    <div class="crm-obj-desc">The NDA/BLA is structured as a <strong>Common Technical Document (CTD)</strong> — a globally harmonised five-module format. <strong>Module 1 (Regional)</strong> — cover letter, application form, proposed labelling (Draft Package Insert), patent certifications; jurisdiction-specific. <strong>Module 2 (Summaries)</strong> — quality overall summary, non-clinical overview and written summaries, clinical overview and clinical summary; the FDA reviewer's primary reading material. <strong>Module 3 (Quality)</strong> — complete chemistry, manufacturing, and controls data; drug substance and drug product characterisation, stability. <strong>Module 4 (Non-Clinical)</strong> — all pharmacology, ADME, and toxicology study reports. <strong>Module 5 (Clinical)</strong> — the largest module; all clinical study reports, statistical analysis results, individual patient data (where required), integrated summaries of efficacy (ISE) and safety (ISS). The NDA is submitted in <strong>eCTD format</strong> — a structured electronic format with a backbone XML file that enables FDA reviewers to navigate the submission, track lifecycle changes, and compare current versus prior submissions. A typical NDA for a small molecule runs 100,000–300,000 pages equivalent.</div>
  </div>
</div>

<h3 id="ch2-post-approval">Post-Approval Regulatory Obligations</h3>
<p>Regulatory responsibilities do not end at approval — they intensify in some respects. Post-approval, the regulatory function manages label changes, post-marketing studies, periodic safety reports, and the continuous obligation to maintain the approved registration in good standing across every market where the product is sold.</p>

<div class="crm-obj-grid" style="margin:24px 0;">
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#0a2010">📝</div>
      <div>
        <div class="crm-obj-name">Labelling Changes &amp; sNDA/sBLA</div>
        <div class="crm-obj-api">Prior Approval Supplement · CBE-30 · CBE-0 · Annual Report changes</div>
      </div>
    </div>
    <div class="crm-obj-desc">Any change to an approved drug's labelling, manufacturing process, or indications requires a submission to FDA. <strong>Prior Approval Supplement (PAS)</strong> — required for major changes (new indication, new patient population, significant manufacturing changes); FDA has 6–12 months to review. <strong>Changes Being Effected — 30-day (CBE-30)</strong> — moderate changes (new strength, new route of administration, labelling changes adding safety information); can be implemented after 30 days if no FDA objection. <strong>Changes Being Effected — 0-day (CBE-0)</strong> — changes that add or strengthen contraindication, warning, precaution, or adverse reaction information; can be implemented immediately, FDA reviews after the fact. <strong>Annual Report changes</strong> — minor changes (editorial corrections, typographical fixes) reported annually. New indication submissions trigger the full commercial planning cycle: new payer strategy, new formulary negotiations, new sales force training, new promotional material MLR review.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#1a0a20">🛡️</div>
      <div>
        <div class="crm-obj-name">PBRER / PSUR — Periodic Safety Reports</div>
        <div class="crm-obj-api">ICH E2C(R2) · Annual global submission · Risk-benefit assessment</div>
      </div>
    </div>
    <div class="crm-obj-desc">The <strong>Periodic Benefit-Risk Evaluation Report (PBRER)</strong>, known as the Periodic Safety Update Report (PSUR) in the EU, is submitted annually (or at intervals set by the health authority) and provides a comprehensive update on the benefit-risk profile of the approved product. It covers: post-marketing safety data, adverse event signal analysis, REMS/RMP status update (see below), labelling consistency review across markets, any new clinical data (post-approval studies, real-world evidence), and the sponsor's updated benefit-risk assessment. Pharmacovigilance generates the underlying safety analysis; Regulatory Affairs authors the report and manages submission logistics across all registered markets. In the EU, a single PSUR assessment procedure covers all EU member states through EMA's PSUR single assessment (PSUSA) process.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#200a00">⚠️</div>
      <div>
        <div class="crm-obj-name">REMS — Risk Evaluation and Mitigation Strategy</div>
        <div class="crm-obj-api">FDA-required · Communication plan · ETASU · Distribution restrictions</div>
      </div>
    </div>
    <div class="crm-obj-desc">A <strong>Risk Evaluation and Mitigation Strategy (REMS)</strong> is required by FDA when a drug's risks cannot be managed through labelling alone. REMS requirements range from a simple Medication Guide (a 2-page patient information document distributed with the drug at dispensing) to complex programmes with <strong>Elements to Assure Safe Use (ETASU)</strong> — prescriber certification, patient enrolment registries, pharmacy certification, laboratory monitoring requirements. Examples: isotretinoin (iPLEDGE programme — pregnancy testing before each prescription); clozapine (clozapine REMS — ANC monitoring before dispensing); opioids (REMS with ETASU for prescriber training). REMS programmes must be updated when the safety profile changes and are assessed for effectiveness on a schedule agreed with FDA. Regulatory Affairs owns the REMS programme; Commercial and Medical Affairs must ensure all field communications are REMS-compliant.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#1a1a00">🌍</div>
      <div>
        <div class="crm-obj-name">Global Registration Maintenance</div>
        <div class="crm-obj-api">Renewal cycles · Variations · Licence maintenance · Market withdrawal</div>
      </div>
    </div>
    <div class="crm-obj-desc">A product approved in 50 markets requires 50 separate registration records, each with its own renewal cycle, variation procedures, labelling language, and health authority relationship. <strong>Renewal submissions</strong> — EU Marketing Authorisations are issued for 5 years initially (then unlimited with an annual update); many other markets require annual or 5-year renewals with updated safety data. <strong>Variations</strong> — EU Type IA, IB, and II variations (analogous to CBE-0, CBE-30, and PAS in the US) manage changes to the marketing authorisation after approval. <strong>Labelling harmonisation</strong> — ensuring that the core safety information in the Reference Safety Information (RSI) is reflected in all country-specific labels; a change to the RSI (e.g., a new contraindication based on post-marketing data) must be propagated to all country labels through their respective variation procedures. Regulatory Information Management (RIM) systems like Veeva RIM track all of these deadlines, dossier versions, and submission statuses to prevent registration lapse.</div>
  </div>
</div>

<h3 id="ch2-etmf">Veeva Vault eTMF — The Trial Master File System</h3>

<p>The <strong>Trial Master File (TMF)</strong> is the collection of essential documents that, individually and collectively, permits the evaluation of the conduct of a trial and the quality of the data produced. ICH E6(R2) GCP defines what must be in the TMF — Veeva Vault eTMF is the system that manages it. An adequate, inspection-ready TMF is a legal requirement: FDA, EMA, and other health authorities inspect the TMF to verify that the trial was conducted in accordance with GCP, the approved protocol, and applicable regulatory requirements. A deficient TMF is grounds for data rejection — meaning the entire clinical programme could be invalidated.</p>

<div class="crm-obj-grid" style="margin:24px 0;">
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#0a1830">📁</div>
      <div>
        <div class="crm-obj-name">Vault eTMF — Core Architecture</div>
        <div class="crm-obj-api">Document management · TMF Reference Model · DIA TMF standard</div>
      </div>
    </div>
    <div class="crm-obj-desc">Veeva Vault eTMF is built on the <strong>DIA/TMF Reference Model</strong> — the industry-standard taxonomy that defines the structure, naming, and content of the TMF. The three-level hierarchy maps the TMF: <strong>Zone</strong> (1–5: Trial Management; Central Trial Documents; Regulatory; IRB/IEC; Site Management) → <strong>Section</strong> (e.g., Zone 1 / Section 1.1 — Plans, 1.2 — Subject Enrolment) → <strong>Artifact</strong> (the specific document type, e.g., Artifact 1.2.1 — Site Enrolment Log). Each Artifact in Vault eTMF has: document type (linked to the TMF Reference Model artifact), study, country, site, version, expected date, received date, and completeness status. Vault eTMF tracks not just what documents exist but what documents are <strong>expected and missing</strong> — the Completeness Score gives the quality assurance team a real-time view of TMF health across every study and site.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#002820">🗂️</div>
      <div>
        <div class="crm-obj-name">Key TMF Document Types by Zone</div>
        <div class="crm-obj-api">Zone 1–5 · Study-level, Country-level, Site-level documents</div>
      </div>
    </div>
    <div class="crm-obj-desc"><strong>Zone 1 — Trial Management:</strong> Trial Master Plan, Trial Management Plan, Monitoring Plan, Data Management Plan, Statistical Analysis Plan, Medical Monitoring Plan, Risk Register, communication logs. <strong>Zone 2 — Central Trial Documents:</strong> Protocol (all versions), Protocol Amendments, ICF (master version), Investigator's Brochure (all versions), IMPD, Insurance Certificate, Pharmacovigilance Agreement. <strong>Zone 3 — Regulatory:</strong> IND (initial and amendments), FDA correspondence, meeting minutes, import/export licences. <strong>Zone 4 — IRB/Ethics Committee:</strong> initial approval, annual renewals, waiver of consent (if applicable), adverse event reporting to IRB. <strong>Zone 5 — Site Management:</strong> Site Initiation Visit report, monitoring visit reports, Protocol Deviation logs, delegation of authority log, CV and GCP certificates for each investigator and sub-investigator, laboratory certification, informed consent forms (signed by each patient — stored locally at the site but referenced in eTMF).</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#1a0a30">⚡</div>
      <div>
        <div class="crm-obj-name">Real-Time TMF — The Shift from Lock to Live</div>
        <div class="crm-obj-api">ICH E6(R2) · Contemporary filing · Inspection-ready at all times</div>
      </div>
    </div>
    <div class="crm-obj-desc">ICH E6(R2) — the updated GCP guideline — introduced the concept of <strong>contemporary filing</strong>: TMF documents should be filed as they are generated, not after trial completion. This fundamentally changed the TMF from an archive assembled at study close-out into a live, continuously updated record. Vault eTMF operationalises this through: <strong>automated document routing</strong> from CROs, sites, and internal teams via the Vault API; <strong>real-time completeness dashboards</strong> showing expected versus filed documents by study, country, and site; <strong>automated overdues alerts</strong> when documents are not received within the expected timeframe; <strong>eTMF Exchange Standard (ETS)</strong> — an industry standard for electronic transfer of TMF documents between sponsors and CROs, enabling bidirectional synchronisation between the sponsor's Vault eTMF and the CRO's own system. Inspection-readiness is no longer a pre-inspection scramble — it is the continuous operating state.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#200a00">🔍</div>
      <div>
        <div class="crm-obj-name">Inspection Readiness &amp; QC in Vault eTMF</div>
        <div class="crm-obj-api">QC workflows · Completeness scoring · Inspection simulation</div>
      </div>
    </div>
    <div class="crm-obj-desc">Vault eTMF provides a structured QC workflow for ongoing TMF review. <strong>QC Review Tasks</strong> — assigned to Clinical Quality Assurance (CQA) reviewers by study, zone, or site; reviewers check document accuracy, completeness, and legibility; findings are tracked as QC Issues with owner assignment and due date. <strong>Completeness Dashboard</strong> — at-a-glance view of Filed/Expected/Missing/Overdue document counts at every level (global, study, country, site); exportable as a TMF Metrics Report for management review. <strong>Inspection Simulation</strong> — the TMF can be configured with an "inspector view" that replicates what an FDA or EMA inspector would see; teams use this to identify gaps before an actual inspection. <strong>Audit Trail</strong> — every document upload, version change, QC action, and user access is recorded in a 21 CFR Part 11-compliant audit trail; this is the chain of evidence that proves each document is the original, unaltered record. When an inspector arrives (electronically or in person), Vault eTMF generates a complete, organised dossier for any trial or site in minutes.</div>
  </div>
</div>

<h3 id="ch2-veeva-rim">Veeva Vault RIM — Regulatory Information Management</h3>

<p>Where Vault eTMF manages the clinical trial record, <strong>Veeva Vault RIM</strong> manages the regulatory record — every submission, every health authority interaction, every approved registration, and every obligation that flows from approval worldwide. RIM consolidates what was previously managed across Excel trackers, shared drives, email threads, and country-specific local systems into a single global regulatory intelligence platform. The consequence of a missed renewal, a mismanaged variation, or a lost health authority correspondence is a lapsed registration — a product that cannot legally be sold in that market.</p>
...
<div class="crm-obj-grid" style="margin:24px 0;">
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#0a1830">🧭</div>
      <div>
        <div class="crm-obj-name">Vault RIM — Submissions Module</div>
        <div class="crm-obj-api">eCTD authoring · Submission planning · Health authority publishing</div>
      </div>
    </div>
    <div class="crm-obj-desc">The Submissions module manages the entire lifecycle of a regulatory submission from planning through publishing. <strong>Submission Planning</strong> — the submission is created as a record with type (IND, NDA, BLA, MAA, sNDA), sequence number, target submission date, and responsible team. A submission hierarchy links all child submissions (amendments, supplements) to the parent submission. <strong>Content Planning</strong> — the eCTD module plan defines which documents are required for each CTD module; content items are assigned to authors with due dates; the submission manager tracks completeness against the plan. <strong>Document Authoring</strong> — regulatory authors draft Module 2 summaries, clinical overviews, and integrated summaries directly in Vault RIM or link to source documents from Vault eTMF, Vault Quality, and other systems. <strong>Publishing</strong> — the completed submission package is compiled into eCTD format using Vault's built-in publishing engine; the output is a validated eCTD submission ready for electronic delivery to the health authority via ESG (Electronic Submissions Gateway) for FDA or eCTD viewer/portal for other authorities.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#1a2500">📋</div>
      <div>
        <div class="crm-obj-name">Vault RIM — Registrations Module</div>
        <div class="crm-obj-api">Global registration tracking · Renewal management · Label repository</div>
      </div>
    </div>
    <div class="crm-obj-desc">The Registrations module is the authoritative global product registration database. For every product in every country, it tracks: <strong>Registration Record</strong> — product name, approved indication, dosage form, strength, route of administration, approval date, registration number, holder name, local affiliate. <strong>Renewal Schedule</strong> — renewal due date, last renewal submission date, grace period, assigned regulatory contact in-country; automated reminders fire well in advance of the renewal deadline. <strong>Approved Labelling</strong> — the current approved prescribing information and patient labelling for each country, version-controlled; when a label change is submitted, the new version is linked to the pending variation; upon approval, the new version is promoted to current. <strong>Condition of Approval Tracking</strong> — any post-approval commitments (post-marketing studies, REMS milestones, specific reporting obligations) are tracked as conditions linked to the registration record, with due dates and status. The Registrations module feeds directly into the Regulatory Intelligence and Labelling modules for cross-portfolio analysis.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#2a1000">📬</div>
      <div>
        <div class="crm-obj-name">Vault RIM — Health Authority Correspondence</div>
        <div class="crm-obj-api">Complete Response Letters · Meeting management · Commitment tracking</div>
      </div>
    </div>
    <div class="crm-obj-desc">Every formal communication with a health authority is captured and managed in Vault RIM as a Health Authority (HA) Correspondence record. <strong>Incoming correspondence</strong> (FDA Information Request, Additional Information Request, Complete Response Letter, Action Letter, Division Director Briefing) is logged, classified, and routed to the responsible reviewer with a response due date. <strong>Outgoing correspondence</strong> (meeting request packages, responses to Information Requests, commitment updates) is authored in Vault, reviewed through a workflow, and published. <strong>Meeting Management</strong> — for formal FDA meetings (Type A, B, C), Vault tracks: meeting request date, FDA acknowledgement date, meeting date, briefing document submission date, meeting minutes, action items, and response commitments. <strong>Commitment Tracking</strong> — every commitment made in a meeting, in a CRL response, or as a condition of approval is tracked as a Regulatory Commitment with due date, owner, and status. Automated alerts fire when commitments approach their due dates, protecting the company from inadvertent non-compliance.</div>
  </div>
  <div class="crm-obj-card">
    <div class="crm-obj-header">
      <div class="crm-obj-icon" style="background:#1a0a30">🏷️</div>
      <div>
        <div class="crm-obj-name">Vault RIM — Labelling Module</div>
        <div class="crm-obj-api">Global labelling repository · Core Data Sheet · Country-specific labels · Change management</div>
      </div>
    </div>
    <div class="crm-obj-desc">The Labelling module manages the lifecycle of all product labelling globally. <strong>Core Data Sheet (CDS)</strong> — the company's reference safety document; defines the minimum safety information that must appear in every country label; maintained by Global Regulatory and Pharmacovigilance; when the CDS is updated (new safety finding), the Labelling module automatically identifies which country labels are impacted and generates a variation workplan. <strong>Company Core Data Sheet (CCDS) vs. Country Label</strong> — the CCDS sets the floor; country labels may contain additional information required by local health authorities but must not contradict the CCDS. <strong>Labelling Change Control</strong> — all label changes follow a structured workflow: change request → impact assessment → authoring → Regulatory/Medical/Legal review → submission preparation → health authority review → approval → implementation. <strong>Structured Content Authoring (SCA)</strong> — newer implementations use XML-based structured authoring within Vault RIM to build labels from modular content blocks, enabling automated comparison of label versions and cross-country consistency checking.</div>
  </div>
</div>

<h3 id="ch2-etmf-rim-flow">How eTMF and RIM Work Together: The End-to-End Regulatory Data Flow</h3>

<p>Vault eTMF and Vault RIM are distinct systems — eTMF manages the clinical trial record, RIM manages the regulatory submission and registration record — but they are tightly integrated in the Veeva Vault platform. The flow of data and documents between them represents the end-to-end regulatory lifecycle from first patient enrolled to product approved and maintained on the market.</p>

<div class="callout callout-info" style="margin:24px 0 32px; padding:24px; border-left:4px solid #7EC8C8; border-radius:10px; background:var(--bg-alt);">
  <div style="font-weight:700; margin-bottom:14px; font-size:14px;">📊 End-to-End Regulatory Data Flow: eTMF → RIM → Submission</div>
  <div style="display:grid; gap:0; font-size:12.5px;">
    <div style="display:flex; align-items:flex-start; gap:12px; padding:10px 0; border-bottom:1px solid var(--border);">
      <div style="min-width:28px; height:28px; border-radius:50%; background:#7EC8C8; color:#0a1628; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:12px; flex-shrink:0;">1</div>
      <div><strong>Trial Initiation:</strong> Protocol, ICF, and IB are authored in Vault RIM (as regulatory documents) and simultaneously filed in Vault eTMF Zone 2. The same document record in Vault, with the same document ID, version, and audit trail, serves both purposes — single source of truth, zero duplication.</div>
    </div>
    <div style="display:flex; align-items:flex-start; gap:12px; padding:10px 0; border-bottom:1px solid var(--border);">
      <div style="min-width:28px; height:28px; border-radius:50%; background:#7EC8C8; color:#0a1628; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:12px; flex-shrink:0;">2</div>
      <div><strong>Protocol Amendments:</strong> When a protocol amendment is authored in Vault RIM (driven by a safety finding or regulatory request), the submission workflow publishes it to FDA as an IND amendment; simultaneously, the new protocol version is routed to Vault eTMF Zone 2 and all affected site ICFs are flagged for update. All sites receive a task notification via Vault to file the updated documents at the site level (Zone 5).</div>
    </div>
    <div style="display:flex; align-items:flex-start; gap:12px; padding:10px 0; border-bottom:1px solid var(--border);">
      <div style="min-width:28px; height:28px; border-radius:50%; background:#7EC8C8; color:#0a1628; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:12px; flex-shrink:0;">3</div>
      <div><strong>Safety Reporting (SUSAR):</strong> Pharmacovigilance identifies a SUSAR in the safety database; the SUSAR report is authored, reviewed through a Vault Quality workflow, and transmitted to FDA as an expedited IND safety report via RIM. Simultaneously, the updated IB (if the SUSAR meets the threshold) is version-bumped in Vault RIM, pushed to eTMF Zone 2, and distributed to all active sites for ICF revision.</div>
    </div>
    <div style="display:flex; align-items:flex-start; gap:12px; padding:10px 0; border-bottom:1px solid var(--border);">
      <div style="min-width:28px; height:28px; border-radius:50%; background:#7EC8C8; color:#0a1628; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:12px; flex-shrink:0;">4</div>
      <div><strong>Monitoring Reports &amp; Protocol Deviations:</strong> Clinical Research Associates (CRAs) file monitoring visit reports and protocol deviation records directly into Vault eTMF Zone 5 after each site visit. These are automatically flagged for Clinical Quality Assurance review. Significant deviations that require regulatory reporting are escalated via a Vault workflow to Regulatory Affairs, who assesses whether an IND amendment or safety report is needed — triggering a new submission workflow in RIM.</div>
    </div>
    <div style="display:flex; align-items:flex-start; gap:12px; padding:10px 0; border-bottom:1px solid var(--border);">
      <div style="min-width:28px; height:28px; border-radius:50%; background:#7EC8C8; color:#0a1628; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:12px; flex-shrink:0;">5</div>
      <div><strong>Clinical Study Report (CSR) Lock:</strong> When a trial completes and the CSR is finalised, it is filed in Vault eTMF Zone 2 (closing out the trial-level TMF) and simultaneously linked in Vault RIM as a source document for Module 5 of the NDA. The same document, in the same Vault, flows from the clinical record into the submission record without re-upload or format conversion.</div>
    </div>
    <div style="display:flex; align-items:flex-start; gap:12px; padding:10px 0; border-bottom:1px solid var(--border);">
      <div style="min-width:28px; height:28px; border-radius:50%; background:#7EC8C8; color:#0a1628; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:12px; flex-shrink:0;">6</div>
      <div><strong>NDA Assembly &amp; Publishing:</strong> The Submissions module in RIM aggregates all linked source documents (CSRs from eTMF, quality documents from Vault QMS, manufacturing data from Vault QualityDocs) and assembles the CTD. Module 2 summaries and the integrated summaries of efficacy/safety are authored directly in Vault RIM by regulatory writers. The built-in eCTD publisher compiles the validated submission package for ESG delivery to FDA.</div>
    </div>
    <div style="display:flex; align-items:flex-start; gap:12px; padding:10px 0; border-bottom:1px solid var(--border);">
      <div style="min-width:28px; height:28px; border-radius:50%; background:#7EC8C8; color:#0a1628; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:12px; flex-shrink:0;">7</div>
      <div><strong>FDA Review &amp; Information Requests:</strong> FDA Information Requests (IRs) arrive as HA Correspondence records in Vault RIM; they are triaged, assigned, and tracked. Response documents are authored in Vault, reviewed through the submission workflow, and published as a sequence 0001 Amendment within the NDA lifecycle. Every IR and response becomes part of the permanent regulatory record linked to the NDA in RIM.</div>
    </div>
    <div style="display:flex; align-items:flex-start; gap:12px; padding:10px 0;">
      <div style="min-width:28px; height:28px; border-radius:50%; background:#7EC8C8; color:#0a1628; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:12px; flex-shrink:0;">8</div>
      <div><strong>Approval → Registration → Commercial Launch:</strong> Upon receipt of the FDA Action Letter (approval), Vault RIM auto-creates a Registration record for the approved product in the US market; the approved label is filed as the current labelling version; post-approval commitments and REMS obligations (if any) are entered as Regulatory Commitments with due dates. This registration record immediately becomes the basis for global variation submissions — EU, Japan, and other markets receive variation submissions built from the same approved US dossier, adapted to local requirements through the Labelling module.</div>
    </div>
  </div>
</div>

<div class="callout insight" style="margin:32px 0 16px;">
  <div class="callout-title">💡 Why Veeva Vault's Single-Platform Architecture Matters for Regulatory</div>
  The critical differentiator of the Veeva approach is that eTMF and RIM are not separate databases connected by integrations — they are modules of a single Vault platform sharing the same document repository, the same user management, the same audit trail infrastructure, and the same API. A protocol document in Zone 2 of eTMF is the same object as the source document linked in the NDA Module 5 CTD in RIM — the same document ID, the same metadata, the same version history. This matters enormously for inspection readiness: when an FDA inspector asks "show me every version of Protocol Amendment 3 and every submission that references it," Vault answers that query across both the trial record and the regulatory record in a single search, with a complete audit trail showing who filed, approved, and referenced each version. The alternative — paper TMFs, SharePoint folders, and disconnected submission management tools — makes this question take days to answer. In Vault, it takes seconds.
</div>
...
# ── Renumber chapter headers (ch5→6, ch6→7, …, ch10→11) to accommodate new Ch5 ──
def _rn(html, old_num, old_word, new_num, new_word):
    html = html.replace(f'>{old_num}</div>', f'>{new_num}</div>', 1)
    html = html.replace(f'>Chapter {old_word}<', f'>Chapter {new_word}<', 1)
    return html

ch5  = _rn(ch5,  '5', 'Five',  '6', 'Six')
ch6  = _rn(ch6,  '6', 'Six',   '7', 'Seven')
ch7  = _rn(ch7,  '7', 'Seven', '8', 'Eight')
ch8  = _rn(ch8,  '8', 'Eight', '9', 'Nine')
ch9  = _rn(ch9,  '9', 'Nine',  '10', 'Ten')
ch10 = _rn(ch10, '10', 'Ten',  '11', 'Eleven')

# Fix chapter div id attributes to match displayed chapter numbers
ch5  = ch5.replace('id="ch5"',  'id="ch6"',  1)
ch6  = ch6.replace('id="ch6"',  'id="ch7"',  1)
ch7  = ch7.replace('id="ch7"',  'id="ch8"',  1)
ch8  = ch8.replace('id="ch8"',  'id="ch9"',  1)
ch9  = ch9.replace('id="ch9"',  'id="ch10"', 1)
ch10 = ch10.replace('id="ch10"', 'id="ch11"', 1)
...
CH_MA = """
<div class="chapter" id="ch-ma">
  <div class="ch-label">
    <div class="ch-num" style="background:#1B6B3A">5</div>
    <span style="color:#1B6B3A">Chapter Five</span>
  </div>
  <h1>Market Access — Getting the Drug to the Patient</h1>
  <p class="lead">A drug approved by the FDA is not automatically available to patients. Between regulatory approval and the moment a patient fills a prescription lies one of the most complex commercial battlegrounds in healthcare: market access. Payers — insurance companies, pharmacy benefit managers, government programmes — control the gates. Market access teams exist to negotiate those gates open.</p>

  <p>Market access is the function responsible for ensuring that the right patients can obtain a therapy at an accessible cost, in a timely manner, through the appropriate channel. It encompasses pricing strategy, formulary negotiation, health economics evidence, reimbursement policy, government pricing compliance, and patient support programmes. A product with exceptional clinical data but poor market access may achieve only 20–30% of its commercial potential — formulary exclusions, high co-pays, and prior authorisation burdens create friction that prevents patients from starting or staying on therapy.</p>

  <h2 id="ma-payer-landscape">The Payer Landscape</h2>
  <p>Understanding who controls formulary access is the first step in market access strategy. The US payer landscape is a complex ecosystem of entities that each exert different levers on patient access and net pricing.</p>

  <div class="crm-obj-grid" style="margin:24px 0;">
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">💊</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Pharmacy Benefit Managers (PBMs)</div>
          <div class="crm-obj-api">Express Scripts · CVS Caremark · OptumRx — control ~80% of US prescription drug benefit</div>
        </div>
      </div>
      <div class="crm-obj-desc">PBMs are the most powerful single entity in US pharmaceutical pricing. They administer prescription drug benefits for commercial health plans, self-insured employers, and government programmes. Their leverage comes from aggregating covered lives: a single PBM may manage pharmacy benefits for 100+ million people, giving them enormous negotiating power. Key PBM mechanisms: <strong>Formulary design</strong> — PBMs build and manage the formulary (the list of covered drugs and their tier placement); preferred tier placement can drive 3–5× higher script volume versus non-preferred. <strong>Rebate negotiations</strong> — manufacturers pay rebates (retrospective discounts) to secure preferred formulary placement; rebates are confidential, percentage-of-WAC, and often reach 40–70%+ for certain drug classes. <strong>Utilisation management (UM)</strong> — prior authorisation (PA) requirements, step therapy (fail-first on cheaper drugs), and quantity limits. <strong>Specialty pharmacy networks</strong> — PBMs control which specialty pharmacies can dispense high-cost biologics and specialty drugs.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">🏥</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Commercial Health Plans</div>
          <div class="crm-obj-api">United, Anthem, Aetna, Cigna — employer-sponsored and individual market coverage</div>
        </div>
      </div>
      <div class="crm-obj-desc">Commercial health plans cover employer-sponsored and individual market lives. Most contract with PBMs for formulary management, but large national plans (United, Anthem) have in-house PBM capabilities. Market access teams target both the plan's Medical Director (for specialty/medical-benefit drugs administered in-office) and the formulary committee (for pharmacy-benefit drugs). Key commercial plan dynamics: <strong>Tier structure</strong> — Tier 1 (generic, lowest co-pay), Tier 2 (preferred brand), Tier 3 (non-preferred brand), Tier 4 (specialty, co-insurance); being on Tier 2 vs. Tier 3 can mean $50 vs. $100+ monthly patient cost-share. <strong>Prior authorisation criteria</strong> — plan-specific PA criteria define which patients qualify; overly restrictive PA can effectively prevent access even for on-label patients. <strong>Step therapy requirements</strong> — 30–60% of commercial plans require patients to fail generic alternatives before approving branded drugs, even in therapeutic areas where the branded drug has superior evidence.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">🏛️</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Medicaid</div>
          <div class="crm-obj-api">State + Federal · Best Price · AMP · Supplemental Rebates · 340B</div>
        </div>
      </div>
      <div class="crm-obj-desc">Medicaid covers ~90 million low-income Americans across 50 state programmes. Manufacturers must participate in the Medicaid Drug Rebate Programme (MDRP) to have drugs covered by Medicaid and Medicare Part D. <strong>Best Price</strong> — manufacturers report the lowest price offered to any commercial customer (with specific exemptions); Medicaid rebate is the greater of 23.1% of AMP or the difference between AMP and Best Price. <strong>Average Manufacturer Price (AMP)</strong> — the average price manufacturers receive from wholesalers net of chargebacks and certain discounts; the basis for Medicaid rebate calculations and CMS ceiling prices. <strong>Supplemental rebates</strong> — states negotiate additional rebates above the federal floor for preferred formulary placement; preferred Medicaid formulary status can drive significant volume in states like California and New York. <strong>340B Drug Pricing Programme</strong> — requires manufacturers to sell to covered entities (safety-net hospitals, FQHCs) at ~25% of AMP; 340B creates complex gross-to-net dynamics because these sales must be excluded from Best Price calculations.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">👴</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Medicare Part D &amp; Part B</div>
          <div class="crm-obj-api">CMS · PDP sponsors · MAPD plans · ASP + 6% for Part B drugs</div>
        </div>
      </div>
      <div class="crm-obj-desc">Medicare covers 65+ million Americans. <strong>Part D</strong> (pharmacy benefit) is delivered through private Prescription Drug Plans (PDPs) and Medicare Advantage Prescription Drug plans (MAPDs). Formulary placement negotiations occur with individual Part D plan sponsors, guided by CMS formulary requirements; plans must cover at least two drugs per therapeutic class. <strong>Coverage Gap</strong> — historically known as the "donut hole"; post-IRA 2022, manufacturers provide discounts in the coverage gap. <strong>Inflation Rebate Penalty (IRA 2022)</strong> — drugs with price increases exceeding inflation (CPI-U) trigger mandatory rebates to CMS; this fundamentally constrains annual list price increases. <strong>Medicare Drug Price Negotiation (IRA 2022)</strong> — CMS can directly negotiate prices for high-expenditure drugs without generic/biosimilar competition; first negotiated prices effective 2026. <strong>Part B</strong> (medical benefit) covers physician-administered drugs (biologics, infusables); reimbursed at Average Selling Price (ASP) + 6%; buy-and-bill dynamics; hospital Outpatient Prospective Payment System rates.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">🎖️</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">VA / DoD / Federal Supply Schedule</div>
          <div class="crm-obj-api">FAMP · Non-FAMP · Big 4 · Federal Ceiling Price</div>
        </div>
      </div>
      <div class="crm-obj-desc">Federal government purchasers (VA, DoD, PHS, Coast Guard — collectively the "Big 4") receive the deepest statutory discounts. <strong>Federal Ceiling Price (FCP)</strong> — capped at 76% of Non-Federal Average Manufacturer Price (Non-FAMP); the Big 4 cannot be charged more than this statutory cap. <strong>Federal Supply Schedule (FSS)</strong> — VA contracts with manufacturers for FSS pricing; typically requires the most favourable price offered to comparable commercial customers. <strong>Tricare</strong> (DoD) — administers pharmacy benefits for military members and dependents; uses retail network pharmacies plus mail order and military treatment facility pharmacies. Federal pricing has significant gross-to-net implications: high volume, statutory deep discounts, but mandatory participation to retain Medicaid/Medicare programme eligibility.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">🏨</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">IDNs, GPOs &amp; Specialty Pharmacy</div>
          <div class="crm-obj-api">Integrated Delivery Networks · Group Purchasing Organisations · SP Hub</div>
        </div>
      </div>
      <div class="crm-obj-desc"><strong>Integrated Delivery Networks (IDNs)</strong> — large hospital systems that negotiate directly with manufacturers for formulary inclusion across their inpatient and outpatient formularies; P&amp;T committee approval required; IDN pharmacy directors are key market access stakeholders. <strong>Group Purchasing Organisations (GPOs)</strong> — aggregate purchasing power of multiple hospitals; GPO contracts (typically admin fees of 2–3% paid by manufacturers) are a prerequisite for hospital formulary access. <strong>Specialty Pharmacy (SP)</strong> — for high-cost specialty drugs (biologics, oncologics), manufacturers designate a limited network of specialty pharmacies authorised to dispense the product; SPs provide patient adherence support, insurance verification, and REMS compliance; SP hub services (e.g., CoverMyMeds, Lash Group) manage prior authorisation, appeals, and co-pay assistance enrolment.</div>
    </div>
  </div>

  <h2 id="ma-pricing">Pharmaceutical Pricing Strategy</h2>
  <p>Pricing a pharmaceutical product is one of the most consequential decisions in drug commercialisation. The list price (WAC) anchors all downstream pricing calculations — yet the actual realised revenue per unit (net price) may be 40–70% below list after all discounts, rebates, and chargebacks are applied.</p>

  <!-- SVG: Market Access Pricing & Access Flow -->
  <figure class="vis-embed" aria-label="Market Access — Pricing &amp; Payer Ecosystem">
    <div class="vis-label"><span class="vis-icon">◈</span> Market Access — Pricing, Rebates &amp; Patient Access Flow</div>
    <div class="vis-inner">
      <svg viewBox="0 0 900 560" xmlns="http://www.w3.org/2000/svg" font-family="system-ui,sans-serif">
        <defs>
          <linearGradient id="maGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stop-color="#0a1628"/>
            <stop offset="100%" stop-color="#061020"/>
          </linearGradient>
          <marker id="maArr" markerWidth="8" markerHeight="8" refX="7" refY="3" orient="auto">
            <path d="M0,0 L0,6 L8,3 z" fill="#4ACA7A"/>
          </marker>
          <marker id="maArrGray" markerWidth="8" markerHeight="8" refX="7" refY="3" orient="auto">
            <path d="M0,0 L0,6 L8,3 z" fill="#4A6080"/>
          </marker>
          <marker id="maArrRed" markerWidth="8" markerHeight="8" refX="7" refY="3" orient="auto">
            <path d="M0,0 L0,6 L8,3 z" fill="#CA4A4A"/>
          </marker>
        </defs>
        <rect width="900" height="560" fill="url(#maGrad)" rx="10"/>
        <!-- Title -->
        <text x="450" y="32" text-anchor="middle" fill="#4ACA7A" font-size="14" font-weight="700" letter-spacing="1">MARKET ACCESS — PRICING &amp; PATIENT ACCESS FLOW</text>

        <!-- PHARMA COMPANY box -->
        <rect x="320" y="55" width="260" height="70" rx="10" fill="#0f2a0f" stroke="#1B6B3A" stroke-width="1.5"/>
        <text x="450" y="78" text-anchor="middle" fill="#4ACA7A" font-size="12" font-weight="700">PHARMACEUTICAL COMPANY</text>
        <text x="450" y="96" text-anchor="middle" fill="#8BA88B" font-size="10">WAC · List Price Setting</text>
        <text x="450" y="110" text-anchor="middle" fill="#8BA88B" font-size="10">Contract Management · Government Pricing</text>

        <!-- WAC Label -->
        <text x="200" y="78" text-anchor="middle" fill="#E0C060" font-size="11" font-weight="700">WAC</text>
        <text x="200" y="92" text-anchor="middle" fill="#8B7840" font-size="9">Wholesale Acquisition Cost</text>
        <text x="200" y="106" text-anchor="middle" fill="#8B7840" font-size="9">= List Price (public)</text>
        <rect x="130" y="60" width="140" height="58" rx="8" fill="none" stroke="#8B7840" stroke-width="1" stroke-dasharray="4,3"/>

        <!-- Wholesaler / Distributor -->
        <rect x="360" y="175" width="180" height="50" rx="8" fill="#101820" stroke="#3A5A80" stroke-width="1.5"/>
        <text x="450" y="196" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">WHOLESALER / 3PL</text>
        <text x="450" y="211" text-anchor="middle" fill="#5A8090" font-size="9">McKesson · AmerisourceBergen · Cardinal</text>

        <!-- Arrow Pharma → Wholesaler -->
        <line x1="450" y1="125" x2="450" y2="172" stroke="#4ACA7A" stroke-width="1.5" marker-end="url(#maArr)"/>
        <text x="458" y="152" fill="#6ACA8A" font-size="9">WAC − 2% chargeback</text>

        <!-- PBM box -->
        <rect x="60" y="175" width="160" height="70" rx="8" fill="#101828" stroke="#4A7ABF" stroke-width="1.5"/>
        <text x="140" y="196" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">PBM</text>
        <text x="140" y="210" text-anchor="middle" fill="#5A8090" font-size="9">Express Scripts · CVS Caremark</text>
        <text x="140" y="224" text-anchor="middle" fill="#5A8090" font-size="9">OptumRx · Formulary Control</text>

        <!-- Pharma → PBM (rebate arrow) -->
        <path d="M320,100 Q200,100 220,180" stroke="#CA4A4A" stroke-width="1.5" fill="none" stroke-dasharray="5,3" marker-end="url(#maArrRed)"/>
        <text x="220" y="140" fill="#CA4A4A" font-size="9" font-weight="700">Rebates</text>
        <text x="220" y="152" fill="#CA4A4A" font-size="9">40–70% of WAC</text>

        <!-- Government box -->
        <rect x="680" y="175" width="175" height="70" rx="8" fill="#1a1020" stroke="#8B3A8B" stroke-width="1.5"/>
        <text x="768" y="196" text-anchor="middle" fill="#C07AC0" font-size="11" font-weight="700">GOVERNMENT</text>
        <text x="768" y="210" text-anchor="middle" fill="#806080" font-size="9">Medicaid · Medicare · VA</text>
        <text x="768" y="224" text-anchor="middle" fill="#806080" font-size="9">Best Price · AMP · FCP</text>

        <!-- Pharma → Gov (statutory rebates) -->
        <path d="M580,100 Q700,100 720,180" stroke="#CA4A4A" stroke-width="1.5" fill="none" stroke-dasharray="5,3" marker-end="url(#maArrRed)"/>
        <text x="665" y="140" fill="#CA4A4A" font-size="9" font-weight="700">Stat. Rebates</text>
        <text x="665" y="152" fill="#CA4A4A" font-size="9">Medicaid MDRP</text>

        <!-- Pharmacy / SP box -->
        <rect x="340" y="295" width="220" height="55" rx="8" fill="#101820" stroke="#3A5A80" stroke-width="1.5"/>
        <text x="450" y="317" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">PHARMACY / SPECIALTY Rx</text>
        <text x="450" y="333" text-anchor="middle" fill="#5A8090" font-size="9">Retail · Mail Order · Specialty · Hub Services</text>

        <!-- Wholesaler → Pharmacy -->
        <line x1="450" y1="225" x2="450" y2="293" stroke="#4ACA7A" stroke-width="1.5" marker-end="url(#maArr)"/>
        <text x="458" y="262" fill="#6ACA8A" font-size="9">WAC − chargeback</text>

        <!-- PBM → Pharmacy (adjudication) -->
        <path d="M220,225 Q290,260 338,310" stroke="#4A7ABF" stroke-width="1.5" fill="none" marker-end="url(#maArrGray)"/>
        <text x="248" y="272" fill="#4A7ABF" font-size="9">Adjudication</text>
        <text x="248" y="284" fill="#4A7ABF" font-size="9">Co-pay / formulary</text>

        <!-- Government → Pharmacy -->
        <path d="M718,245 Q600,270 563,300" stroke="#8B3A8B" stroke-width="1.5" fill="none" stroke-dasharray="4,3" marker-end="url(#maArrGray)"/>
        <text x="638" y="265" fill="#8B3A8B" font-size="9">Coverage rules</text>

        <!-- HEOR / Value Story box -->
        <rect x="30" y="310" width="170" height="60" rx="8" fill="#0f1820" stroke="#4A7A4A" stroke-width="1.5"/>
        <text x="115" y="330" text-anchor="middle" fill="#6AB06A" font-size="10" font-weight="700">HEOR / VALUE DOSSIER</text>
        <text x="115" y="346" text-anchor="middle" fill="#4A6A4A" font-size="9">Cost-effectiveness · ICER</text>
        <text x="115" y="360" text-anchor="middle" fill="#4A6A4A" font-size="9">Budget Impact Model</text>

        <!-- HEOR → PBM -->
        <line x1="200" y1="340" x2="220" y2="280" stroke="#4A7A4A" stroke-width="1" stroke-dasharray="4,3" marker-end="url(#maArrGray)"/>

        <!-- Patient Access box -->
        <rect x="340" y="415" width="220" height="70" rx="10" fill="#0f1a28" stroke="#1B6B3A" stroke-width="2"/>
        <text x="450" y="437" text-anchor="middle" fill="#4ACA7A" font-size="12" font-weight="700">PATIENT</text>
        <text x="450" y="453" text-anchor="middle" fill="#4A8A5A" font-size="10">Co-pay Card · PAP · Free Trial</text>
        <text x="450" y="468" text-anchor="middle" fill="#4A8A5A" font-size="10">Prior Auth Support · Appeals</text>

        <!-- Pharmacy → Patient -->
        <line x1="450" y1="350" x2="450" y2="413" stroke="#4ACA7A" stroke-width="2" marker-end="url(#maArr)"/>
        <text x="458" y="385" fill="#6ACA8A" font-size="9">Rx dispensed</text>
        <text x="458" y="397" fill="#6ACA8A" font-size="9">+ patient cost-share</text>

        <!-- Co-pay / PAP box -->
        <rect x="680" y="310" width="175" height="60" rx="8" fill="#0f1a0f" stroke="#2A6B3A" stroke-width="1.5"/>
        <text x="768" y="332" text-anchor="middle" fill="#4ACA7A" font-size="10" font-weight="700">PATIENT SUPPORT</text>
        <text x="768" y="348" text-anchor="middle" fill="#3A8A4A" font-size="9">Co-pay Assistance Cards</text>
        <text x="768" y="362" text-anchor="middle" fill="#3A8A4A" font-size="9">Patient Assistance Programmes</text>

        <!-- Patient Support → Patient -->
        <path d="M718,355 Q640,390 563,435" stroke="#4ACA7A" stroke-width="1.5" fill="none" marker-end="url(#maArr)"/>
        <text x="630" y="405" fill="#3A8A4A" font-size="9">Reduces OOP cost</text>

        <!-- Gross-to-Net waterfall label -->
        <rect x="30" y="415" width="175" height="90" rx="8" fill="#1a1010" stroke="#8B3A3A" stroke-width="1.5"/>
        <text x="118" y="437" text-anchor="middle" fill="#CA7A7A" font-size="10" font-weight="700">GROSS-TO-NET</text>
        <text x="118" y="452" text-anchor="middle" fill="#CA7A7A" font-size="10" font-weight="700">WATERFALL</text>
        <text x="118" y="468" text-anchor="middle" fill="#8B5A5A" font-size="9">WAC: $100</text>
        <text x="118" y="482" text-anchor="middle" fill="#8B5A5A" font-size="9">− Rebates: −$45</text>
        <text x="118" y="495" text-anchor="middle" fill="#CA4A4A" font-size="9" font-weight="700">Net Price: ~$55</text>

        <!-- NET Price arrow to Patient -->
        <line x1="205" y1="458" x2="338" y2="455" stroke="#8B3A3A" stroke-width="1" stroke-dasharray="4,3" marker-end="url(#maArrRed)"/>

        <!-- Model N badge -->
        <rect x="590" y="415" width="90" height="26" rx="5" fill="#1a2a40" stroke="#4A7ABF" stroke-width="1"/>
        <text x="635" y="433" text-anchor="middle" fill="#0B6B6B" font-size="9" font-weight="700">Model N</text>

        <!-- Anaplan badge -->
        <rect x="590" y="448" width="90" height="26" rx="5" fill="#1a2a40" stroke="#4A7ABF" stroke-width="1"/>
        <text x="635" y="466" text-anchor="middle" fill="#0B6B6B" font-size="9" font-weight="700">Anaplan</text>

        <text x="588" y="413" fill="#5A8090" font-size="8">Systems:</text>

        <!-- Legend -->
        <line x1="350" y1="535" x2="375" y2="535" stroke="#4ACA7A" stroke-width="2" marker-end="url(#maArr)"/>
        <text x="380" y="539" fill="#4ACA7A" font-size="9">Product / Rx flow</text>
        <line x1="470" y1="535" x2="495" y2="535" stroke="#CA4A4A" stroke-width="1.5" stroke-dasharray="4,3" marker-end="url(#maArrRed)"/>
        <text x="500" y="539" fill="#CA4A4A" font-size="9">Rebate / discount flow</text>
        <line x1="620" y1="535" x2="645" y2="535" stroke="#4A7ABF" stroke-width="1.5" marker-end="url(#maArrGray)"/>
        <text x="650" y="539" fill="#4A7ABF" font-size="9">Coverage / adjudication</text>
      </svg>
    </div>
    <figcaption class="vis-cap">Market Access — Pricing, Rebates &amp; Patient Access Ecosystem</figcaption>
  </figure>
  ...
  <div class="crm-obj-grid" style="margin:24px 0;">
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">💰</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">WAC — Wholesale Acquisition Cost</div>
          <div class="crm-obj-api">List price · Public · Anchors all downstream calculations · Not what anyone actually pays</div>
        </div>
      </div>
      <div class="crm-obj-desc">WAC is the manufacturer's published list price to wholesalers — it is set by the manufacturer and publicly available. It is the starting point for all pricing calculations. No major payer actually pays WAC; every channel receives discounts, rebates, or chargebacks below list. WAC is set strategically: high enough to accommodate the rebate concessions required for formulary access while still yielding an acceptable net price. WAC increases have historically tracked 8–10% annually, but post-IRA inflation penalties for Medicare drugs constrain future WAC increase strategy. <strong>Important distinctions:</strong> WAC is different from Average Wholesale Price (AWP) — a legacy benchmark still used in some Medicare Part B reimbursement calculations, set at WAC + ~20%.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">📉</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Gross-to-Net Waterfall</div>
          <div class="crm-obj-api">WAC → Gross Revenue → Net Revenue after all deductions</div>
        </div>
      </div>
      <div class="crm-obj-desc">The gross-to-net waterfall quantifies every dollar of discount, rebate, and allowance deducted from WAC to arrive at net revenue. Typical waterfall components: <strong>Managed care rebates</strong> — largest component; paid to PBMs and health plans quarterly; recorded as a reduction to gross revenue. <strong>Medicaid statutory rebates</strong> — federal floor rebate plus state supplemental rebates. <strong>340B discounts</strong> — mandatory discounts to covered entities; excluded from Best Price. <strong>Chargebacks</strong> — difference between contract price and WAC, paid by manufacturers to wholesalers when they sell to contract-eligible customers below WAC. <strong>Patient co-pay assistance</strong> — co-pay card redemptions reduce realised revenue. <strong>Distribution fees</strong> — fees paid to wholesalers and distributors for inventory management and data services. A typical branded drug may have gross-to-net adjustments of 40–60%; some high-rebate categories (diabetes, respiratory) exceed 70%.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">🤝</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Formulary Contracting &amp; Rebate Strategy</div>
          <div class="crm-obj-api">Preferred tier · Exclusion risk · Rebate tiers · Value-based contracts</div>
        </div>
      </div>
      <div class="crm-obj-desc">Formulary contracting is the negotiation between a manufacturer's market access team and the PBM/health plan to secure preferred tier placement in exchange for rebates. Contract structure: <strong>Base rebate</strong> — flat percentage of WAC paid for formulary inclusion (non-preferred Tier 3 access). <strong>Performance rebate</strong> — incremental rebate for preferred Tier 2 placement, conditioned on maintaining a minimum market share threshold within the formulary. <strong>Market share step-ups</strong> — additional rebate percentages triggered when the drug achieves defined market share milestones. <strong>Exclusivity rebate</strong> — paid when competitors are excluded from formulary (formulary exclusions have become common for commodity classes like statins, PPIs, and increasingly diabetes GLP-1s). <strong>Value-based contracts (VBCs)</strong> — emerging model linking rebate levels to real-world patient outcomes; e.g., manufacturer pays a higher rebate if the drug fails to achieve defined clinical outcomes in the plan's population; requires sophisticated data infrastructure.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">📊</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Government Pricing Compliance</div>
          <div class="crm-obj-api">Best Price · AMP · Non-FAMP · ASP · Quarterly CMS reporting</div>
        </div>
      </div>
      <div class="crm-obj-desc">Government pricing is a mandatory quarterly reporting obligation for any manufacturer participating in the Medicaid Drug Rebate Programme (MDRP). Non-compliance carries severe penalties. <strong>Average Manufacturer Price (AMP)</strong> — average price received from wholesalers and retail pharmacies, net of chargebacks, cash discounts, and certain fees; reported quarterly to CMS; basis for Medicaid rebate, 340B ceiling price, and FAMP. <strong>Best Price (BP)</strong> — lowest price offered to any US customer in any pricing arrangement; certain transactions are excluded (340B sales, nominal pricing to charitable entities, bona fide service fees). <strong>Non-Federal Average Manufacturer Price (Non-FAMP)</strong> — basis for Federal Supply Schedule pricing and the Federal Ceiling Price calculation. <strong>Average Selling Price (ASP)</strong> — for Part B drugs; average sales price to all US purchasers net of rebates, discounts, and chargebacks; reported quarterly; used to set Medicare Part B reimbursement rate. Errors in government pricing reports can trigger retroactive rebate obligations, civil monetary penalties, and False Claims Act liability.</div>
    </div>
  </div>

  <h2 id="ma-heor">Health Economics &amp; Outcomes Research (HEOR)</h2>
  <p>HEOR generates the economic and real-world evidence that underpins market access negotiations. Without a compelling economic value story, even clinically superior drugs face formulary restrictions and steep rebate demands.</p>
  ...
  <div class="crm-obj-grid" style="margin:24px 0;">
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">📐</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Cost-Effectiveness Analysis (CEA)</div>
          <div class="crm-obj-api">ICER · QALY · Cost per QALY threshold · Payer willingness-to-pay</div>
        </div>
      </div>
      <div class="crm-obj-desc">CEA compares the cost and health outcomes of a new therapy versus the current standard of care. The primary metric is the Incremental Cost-Effectiveness Ratio (ICER) — the additional cost per Quality-Adjusted Life Year (QALY) gained. <strong>ICER (non-profit)</strong> — the Institute for Clinical and Economic Review publishes independent CEA reports for high-cost drugs; ICER reports influence PBM formulary negotiations, state Medicaid supplemental rebate targets, and increasingly commercial plan coverage policies. A commonly cited US willingness-to-pay threshold is $100,000–$150,000 per QALY, though this is not a formal regulatory standard. <strong>Payer-specific models</strong> — market access teams build custom CEA models using payer-specific patient population data and local cost inputs to demonstrate value in each payer's specific context. Drugs with favourable ICER scores command higher net prices; drugs with unfavourable scores face steep rebate demands to reach cost-effectiveness thresholds.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">🏦</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Budget Impact Model (BIM)</div>
          <div class="crm-obj-api">Payer-specific · Covered lives · Utilisation projections · Net budget impact</div>
        </div>
      </div>
      <div class="crm-obj-desc">While CEA answers "is this drug cost-effective for society?", the Budget Impact Model answers the question payers actually care about: "what will this drug cost MY plan if I cover it?" The BIM projects the total drug spend change for a specific health plan if it adds the new therapy to its formulary. Inputs: number of covered lives in the relevant disease population, expected market share uptake over 3 years, current standard-of-care costs, drug acquisition cost at negotiated net price, and downstream cost offsets (hospitalisations avoided, procedures avoided, productivity gains). Market access teams present customised BIMs to each payer using their specific covered-lives data. Plans with high disease prevalence in the target population may negotiate more aggressively on price than plans with low prevalence.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">🌍</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Real-World Evidence (RWE)</div>
          <div class="crm-obj-api">Claims data · EHR analysis · Registry studies · PRO data · Comparative effectiveness</div>
        </div>
      </div>
      <div class="crm-obj-desc">RWE fills the evidence gaps left by randomised clinical trials — which use selected patient populations, controlled conditions, and limited follow-up periods. Sources: <strong>Claims data</strong> — insurance claims from PBMs and health plans showing real-world prescribing patterns, treatment sequences, adherence, persistence, and healthcare resource utilisation; can demonstrate that the drug reduces ER visits or hospitalisations. <strong>Electronic Health Record (EHR) data</strong> — real clinical outcomes in diverse patient populations including those excluded from trials. <strong>Patient registries</strong> — disease-specific databases capturing long-term outcomes in treated populations. <strong>Patient-Reported Outcomes (PROs)</strong> — quality-of-life improvements that trial endpoints may not capture. RWE is presented to payer formulary committees to justify premium pricing or to satisfy post-approval commitments to payers who conditionally covered the drug pending real-world outcomes data.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">📋</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Value Dossier / AMCP Dossier</div>
          <div class="crm-obj-api">AMCP Format · Clinical + economic evidence compendium · Payer-facing</div>
        </div>
      </div>
      <div class="crm-obj-desc">The AMCP (Academy of Managed Care Pharmacy) Format Dossier is the standard submission document manufacturers use to present clinical and economic evidence to payers. Structure: <strong>Section 1</strong> — disease background and epidemiology; <strong>Section 2</strong> — clinical evidence summary (all trial data, safety, quality of life); <strong>Section 3</strong> — economic model (CEA, BIM with assumptions and references); <strong>Section 4</strong> — product information and dosing; <strong>Section 5</strong> — supporting references. The dossier is prepared by HEOR and medical writing teams, reviewed by regulatory to ensure off-label content compliance, and submitted to payer pharmacy and therapeutics (P&amp;T) committees as part of the formulary review process. A well-constructed dossier can accelerate formulary coverage decisions from 12+ months to 3–6 months.</div>
    </div>
  </div>

  <h2 id="ma-patient-access">Patient Access Programmes</h2>
  <p>Even with formulary placement, high patient cost-share can prevent patients from starting or staying on therapy. Patient access programmes address this gap and are a critical lever in total access strategy.</p>
  ...
  <div class="crm-obj-grid" style="margin:24px 0;">
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">💳</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Co-pay Assistance Cards</div>
          <div class="crm-obj-api">Commercially insured patients only · OOP reduction · Accumulators · Maximisers</div>
        </div>
      </div>
      <div class="crm-obj-desc">Co-pay assistance cards (also called co-pay cards or coupons) allow commercially insured patients to reduce their out-of-pocket cost-share. Manufacturer funds the difference between the patient's plan cost-share and a set maximum patient co-pay (e.g., patient pays $10/month, manufacturer pays remaining $90 to the pharmacy). Restrictions: <strong>Federally insured patients excluded</strong> — co-pay cards cannot be used by Medicare, Medicaid, or other government-insured patients (Anti-Kickback Statute violation); patients must attest to commercial insurance status. <strong>Accumulator adjustment programmes</strong> — PBMs have implemented accumulators that prevent co-pay card payments from counting toward a patient's deductible/out-of-pocket maximum; once the card maximum is exhausted, patients face full cost-share. <strong>Maximiser programmes</strong> — programmes designed to capture the full co-pay card benefit (up to $10,000+/year) while keeping the patient's cost-share near zero; manufacturers have responded with maximiser-specific card designs.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">🆓</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Patient Assistance Programmes (PAPs)</div>
          <div class="crm-obj-api">Uninsured / underinsured · Income-based · Free drug · Foundation support</div>
        </div>
      </div>
      <div class="crm-obj-desc">PAPs provide free or deeply discounted drug to uninsured or underinsured patients who meet income eligibility criteria (typically ≤400% of the federal poverty level). Manufacturers are not required to offer PAPs but virtually all branded manufacturers do as part of their access commitment. PAP mechanics: patient submits income documentation to the manufacturer or a third-party hub; manufacturer ships free drug directly to patient or provides vouchers; some manufacturers instead direct patients to charitable foundations (PAN Foundation, HealthWell Foundation) which provide grants for premium assistance and cost-sharing. Medicare patients ineligible for co-pay cards may qualify for foundation grants. PAP programmes are closely scrutinised by OIG for compliance with Anti-Kickback Statute safe harbours; all PAP decisions must be made without reference to the patient's prescribing volume.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">🔓</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Prior Authorisation &amp; Appeals Support</div>
          <div class="crm-obj-api">PA criteria navigation · Peer-to-peer review · Appeals management · Bridge supply</div>
        </div>
      </div>
      <div class="crm-obj-desc">Prior authorisation (PA) is a payer requirement that physicians obtain plan approval before prescribing a drug. PA denial is one of the most common barriers to therapy initiation. Hub services support PA navigation: <strong>Benefit investigation</strong> — determines the patient's plan, formulary tier, and PA requirements before the prescription is submitted. <strong>PA initiation</strong> — hub staff complete and submit PA forms on behalf of the prescriber. <strong>Peer-to-peer facilitation</strong> — when initial PA is denied, the hub connects the prescriber with the plan's Medical Director for a clinical peer-to-peer review call. <strong>Appeals management</strong> — for continued denials, hub staff manage the formal appeals process including administrative appeals and external independent reviews. <strong>Bridge supply</strong> — free starter samples or emergency supply to ensure patients do not go without therapy during PA processing delays (which average 3–17 business days depending on drug and plan).</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #1B6B3A; border-top:1px solid #0a3a1a; border-right:1px solid #0a3a1a; border-bottom:1px solid #0a3a1a;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a2a10">📈</div>
        <div>
          <div class="crm-obj-name" style="color:#4ACA7A">Access Analytics &amp; Market Intelligence</div>
          <div class="crm-obj-api">Formulary tracking · PA denial rates · NRx/TRx pull-through · Net price realisation</div>
        </div>
      </div>
      <div class="crm-obj-desc">Market access analytics tracks the real-world impact of coverage decisions on prescription volume and revenue. Key metrics: <strong>Formulary coverage</strong> — percentage of covered commercial, Medicare Part D, and Medicaid lives with unrestricted or preferred access; tracked weekly by formulary intelligence vendors (Managed Markets Insight &amp; Technology, Fingertip Formulary). <strong>PA denial rate &amp; appeal success rate</strong> — early warning indicator of access barriers; rising denial rates may require PA criteria renegotiation with payers. <strong>Pull-through rate</strong> — percentage of written prescriptions that are actually dispensed (abandoned prescriptions indicate access barriers). <strong>Net price realisation</strong> — actual net revenue per unit versus plan; variance analysis identifies whether realised pricing aligns with contracting assumptions. <strong>Gross-to-net reconciliation</strong> — quarterly process to true up actual rebate payments against accruals; managed through Model N and financial planning systems.</div>
    </div>
  </div>

  <h2 id="ma-model-n">Model N — Revenue Management &amp; Government Pricing Platform</h2>
  <p>Model N is the leading enterprise software platform for pharmaceutical revenue management. It automates the complex, compliance-critical processes of government price reporting, contract management, rebate administration, and chargebacks — processes that, if done manually or incorrectly, create enormous financial exposure and False Claims Act liability.</p>

  <div class="crm-obj-grid" style="margin:24px 0;">
    <div class="crm-obj-card" style="border-left:3px solid #4A7ABF; border-top:1px solid #1B3A6B; border-right:1px solid #1B3A6B; border-bottom:1px solid #1B3A6B;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a1428">🏛️</div>
        <div>
          <div class="crm-obj-name" style="color:#7EC8C8">Model N — Government Pricing (GP) Module</div>
          <div class="crm-obj-api">AMP · Best Price · Non-FAMP · ASP · Medicaid rebate invoicing · CMS reporting</div>
        </div>
      </div>
      <div class="crm-obj-desc">The Government Pricing module is Model N's core differentiator. It automates the quarterly calculation and CMS reporting of AMP, Best Price, Non-FAMP, and ASP — calculations that involve processing millions of transaction records across every channel, applying complex statutory exclusions, and producing audit-ready reports. <strong>Transaction ingestion</strong> — Model N ingests sales data from wholesalers (via 867 data feeds), chargebacks, contract sales (via 844/845 EDI), and direct sales; each transaction is classified by channel, customer type, and applicable pricing programme. <strong>AMP calculation engine</strong> — applies 42 CFR Part 447 regulatory rules to compute weighted-average AMP by NDC by quarter; handles complex scenarios including restatements, late submissions, and newly approved products. <strong>Best Price determination</strong> — scans all transaction data and pricing arrangements to identify the lowest price in any configuration; flags potential Best Price violations before submission. <strong>CMS submission</strong> — generates the MDRP quarterly submission in the required XML format for the CMS Drug Data Reporting for Medicaid (DDR) system; maintains submission audit trail. <strong>Medicaid rebate invoicing</strong> — processes Medicaid rebate invoices from all 50 state Medicaid agencies; validates invoice amounts against CMS-calculated rebate obligations; manages disputes and supplemental rebate payments.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #4A7ABF; border-top:1px solid #1B3A6B; border-right:1px solid #1B3A6B; border-bottom:1px solid #1B3A6B;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a1428">📑</div>
        <div>
          <div class="crm-obj-name" style="color:#7EC8C8">Model N — Contract Management</div>
          <div class="crm-obj-api">Commercial contracts · Managed care · GPO · Government · Chargeback processing</div>
        </div>
      </div>
      <div class="crm-obj-desc">Model N manages the full lifecycle of all pricing contracts — from creation and approval through execution, chargeback processing, and expiration. <strong>Contract authoring</strong> — contracts are built in Model N's contract management module with pricing tiers, eligibility criteria (customer type, GPO membership), effective dates, and performance conditions; approved through a workflow and published to the contract repository. <strong>Eligibility determination</strong> — when a wholesaler submits a chargeback claim (asserting that a customer purchased at a sub-WAC contract price), Model N validates: is the customer eligible for the claimed contract? Was the purchase date within the contract period? Does the claim match the wholesaler's sales data? <strong>Chargeback processing</strong> — validated chargebacks are approved and the differential between contract price and WAC is credited to the wholesaler; invalid chargebacks are disputed with supporting data. <strong>Contract performance tracking</strong> — Model N tracks market share and volume performance against contract thresholds to calculate earned versus unearned rebate tiers; ensures rebate payments are paid only when performance conditions are met.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #4A7ABF; border-top:1px solid #1B3A6B; border-right:1px solid #1B3A6B; border-bottom:1px solid #1B3A6B;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a1428">💸</div>
        <div>
          <div class="crm-obj-name" style="color:#7EC8C8">Model N — Rebate Management</div>
          <div class="crm-obj-api">Managed care rebates · Medicaid supplementals · State contract rebates · Accruals</div>
        </div>
      </div>
      <div class="crm-obj-desc">Rebate management in Model N tracks every rebate obligation across commercial managed care, Medicaid supplemental, state contracts, and federal pricing programmes. <strong>Rebate accruals</strong> — for financial reporting (GAAP), manufacturers must accrue rebate liabilities in the same period as the associated revenue; Model N calculates accruals based on contracted rates, utilisation data from PBMs and plans, and government price calculations; feeds the P&amp;L as a gross-to-net revenue reduction. <strong>Managed care rebate settlement</strong> — PBMs and health plans submit quarterly utilisation data; Model N calculates the rebate due, generates payment instructions, and reconciles against prior accruals; performance rebate tiers are evaluated based on submitted utilisation versus contract thresholds. <strong>Medicaid supplemental rebates</strong> — state Medicaid programmes negotiate supplemental rebates above the federal floor; Model N tracks each state's supplemental agreement, processes state-submitted utilisation, and calculates state-specific supplemental payments. <strong>Dispute management</strong> — when payers submit incorrect utilisation data or calculate rebates erroneously, Model N generates dispute letters with supporting data and tracks dispute resolution timelines.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #4A7ABF; border-top:1px solid #1B3A6B; border-right:1px solid #1B3A6B; border-bottom:1px solid #1B3A6B;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a1428">🔗</div>
        <div>
          <div class="crm-obj-name" style="color:#7EC8C8">Model N — 340B Programme Management</div>
          <div class="crm-obj-api">Ceiling price · Covered entity eligibility · Duplicate discount prevention · HRSA compliance</div>
        </div>
      </div>
      <div class="crm-obj-desc">The 340B Drug Pricing Programme requires manufacturers to sell to eligible covered entities (safety-net hospitals, Federally Qualified Health Centres, Ryan White HIV/AIDS clinics, etc.) at a ceiling price of approximately 23.1% of AMP — the same discount as the Medicaid federal floor rebate. Model N manages 340B compliance: <strong>Covered entity eligibility verification</strong> — Model N integrates with the HRSA 340B Office of Pharmacy Affairs (OPA) database to verify which entities are eligible for 340B pricing; purchases by ineligible entities at 340B prices create contract pharmacy and replenishment reconciliation errors. <strong>Ceiling price calculation</strong> — quarterly 340B ceiling prices are calculated from AMP and published in HRSA's 340B ceiling price database; Model N automates this calculation and ensures pricing systems are updated before the next quarter. <strong>Duplicate discount prevention</strong> — federal law prohibits 340B discounts and Medicaid rebates from being applied to the same dispensing event; Model N flags and manages these "duplicate discount" scenarios through data matching and carve-out programme administration. <strong>Contract pharmacy monitoring</strong> — as 340B has expanded to contract pharmacy arrangements (340B-eligible entities dispensing through retail pharmacy chains), Model N tracks these arrangements and manages manufacturer restrictions on contract pharmacy participation.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #4A7ABF; border-top:1px solid #1B3A6B; border-right:1px solid #1B3A6B; border-bottom:1px solid #1B3A6B;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a1428">🔄</div>
        <div>
          <div class="crm-obj-name" style="color:#7EC8C8">Model N — Gross-to-Net Analytics</div>
          <div class="crm-obj-api">Net revenue realisation · Waterfall reporting · Variance analysis · Forecast vs. actual</div>
        </div>
      </div>
      <div class="crm-obj-desc">Model N's analytics layer transforms transactional contract, rebate, and government pricing data into the gross-to-net waterfall reporting that finance and market access leadership use to manage the business. <strong>Net revenue by channel</strong> — breaks down actual net revenue realisation by payer segment (commercial managed care, Medicare Part D, Medicaid, cash/uninsured, 340B, federal); reveals which channels are most and least profitable after all contractual deductions. <strong>Rebate rate analysis</strong> — actual rebate rates paid versus contracted rates; identifies whether portfolio companies are receiving the formulary positions they contracted for and paying rebates correctly. <strong>Accrual-to-actual reconciliation</strong> — compares financial accruals recorded in the G/L against actual payments made; large variances signal accrual methodology problems or unexpected payer behaviour. <strong>IRA inflation penalty projection</strong> — as of 2023, drugs with Medicare price increases above CPI must pay inflation rebates to CMS; Model N calculates projected penalties under different pricing scenarios to inform WAC increase decisions. All analytics are exportable to Anaplan for integrated financial and commercial planning.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #4A7ABF; border-top:1px solid #1B3A6B; border-right:1px solid #1B3A6B; border-bottom:1px solid #1B3A6B;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#0a1428">⚖️</div>
        <div>
          <div class="crm-obj-name" style="color:#7EC8C8">Model N — Compliance &amp; Audit Trail</div>
          <div class="crm-obj-api">21 CFR Part 11 · False Claims Act defence · Audit-ready documentation · SOX controls</div>
        </div>
      </div>
      <div class="crm-obj-desc">Government pricing errors are not merely accounting mistakes — they are potential False Claims Act violations that can result in treble damages and exclusion from federal health programmes. Model N is built as an audit-ready, compliance-first platform: <strong>Complete audit trail</strong> — every calculation, every data input, every user action, every submission is logged with user ID, timestamp, and before/after values; creates the documentation chain needed to defend government pricing calculations in CMS audits or DOJ investigations. <strong>Restatement management</strong> — when historical AMP or Best Price calculations need correction (due to late-arriving data or calculation errors), Model N manages the restatement process, recalculates affected quarters, and submits amendments to CMS with full change documentation. <strong>SOX controls</strong> — as a system that directly impacts publicly reported financial statements (through gross-to-net accruals), Model N is subject to Sarbanes-Oxley internal controls; access controls, segregation of duties, and approval workflows are configured to satisfy SOX requirements. <strong>Pricing policy enforcement</strong> — pricing rules are configured in the system once, approved through governance, and automatically applied to every transaction; eliminates manual calculation errors that create compliance exposure.</div>
    </div>
  </div>

  <h2 id="ma-anaplan">Anaplan — Connected Planning for Market Access</h2>
  <p>While Model N manages the transactional reality of contracts and government pricing, Anaplan provides the planning, forecasting, and scenario modelling layer — connecting market access strategy with financial targets, commercial planning, and supply chain. Anaplan's in-memory calculation engine and connected planning architecture allow market access teams to model complex "what-if" scenarios across WAC pricing, rebate strategies, formulary assumptions, and patient access programme investments in real time.</p>

  <div class="crm-obj-grid" style="margin:24px 0;">
    <div class="crm-obj-card" style="border-left:3px solid #E05A00; border-top:1px solid #6B2A00; border-right:1px solid #6B2A00; border-bottom:1px solid #6B2A00;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#1a1000">📊</div>
        <div>
          <div class="crm-obj-name" style="color:#E09A60">Anaplan — Gross-to-Net Planning &amp; Forecasting</div>
          <div class="crm-obj-api">Rebate accrual forecast · Net revenue planning · GTN ratio modelling · Sensitivity analysis</div>
        </div>
      </div>
      <div class="crm-obj-desc">The gross-to-net planning model in Anaplan is the central forecasting tool for market access finance. It connects formulary coverage assumptions, contracted rebate rates, government pricing projections, and patient volume forecasts into a unified net revenue model. <strong>Connected data inputs</strong> — Anaplan pulls actual gross sales from ERP (SAP/Oracle), actual rebate payments from Model N, formulary coverage from market intelligence vendors, and NRx/TRx demand data from IQVIA; all inputs refresh on defined schedules so the GTN model is always based on current actuals. <strong>Rolling forecast</strong> — Anaplan's continuous planning architecture supports a rolling 18-month forecast that updates automatically as actuals are posted; eliminates the quarterly "black box" forecasting cycle of spreadsheet-based planning. <strong>Scenario modelling</strong> — market access teams model formulary coverage scenarios (e.g., what happens to net revenue if a major PBM excludes the drug in Q3?) with instant recalculation across all connected metrics including financial plan, sales quota, and supply demand signals. <strong>GTN ratio trending</strong> — tracks gross-to-net ratio over time and flags deterioration (e.g., rising rebate rates due to competitive pressure) as an early warning to pricing strategy teams.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #E05A00; border-top:1px solid #6B2A00; border-right:1px solid #6B2A00; border-bottom:1px solid #6B2A00;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#1a1000">🎯</div>
        <div>
          <div class="crm-obj-name" style="color:#E09A60">Anaplan — Contracting Strategy &amp; Rebate Optimisation</div>
          <div class="crm-obj-api">Rebate modelling · Tier placement optimisation · Portfolio strategy · Deal economics</div>
        </div>
      </div>
      <div class="crm-obj-desc">Before entering a formulary negotiation, market access teams use Anaplan to model the economics of every deal scenario. <strong>Rebate-volume trade-off modelling</strong> — the core question is: at what rebate rate does preferred tier placement generate enough incremental prescription volume to offset the rebate cost and produce higher net revenue than a lower-rebate non-preferred position? Anaplan models this trade-off using demand elasticity curves calibrated to historical access data. <strong>Portfolio contracting</strong> — for companies with multiple products, Anaplan models portfolio bundle contracts where a preferred position for Product A is traded against a preferred position for Product B; cross-portfolio deal optimisation requires simultaneous modelling of all product-payer combinations. <strong>Exclusivity economics</strong> — models the incremental volume (and associated incremental rebate cost) of paying an exclusivity premium versus the benefit of a formulary exclusively. <strong>Contract performance simulation</strong> — for performance-tiered contracts, Anaplan simulates the probability of hitting each tier threshold based on historical market share data and forecasted demand, allowing teams to negotiate tiers that are achievable but stretch commercial performance.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #E05A00; border-top:1px solid #6B2A00; border-right:1px solid #6B2A00; border-bottom:1px solid #6B2A00;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#1a1000">🌐</div>
        <div>
          <div class="crm-obj-name" style="color:#E09A60">Anaplan — Brand Planning &amp; LOE Forecasting</div>
          <div class="crm-obj-api">Launch forecast · Loss of exclusivity · Patient flow modelling · Lifecycle management</div>
        </div>
      </div>
      <div class="crm-obj-desc">Anaplan connects market access modelling to the broader brand planning and lifecycle management process. <strong>Launch revenue forecast</strong> — integrates formulary coverage ramp assumptions (what % of covered lives will have preferred access in months 1, 6, 12 post-launch) with TRx demand forecasts and GTN assumptions to project net revenue by quarter for the first 3–5 years. <strong>Loss of Exclusivity (LOE) planning</strong> — models the revenue cliff when patent protection expires and generics enter: generic penetration curves, managed care formulary switching, authorised generic strategy, and the residual branded volume that remains. <strong>Patient journey modelling</strong> — builds a patient flow model from diagnosis to therapy initiation, tracking conversion rates at each step (diagnosed → treated → switched to this drug) and the access barriers (PA denial rate, co-pay burden, step therapy) that reduce conversion; used to size patient support programme investment. <strong>Indication expansion</strong> — models revenue impact of a new indication submission including incremental formulary negotiations, label expansion timing, and incremental patient population size.</div>
    </div>
    <div class="crm-obj-card" style="border-left:3px solid #E05A00; border-top:1px solid #6B2A00; border-right:1px solid #6B2A00; border-bottom:1px solid #6B2A00;">
      <div class="crm-obj-header">
        <div class="crm-obj-icon" style="background:#1a1000">🔗</div>
        <div>
          <div class="crm-obj-name" style="color:#E09A60">Anaplan — Connected Planning Architecture</div>
          <div class="crm-obj-api">Finance · Supply chain · Commercial · HR · Single source of truth · API integrations</div>
        </div>
      </div>
      <div class="crm-obj-desc">Anaplan's differentiated architecture is its ability to connect plans across functions in a single in-memory platform, eliminating the "Excel island" problem where each function maintains its own disconnected version of the forecast. <strong>Finance integration</strong> — Anaplan's net revenue model feeds directly into the financial P&amp;L forecast in the corporate financial planning model; when market access updates a contracting assumption, the impact on gross profit flows immediately to finance. <strong>Supply chain integration</strong> — demand forecasts from Anaplan drive supply planning (manufacturing batch sizing, distribution inventory levels); access-driven demand shocks (new formulary win adding 5M covered lives) are immediately visible to supply planners. <strong>Commercial quota setting</strong> — net revenue forecasts by territory and product flow from Anaplan to the commercial team's quota-setting model; quotas reflect realistic net-price expectations, not inflated WAC-based numbers. <strong>API ecosystem</strong> — Anaplan connects to Model N (for actual GTN data), SAP/Oracle (for financial actuals), IQVIA/Symphony (for market data), and Veeva CRM (for commercial activity and forecast data) through a pre-built connector library and CloudWorks integration platform. The result: a single, continuously updated enterprise forecast that replaces the quarterly 6-week budgeting cycle.</div>
    </div>
  </div>

  <div class="callout insight" style="margin:32px 0 16px;">
    <div class="callout-title">💡 Model N + Anaplan: How They Work Together</div>
    Model N is the system of record for what actually happened — the transactional truth of every contract, chargeback, rebate payment, and government price calculation. Anaplan is the system of intelligence for what will happen — the forward-looking planning, scenario modelling, and cross-functional alignment engine. Data flows from Model N into Anaplan quarterly (or more frequently via API) to ground planning assumptions in transactional reality. A contracting team member negotiating a new PBM agreement in Anaplan's deal modelling tool is working with actual current-quarter rebate rates pulled from Model N, actual formulary coverage data from market intelligence feeds, and actual demand data from IQVIA — producing a deal model that is both analytically rigorous and operationally grounded. The two systems together close the loop between strategy and execution in market access.
  </div>
...
CHAPTERS = [
    ...
    ('ch-ma',    'Ch 5 · Market Access'),
    ('ch6',      'Ch 6 · The Firewall'),
    ('ch7',      'Ch 7 · R&D Bridge'),
    ('ch8',      'Ch 8 · The Launch'),
    ('ch9',      'Ch 9 · The People'),
    ('ch10',     'Ch 10 · The Rules'),
    ('ch11',     'Ch 11 · Putting It Together'),
    ('ch12',          'Ch 12 · Veeva Systems'),
    ('ch-vault-crm',  'Ch 13 · Vault CRM'),
    ('ch14',          'Ch 14 · Strategy'),
...
nav_ch_ma    = nav_footer('ch-ma')
nav_ch5      = nav_footer('ch6')
nav_ch6      = nav_footer('ch7')
nav_ch7      = nav_footer('ch8')
nav_ch8      = nav_footer('ch9')
nav_ch9      = nav_footer('ch10')
nav_ch10     = nav_footer('ch11')
nav_ch11         = nav_footer('ch12')
nav_ch_vault_crm = nav_footer('ch-vault-crm')
nav_ch14         = nav_footer('ch14')
  ...
  <figure class="vis-embed" aria-label="Product Management Flow">
    ...
    <div class="vis-inner" style="padding:22px 16px;">
      <svg viewBox="0 0 960 210" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:680px;display:block;">
        ...
        <rect width="960" height="210" fill="#F8FAFC"/>
        ...
        <text x="8" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">1</text>

        <!-- Step 2: Territory-Product Config -->
        <rect x="168" y="30" width="148" height="120" rx="7" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <circle cx="242" cy="58" r="16" fill="#1B3A6B" fill-opacity=".4" stroke="#1B3A6B" stroke-width="1"/>
        <text x="242" y="63" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">T-P</text>
        <text x="242" y="90" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">Territory-Product</text>
        ...
        <text x="168" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">2</text>

        <!-- Step 3: Detail Priority -->
        <rect x="336" y="30" width="148" height="120" rx="7" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <circle cx="410" cy="58" r="16" fill="#1B3A6B" fill-opacity=".4" stroke="#1B3A6B" stroke-width="1"/>
        <text x="410" y="63" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">D#</text>
        <text x="410" y="90" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">Detail Priority</text>
        ...
        <text x="336" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">3</text>

        <!-- Step 4: CLM Presentation -->
        <rect x="504" y="30" width="148" height="120" rx="7" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <circle cx="578" cy="58" r="16" fill="#1B3A6B" fill-opacity=".4" stroke="#1B3A6B" stroke-width="1"/>
        <text x="578" y="63" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">CLM</text>
        <text x="578" y="90" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">CLM Presentation</text>
        ...
        <text x="504" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">4</text>

        <!-- Step 5: Products Detailed -->
        <rect x="672" y="30" width="148" height="120" rx="7" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <circle cx="746" cy="58" r="16" fill="#0B5E5E" fill-opacity=".4" stroke="#99E6E6" stroke-width="1"/>
        <text x="746" y="63" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">PD</text>
        <text x="746" y="90" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">Products Detailed</text>
        ...
        <text x="672" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">5</text>
        ...
        <text x="840" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">6</text>
        ...
        <line x1="820" y1="90" x2="840" y2="90" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#pa)"/>
  ...
  <figure class="vis-embed" aria-label="MIRF Lifecycle Flowchart">
    ...
    <div class="vis-inner" style="padding:20px 16px;">
      <svg viewBox="0 0 960 480" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:680px;display:block;">
        ...
        <rect x="20" y="28" width="150" height="52" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="95" y="48" text-anchor="middle" fill="#0B6B6B" font-size="10.5" font-weight="700">Rep-Assisted</text>
        ...
        <rect x="192" y="28" width="150" height="52" rx="6" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="267" y="48" text-anchor="middle" fill="#0B6060" font-size="10.5" font-weight="700">HCP Direct</text>
        ...
        <rect x="364" y="28" width="150" height="52" rx="6" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="439" y="48" text-anchor="middle" fill="#0B6060" font-size="10.5" font-weight="700">Congress / Event</text>
        ...
        <rect x="536" y="28" width="150" height="52" rx="6" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="611" y="48" text-anchor="middle" fill="#0B6060" font-size="10.5" font-weight="700">Digital / Email</text>
        ...
        <line x1="267" y1="80" x2="438" y2="116" stroke="#99E6E6" stroke-width="1" stroke-dasharray="3,3" marker-end="url(#mb)"/>
        <line x1="439" y1="80" x2="453" y2="116" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#mb)"/>
        <line x1="611" y1="80" x2="468" y2="116" stroke="#99E6E6" stroke-width="1" stroke-dasharray="3,3" marker-end="url(#mb)"/>
        ...
        <rect x="270" y="118" width="420" height="58" rx="7" fill="#E0F7F7" stroke="#2A9A9A" stroke-width="2"/>
        <text x="480" y="140" text-anchor="middle" fill="#0B6060" font-size="12" font-weight="700">Medical_Inquiry_vod__c — Record Created</text>
        <text x="480" y="155" text-anchor="middle" fill="#4A5568" font-size="9.5">Source · Product · Question text · HCP NPI · Inquiry Type · Urgency flag · Response method</text>
        ...
        <text x="270" y="122" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">①</text>

        <!-- ── STEP 2: AE Screening ── -->
        <line x1="480" y1="176" x2="480" y2="202" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#mb)"/>
        ...
        <text x="400" y="209" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">②</text>
        ...
        <text x="795" y="240" text-anchor="middle" fill="#4A5568" font-size="8.5">Parallel PV report · 15-day FDA clock starts</text>
        <text x="795" y="252" text-anchor="middle" fill="#4A5568" font-size="8.5">MIRF stays open until AE resolved</text>
        ...
        <line x1="480" y1="260" x2="480" y2="286" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#mb)"/>

        <!-- ── STEP 3: Classification ── -->
        <rect x="180" y="288" width="600" height="50" rx="7" fill="#061818" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="480" y="308" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">Classify Inquiry Type</text>
        ...
        <text x="180" y="292" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">③</text>

        <line x1="480" y1="338" x2="480" y2="360" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#mb)"/>

        <!-- ── STEP 4: SRL Check (diamond) ── -->
        <polygon points="480,362 570,388 480,414 390,388" fill="#061818" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="480" y="384" text-anchor="middle" fill="#0B6060" font-size="10" font-weight="700">SRL Available?</text>
        ...
        <text x="390" y="366" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">④</text>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin:22px 0 36px;">
    ...
    <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:8px;padding:14px;">
      ...
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Primary/secondary practice addresses, used for territory routing, call planning, and sample shipment. Validated against Veeva Network.</div>
      </div>
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Defines the hierarchy of territories — district, region, national — and maps each rep to their territory. Foundation of the SFE rollup reporting structure.</div>
      </div>
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Used by Key Account Managers for hospital systems, IDNs, and large group practices. Captures account objectives, stakeholder map, P&amp;T committee timeline, and formulary status.</div>
      </div>
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Calendar-blocked visits with HCPs. Converts to a full Call Report on execution. Drives rep planning efficiency and reduces missed target HCP visits.</div>
      </div>
      <div>
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Push messages from headquarters to field — new safety label update, competitive intelligence, launch activation, field force contests. Requires rep acknowledgement, creating a read-receipt audit trail.</div>
      </div>
    </div>
    ...
    <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:8px;padding:14px;">
      ...
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Each rep's live sample balance per product and lot. System alerts when inventory falls below reorder threshold or when a lot approaches expiry. Feeds quarterly PDMA reconciliation report.</div>
      </div>
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">When an HCP requests specific samples outside of a face-to-face rep visit (via portal, phone, or mail), a Sample Request record is created. It requires the same HCP signature and PDMA compliance as an in-person drop.</div>
      </div>
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Child of Multichannel_Consent — one record per channel (email, SMS, remote detail). Stores opt-in date, method (verbal/written), and jurisdiction. A single withdrawal record suppresses all digital outreach within 24 hours.</div>
      </div>
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Configurable survey forms delivered via CRM during or after a call. Used for brand perception research, patient identification questions, treatment landscape surveys. Responses feed Market Research analytics, not call metrics.</div>
      </div>
      <div>
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">AI-optimised routing sequences for a rep's daily call list, minimising drive time while maximising call count against high-priority Cycle Plan targets. Integrates with Google Maps via the Veeva CRM mobile app.</div>
      </div>
    </div>
    ...
    <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:8px;padding:14px;">
      ...
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">One attendance record per HCP per event. Captures role (attendee/speaker/chair/moderator), all TOV items (honorarium, travel, accommodation, meals), and FMV validation. The primary Sunshine Act data source for the annual CMS Open Payments report.</div>
      </div>
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Journals, congress abstracts, posters, and manuscripts linked to KOL accounts. MSLs reference publications in call reports. Authorship mapping identifies publication-active KOLs for advisory board and IIS engagement.</div>
      </div>
      <div style="margin-bottom:10px;">
      ...
      <div style="margin-bottom:10px;">
        ...
        <div style="font-size:10.5px;color:#4A5568;line-height:1.5;">Independent medical education (CME) grants and research support grants. All grants flow through an independent grants committee — commercial teams have no visibility. Grant amounts are captured for Sunshine Act reporting and AKS compliance audits.</div>
      </div>
      <div>
...
VAULT_EXTRA = """
  ...
  <figure class="vis-embed" aria-label="Vault PromoMats Document Lifecycle">
    ...
    <svg viewBox="0 0 960 355" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:960px;font-family:system-ui,sans-serif;display:block;">
      <defs>
        <marker id="pmlA" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#4A5568"/></marker>
      ...
      <rect width="960" height="355" rx="12" fill="#F8FAFC"/>
      ...
      <text x="73" y="93" text-anchor="middle" fill="#4A5568" font-size="8.5">Author creates /</text>
      <text x="73" y="105" text-anchor="middle" fill="#4A5568" font-size="8.5">edits content</text>
      <line x1="128" y1="84" x2="156" y2="84" stroke="#4B5563" stroke-width="1.5" marker-end="url(#pmlA)"/>

      <!-- STATE 2: SUBMITTED -->
      <rect x="158" y="55" width="120" height="58" rx="8" fill="#EBF0F8" stroke="#3070B0" stroke-width="1.5"/>
      ...
      <text x="218" y="104" text-anchor="middle" fill="#4A5568" font-size="8">Reviewer tasks created</text>
      ...
      <text x="391" y="94" text-anchor="middle" fill="#4A5568" font-size="8">Simultaneous task routing</text>
      <text x="391" y="107" text-anchor="middle" fill="#4A5568" font-size="8">Annotations &#8226; Votes &#8226; Comments</text>
      ...
      <text x="562" y="104" text-anchor="middle" fill="#4A5568" font-size="8">Expiry date assigned</text>
      ...
      <text x="728" y="112" text-anchor="middle" fill="#4A5568" font-size="7.5">Field force can access</text>
      ...
      <text x="728" y="211" text-anchor="middle" fill="#4A5568" font-size="7.5">Archived in Vault</text>
      ...
      <text x="344" y="214" text-anchor="middle" fill="#4A5568" font-size="7.5">Returned with annotations intact</text>
      ...
      <text x="281" y="298" text-anchor="middle" fill="#4A5568" font-size="8">Scientific accuracy</text>
      <text x="281" y="311" text-anchor="middle" fill="#4A5568" font-size="8">Fair balance &#8212; benefits</text>
      <text x="281" y="324" text-anchor="middle" fill="#4A5568" font-size="8">vs. risks &#8226; Label alignment</text>
      ...
      <text x="417" y="298" text-anchor="middle" fill="#4A5568" font-size="8">IP &#8226; Litigation risk</text>
      <text x="417" y="311" text-anchor="middle" fill="#4A5568" font-size="8">AKS / FCPA compliance</text>
      <text x="417" y="324" text-anchor="middle" fill="#4A5568" font-size="8">Off-label risk assessment</text>
      ...
      <text x="553" y="298" text-anchor="middle" fill="#4A5568" font-size="8">21 CFR Part 202/203</text>
      <text x="553" y="311" text-anchor="middle" fill="#4A5568" font-size="8">FDA Form 2253 submission</text>
      <text x="553" y="324" text-anchor="middle" fill="#4A5568" font-size="8">Claims-to-reference check</text>
    </svg>
  ...
  <figure class="vis-embed" aria-label="PromoMats CRM Integration Architecture">
    ...
    <svg viewBox="0 0 940 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:940px;font-family:system-ui,sans-serif;display:block;">
      ...
      <rect width="940" height="420" rx="12" fill="#F8FAFC"/>
      ...
      <text x="140" y="82" text-anchor="middle" fill="#4A5568" font-size="8.5">Content Mgmt &#38; MLR Workflow</text>
      ...
      <text x="140" y="128" text-anchor="middle" fill="#4A5568" font-size="8">HTML5 package &#8226; slide-level metadata</text>
      ...
      <text x="140" y="174" text-anchor="middle" fill="#4A5568" font-size="8">Locked body &#8226; consent-gated send rules</text>
      ...
      <text x="140" y="220" text-anchor="middle" fill="#4A5568" font-size="8">MLR-approved talking points per indication</text>
      ...
      <text x="140" y="266" text-anchor="middle" fill="#4A5568" font-size="8">PDF &#8226; distributed doc record per call</text>
      ...
      <text x="140" y="312" text-anchor="middle" fill="#4A5568" font-size="8">Vault Medical &#8226; MIRF response content</text>
      ...
      <text x="140" y="358" text-anchor="middle" fill="#4A5568" font-size="8">Triggers CRM auto-withdrawal</text>
      ...
      <text x="802" y="82" text-anchor="middle" fill="#4A5568" font-size="8.5">iRep &#8226; Call Reports &#8226; Field Execution</text>
      ...
      <text x="802" y="128" text-anchor="middle" fill="#4A5568" font-size="8">Slide view &#8226; dwell time &#8226; sequence logged</text>
      ...
      <text x="802" y="174" text-anchor="middle" fill="#4A5568" font-size="8">Consent-gated &#8226; open / click analytics</text>
      ...
      <text x="802" y="220" text-anchor="middle" fill="#4A5568" font-size="8">HCP reaction (Agree &#8594; Disagree) captured</text>
      ...
      <text x="802" y="266" text-anchor="middle" fill="#4A5568" font-size="8">Linked to Call Reports &#8226; status &#8226; expiry</text>

      <rect x="690" y="282" width="224" height="38" rx="5" fill="#E0F7F7" stroke="#208060" stroke-width="1"/>
      <text x="802" y="299" text-anchor="middle" fill="#40B090" font-size="9.5" font-weight="600">Medical_Inquiry_vod__c &#38; MSL iRep</text>
      <text x="802" y="312" text-anchor="middle" fill="#4A5568" font-size="8">SRL retrieved &#8226; MIRF response logged</text>
      ...
      <text x="802" y="358" text-anchor="middle" fill="#4A5568" font-size="8">Rep library updated &#8226; 30-day advance warning</text>
    </svg>
...
NETWORK_EXTRA = """
  ...
  <figure class="vis-embed" aria-label="Veeva Network Data Sources and Master Record Model">
    ...
    <svg viewBox="0 0 960 400" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:960px;font-family:system-ui,sans-serif;display:block;">
      ...
      <rect width="960" height="400" rx="12" fill="#F8FAFC"/>
      ...
      <text x="392" y="172" text-anchor="middle" fill="#4A5568" font-size="7.5">Normalise formats &#8226; dedup keys</text>
      ...
      <text x="392" y="210" text-anchor="middle" fill="#4A5568" font-size="7.5">Match &#8226; merge &#8226; survivorship rules</text>
      ...
      <text x="392" y="248" text-anchor="middle" fill="#4A5568" font-size="7.5">NPI &#8226; DEA &#8226; Licence &#8226; OIG/GSA</text>
      ...
      <text x="538" y="199" fill="#4A5568" font-size="7.5" font-style="italic">Linked to CRM Contact via vid__v</text>
      ...
      <!-- HCO Record -->
      <rect x="526" y="232" width="196" height="150" rx="8" fill="#0A1010" stroke="#99E6E6" stroke-width="1.5"/>
      <text x="624" y="253" text-anchor="middle" fill="#0B6060" font-size="10.5" font-weight="700">HCO Master Record</text>
      <line x1="538" y1="260" x2="710" y2="260" stroke="#99E6E6" stroke-width="1"/>
      ...
      <text x="538" y="365" fill="#4A5568" font-size="7.5" font-style="italic">Linked to CRM Account via vid__v</text>
      ...
      <text x="756" y="100" fill="#4A5568" font-size="8">IDN (Kaiser Permanente)</text>
      <text x="772" y="115" fill="#4A5568" font-size="8">&#9500; Regional Hospital</text>
      <text x="788" y="130" fill="#4A5568" font-size="8">&#9500; Outpatient Clinic</text>
      <text x="804" y="145" fill="#4A5568" font-size="8">&#9492; Department (Cardiology)</text>
      ...
      <text x="840" y="221" text-anchor="middle" fill="#4A5568" font-size="8">Nightly: Account &#38; Contact updated</text>
      <text x="840" y="235" text-anchor="middle" fill="#4A5568" font-size="8">via VID linkage &#8226; OIG flag real-time</text>
      ...
      <!-- Veeva Align box -->
      <rect x="732" y="262" width="216" height="58" rx="8" fill="#F8FAFC" stroke="#BBF7D0" stroke-width="1.5"/>
      <text x="840" y="282" text-anchor="middle" fill="#70A030" font-size="9" font-weight="600">Veeva Align (Territory)</text>
      <text x="840" y="297" text-anchor="middle" fill="#4A5568" font-size="8">Primary affiliation &#8594; territory</text>
      <text x="840" y="311" text-anchor="middle" fill="#4A5568" font-size="8">alignment &#8594; rep ownership</text>

      <line x1="722" y1="310" x2="732" y2="295" stroke="#BBF7D0" stroke-width="1" marker-end="url(#netA)"/>
    </svg>
  ...
  <figure class="vis-embed" aria-label="Network CRM Align Integration Flow">
    ...
    <svg viewBox="0 0 940 390" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:940px;font-family:system-ui,sans-serif;display:block;">
      ...
      <rect width="940" height="390" rx="12" fill="#F8FAFC"/>
      ...
      <text x="143" y="80" text-anchor="middle" fill="#4A5568" font-size="8.5">HCP / HCO Master Data (MDM)</text>
      ...
      <text x="143" y="124" text-anchor="middle" fill="#4A5568" font-size="8">VID &#8226; NPI &#8226; DEA &#8226; specialty &#8226; address</text>
      ...
      <text x="143" y="168" text-anchor="middle" fill="#4A5568" font-size="8">VID &#8226; NPI &#8226; type &#8226; parent hierarchy</text>
      ...
      <text x="143" y="212" text-anchor="middle" fill="#4A5568" font-size="8">Primary flag &#8226; address &#8226; role</text>
      ...
      <text x="143" y="256" text-anchor="middle" fill="#4A5568" font-size="8">Real-time stream &#8226; blocks sample &#38; spend</text>

      <rect x="27" y="272" width="232" height="36" rx="5" fill="#0A1A0A" stroke="#BBF7D0" stroke-width="1"/>
      <text x="143" y="288" text-anchor="middle" fill="#70A030" font-size="9.5" font-weight="600">Licence &#38; DEA Credential</text>
      <text x="143" y="300" text-anchor="middle" fill="#4A5568" font-size="8">Schedule auth. &#8226; expiry &#8226; state</text>

      <rect x="27" y="316" width="232" height="32" rx="5" fill="#082020" stroke="#99E6E6" stroke-width="1"/>
      <text x="143" y="332" text-anchor="middle" fill="#0B6060" font-size="9.5" font-weight="600">DCR (stewardship queue)</text>
      <text x="143" y="344" text-anchor="middle" fill="#4A5568" font-size="8">Field corrections &#8594; validated &#8594; applied</text>
      ...
      <text x="470" y="337" text-anchor="middle" fill="#0B6060" font-size="8" font-weight="600">&#8592; DCR submitted from CRM &#8594; Network stewardship</text>
      ...
      <line x1="271" y1="202" x2="660" y2="202" stroke="#BBF7D0" stroke-width="1.2" marker-end="url(#ncG)"/>
      <line x1="271" y1="246" x2="660" y2="246" stroke="#903030" stroke-width="1.2" marker-end="url(#ncR)"/>
      <line x1="271" y1="290" x2="660" y2="290" stroke="#BBF7D0" stroke-width="1.2" marker-end="url(#ncG)"/>
      <!-- DCR reverse arrow -->
      <path d="M660,330 Q470,355 271,330" fill="none" stroke="#99E6E6" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#ncAL)"/>
      ...
      <text x="794" y="80" text-anchor="middle" fill="#4A5568" font-size="8.5">Field Force Execution &#38; Territory Mgmt</text>
      ...
      <text x="794" y="124" text-anchor="middle" fill="#4A5568" font-size="8">vid__v field links to Network master</text>
      ...
      <text x="794" y="168" text-anchor="middle" fill="#4A5568" font-size="8">IDN hierarchy for formulary &#38; P&#38;T access</text>

      <rect x="674" y="184" width="240" height="36" rx="5" fill="#0A180A" stroke="#BBF7D0" stroke-width="1"/>
      <text x="794" y="200" text-anchor="middle" fill="#70A030" font-size="9.5" font-weight="600">Veeva Align &#8212; Territory Map</text>
      <text x="794" y="212" text-anchor="middle" fill="#4A5568" font-size="8">HCP &#8594; territory &#8594; rep ownership</text>
      ...
      <text x="794" y="256" text-anchor="middle" fill="#4A5568" font-size="8">Sample &#38; spend blocked &#8226; manager alerted</text>

      <rect x="674" y="272" width="240" height="36" rx="5" fill="#0A180A" stroke="#BBF7D0" stroke-width="1"/>
      <text x="794" y="288" text-anchor="middle" fill="#70A030" font-size="9.5" font-weight="600">PDMA Sample Gate</text>
      <text x="794" y="300" text-anchor="middle" fill="#4A5568" font-size="8">DEA &#38; licence verified before sample drop</text>

      <rect x="674" y="316" width="240" height="32" rx="5" fill="#082020" stroke="#99E6E6" stroke-width="1"/>
      <text x="794" y="332" text-anchor="middle" fill="#0B6060" font-size="9.5" font-weight="600">Rep submits DCR from CRM</text>
      <text x="794" y="344" text-anchor="middle" fill="#4A5568" font-size="8">&#x22;Add HCP&#x22; / address fix &#8594; Network queue</text>
    </svg>
...
CLM_EXTRA_NEW = """
  ...
  <figure class="vis-embed" aria-label="In-Call CLM Data Capture Flow">
    ...
    <svg viewBox="0 0 960 380" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:960px;font-family:system-ui,sans-serif;display:block;">
      ...
      <rect width="960" height="380" rx="12" fill="#F8FAFC"/>
      ...
      <text x="88" y="86" text-anchor="middle" fill="#4A5568" font-size="7.5">Cycle plan loaded</text>
      ...
      <text x="88" y="134" text-anchor="middle" fill="#4A5568" font-size="7.5">Network VID validated</text>
      ...
      <text x="88" y="182" text-anchor="middle" fill="#4A5568" font-size="7.5">Call_vod__c created</text>
      ...
      <text x="88" y="230" text-anchor="middle" fill="#4A5568" font-size="7.5">CLM_Presentation_vod__c logged</text>
      ...
      <text x="88" y="278" text-anchor="middle" fill="#4A5568" font-size="7.5">Slides &#8226; Key Messages &#8226; Reactions</text>
      ...
      <text x="88" y="326" text-anchor="middle" fill="#4A5568" font-size="7.5">Call committed &#8226; sync queued</text>
      ...
      <text x="252" y="122" fill="#4A5568" font-size="8">Dwell: 48 sec &#8226; Fully viewed</text>
      ...
      <text x="252" y="172" fill="#4A5568" font-size="8">Dwell: 2 min 14 sec &#8226; Reaction: Agree &#9733;</text>
      ...
      <text x="252" y="222" fill="#4A5568" font-size="8">Dwell: 1 min 32 sec &#8226; Reaction: Neutral</text>
      ...
      <text x="252" y="272" fill="#4A5568" font-size="8">Dwell: 0 sec &#8226; Swiped past</text>
      ...
      <text x="252" y="322" fill="#4A5568" font-size="8">Dwell: 54 sec &#8226; Mandatory &#8212; cannot skip</text>
      <text x="252" y="333" fill="#4A5568" font-size="8">Key Message: &#x22;Tier 2 formulary 85% plans&#x22;</text>
      ...
      <text x="788" y="86" text-anchor="middle" fill="#4A5568" font-size="7.5">HCP VID &#8226; call date &#8226; duration &#8226; CLM flag &#8226; signature</text>
      ...
      <text x="788" y="133" text-anchor="middle" fill="#4A5568" font-size="7.5">Approved doc link &#8226; deck version &#8226; start time</text>
      <text x="788" y="146" text-anchor="middle" fill="#4A5568" font-size="7.5">slides_shown__v &#8226; slides_skipped__v</text>
      ...
      <text x="788" y="193" text-anchor="middle" fill="#4A5568" font-size="7.5">Per-slide record: slide_id &#8226; entry_time</text>
      <text x="788" y="205" text-anchor="middle" fill="#4A5568" font-size="7.5">exit_time &#8226; dwell_sec &#8226; reaction_vod__c</text>
      <text x="788" y="217" text-anchor="middle" fill="#4A5568" font-size="7.5">swipe_direction &#8226; presented_flag</text>

      <rect x="630" y="234" width="316" height="48" rx="6" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
      <text x="788" y="250" text-anchor="middle" fill="#0B6060" font-size="9" font-weight="600">Key_Message_vod__c + Reaction</text>
      <text x="788" y="263" text-anchor="middle" fill="#4A5568" font-size="7.5">message_id &#8226; reaction_vod__c (1&#8211;5)</text>
      <text x="788" y="276" text-anchor="middle" fill="#4A5568" font-size="7.5">1=Strongly Agree &#8230; 5=Strongly Disagree</text>
      ...
      <text x="788" y="319" text-anchor="middle" fill="#4A5568" font-size="7.5">product &#8226; detail priority (1st/2nd/3rd)</text>
      <text x="788" y="332" text-anchor="middle" fill="#4A5568" font-size="7.5">CLM_presentation_vod__c &#8226; sample drop ref</text>

      <!-- analytics arrow from CRM records -->
      <path d="M788,348 Q788,368 480,368 Q172,368 88,348" fill="none" stroke="#99E6E6" stroke-width="1.2" stroke-dasharray="5,3" marker-end="url(#clmO)"/>
      <text x="480" y="363" text-anchor="middle" fill="#0B6060" font-size="7.5">Sync to analytics engine &#8212; aggregated by slide &#8226; territory &#8226; specialty &#8226; prescribing tier &#8226; date &#8594; PromoMats brand dashboard</text>
    </svg>
  ...
  <figure class="vis-embed" aria-label="Full CLM Ecosystem">
    ...
    <svg viewBox="0 0 960 440" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:960px;font-family:system-ui,sans-serif;display:block;">
      ...
      <rect width="960" height="440" rx="12" fill="#F8FAFC"/>
      ...
      <text x="135" y="77" text-anchor="middle" fill="#4A5568" font-size="8">MLR-approved promotional content</text>
      ...
      <rect x="720" y="42" width="210" height="110" rx="10" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
      <text x="825" y="62" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">Vault Medical</text>
      <text x="825" y="77" text-anchor="middle" fill="#4A5568" font-size="8">Scientific content (non-promotional)</text>
      <line x1="732" y1="84" x2="918" y2="84" stroke="#99E6E6" stroke-width="1"/>
      ...
      <text x="480" y="117" text-anchor="middle" fill="#4A5568" font-size="8.5">iRep &#8226; MSL iRep &#8226; Veeva Engage</text>
      ...
      <text x="409" y="162" text-anchor="middle" fill="#4A5568" font-size="7.5">Promotional CLM sessions</text>

      <rect x="486" y="132" width="120" height="40" rx="5" fill="#E0F7F7" stroke="#208060" stroke-width="1"/>
      <text x="546" y="149" text-anchor="middle" fill="#40B090" font-size="9" font-weight="600">MSL iRep (Medical)</text>
      <text x="546" y="162" text-anchor="middle" fill="#4A5568" font-size="7.5">Scientific CLM + Insights</text>
      ...
      <text x="409" y="210" text-anchor="middle" fill="#4A5568" font-size="7.5">All channels &#8226; in-person &#38; remote</text>
      ...
      <text x="546" y="210" text-anchor="middle" fill="#4A5568" font-size="7.5">Per-slide engagement data</text>
      ...
      <text x="135" y="326" text-anchor="middle" fill="#4A5568" font-size="8">SFE &#38; PromoMats dashboards</text>
      ...
      <rect x="720" y="290" width="210" height="120" rx="10" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
      <text x="825" y="311" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">Medical Analytics</text>
      <text x="825" y="326" text-anchor="middle" fill="#4A5568" font-size="8">Insight aggregation &#38; MedComms</text>
      <line x1="732" y1="333" x2="918" y2="333" stroke="#99E6E6" stroke-width="1"/>
      ...
      <text x="480" y="343" text-anchor="middle" fill="#4A5568" font-size="8">Remote video meeting + CLM mirroring</text>
      ...
      <line x1="720" y1="97" x2="630" y2="140" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#ecoT)"/>
      ...
      <line x1="570" y1="240" x2="760" y2="290" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#ecoT)"/>
      ...
      <path d="M825,290 Q860,220 825,152" fill="none" stroke="#99E6E6" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#ecoT)"/>
  ...
  <figure class="vis-embed" aria-label="Vault Medical document lifecycle">
    ...
    <div class="vis-inner">
      <svg viewBox="0 0 900 310" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Vault Medical MRB lifecycle diagram">
        <defs>
          <marker id="vmA" markerWidth="7" markerHeight="5" refX="7" refY="2.5" orient="auto"><polygon points="0 0,7 2.5,0 5" fill="#0B6060"/></marker>
        ...
        <!-- Active -->
        <rect x="790" y="130" width="90" height="44" rx="6" fill="#0B6060" stroke="#1A6A6A" stroke-width="1.5"/>
        ...
        <!-- Step labels -->
        <text x="139" y="66" text-anchor="middle" fill="#0B6060" font-size="7.5" font-family="sans-serif">submit</text>
        <text x="304" y="66" text-anchor="middle" fill="#0B6060" font-size="7.5" font-family="sans-serif">QC pass</text>
        <text x="474" y="66" text-anchor="middle" fill="#0B6060" font-size="7.5" font-family="sans-serif">MD approve</text>
        <text x="644" y="66" text-anchor="middle" fill="#0B6060" font-size="7.5" font-family="sans-serif">legal clear</text>
  ...
  <figure class="vis-embed" aria-label="Vault Medical integration map">
    ...
    <div class="vis-inner">
      <svg viewBox="0 0 900 420" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Vault Medical integration diagram">
        <defs>
          <marker id="vmiA" markerWidth="7" markerHeight="5" refX="7" refY="2.5" orient="auto"><polygon points="0 0,7 2.5,0 5" fill="#0B6060"/></marker>
          ...
          <marker id="vmiAL" markerWidth="7" markerHeight="5" refX="0" refY="2.5" orient="auto"><polygon points="7 0,0 2.5,7 5" fill="#0B6060"/></marker>
        </defs>
        ...
        <rect x="330" y="160" width="240" height="80" rx="10" fill="#0B6060" stroke="#1A6A6A" stroke-width="2"/>
        ...
        <text x="240" y="120" fill="#0B6060" font-size="8" font-family="sans-serif" transform="rotate(-35,240,120)">content sync</text>
        <text x="310" y="148" fill="#0B6060" font-size="8" font-family="sans-serif" transform="rotate(-35,310,148)">call data</text>
        ...
        <text x="596" y="118" fill="#0B6060" font-size="8" font-family="sans-serif" transform="rotate(35,596,118)">SRL pull</text>
        <text x="648" y="150" fill="#0B6060" font-size="8" font-family="sans-serif" transform="rotate(35,648,150)">log sent</text>
...
#cardModal-panel {
  ...
  max-height: 88vh;
  box-shadow: 0 12px 48px rgba(10,61,98,.25);
...
#cardModal-titles { flex: 1; min-width: 0; }
#cardModal-name {
  font-size: 16px; font-weight: 700;
  color: #A8DADC; line-height: 1.3;
  margin-bottom: 3px;
}
#cardModal-api {
  font-size: 10.5px; font-family: monospace;
  color: #64B5B5; letter-spacing: .3px;
}
#cardModal-close {
  width: 32px; height: 32px; border-radius: 50%;
  border: 1px solid #80C8C8; background: transparent;
  color: #A8DADC; font-size: 16px; cursor: pointer; flex-shrink: 0;
  transition: background .15s, color .15s;
  display: flex; align-items: center; justify-content: center;
}
#cardModal-close:hover { background: #E8503A; color: #fff; border-color: #E8503A; }
#cardModal-body {
  padding: 22px 24px;
  overflow-y: auto;
...
#cardModal-body strong { color: #0A3D62; }
#cardModal-body .crm-field-pill {
...
.vis-expand-badge {
  ...
  background: rgba(10,61,98,.88); color: #A8DADC;
...
(function () {
  ...
  // ── Wire up all flashcards (.crm-obj-card) ──
  document.querySelectorAll('.crm-obj-card').forEach(function (card) {
    // add expand badge
    var badge = document.createElement('div');
    badge.className = 'crm-card-expand-badge';
    badge.textContent = '⊕ Expand';
    card.appendChild(badge);

    card.addEventListener('click', function (e) {
      if (e.target.closest('#cardModal')) return;
      openCard(card);
    });
  });
})();
...
window.openCard = function (card) {
  var iconEl  = card.querySelector('.crm-obj-icon');
  var nameEl  = card.querySelector('.crm-obj-name');
  var apiEl   = card.querySelector('.crm-obj-api');
  var descEl  = card.querySelector('.crm-obj-desc');

  var mIcon  = document.getElementById('cardModal-icon');
  var mName  = document.getElementById('cardModal-name');
  var mApi   = document.getElementById('cardModal-api');
  var mBody  = document.getElementById('cardModal-body');

  // icon — clone content + background colour
  if (iconEl) {
    mIcon.innerHTML = iconEl.innerHTML;
    mIcon.style.background = iconEl.style.background || '#1a2030';
  } else {
    mIcon.innerHTML = '📄';
    mIcon.style.background = '#1a2030';
  }

  // title — keep inline colour if set
  mName.innerHTML = nameEl ? nameEl.innerHTML : '';

  // API subtitle
  mApi.innerHTML = apiEl ? apiEl.innerHTML : '';

  // description — full HTML so pills, bold, links all work
  mBody.innerHTML = descEl ? descEl.innerHTML : '';
...
VEEVA_INTEG = """
  <h2 id="veeva-integration">Veeva Ecosystem &#8212; Integration Architecture</h2>
  <p>Every Veeva system is a node in a connected data network. The table below documents
  every major integration: source system, target system, integration method, and what data
  flows across the connection. Understanding these integrations is essential for any
  Commercial or Medical IS role — data quality, access control, and compliance all depend
  on them working correctly end to end.</p>

  <div class="table-scroll" style="overflow-x:auto;margin:24px 0;">
  <table style="width:100%;border-collapse:collapse;font-size:13px;line-height:1.5;">
    <thead>
      <tr style="background:var(--navy,#1B3A6B);color:#fff;">
        <th style="padding:10px 14px;text-align:left;white-space:nowrap;">Source</th>
        <th style="padding:10px 14px;text-align:left;white-space:nowrap;">Target</th>
        <th style="padding:10px 14px;text-align:left;white-space:nowrap;">Method</th>
        <th style="padding:10px 14px;text-align:left;">Data / Purpose</th>
      </tr>
    </thead>
    <tbody>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">Veeva OpenData</td>
        <td style="padding:9px 14px;white-space:nowrap;">Veeva Network</td>
        <td style="padding:9px 14px;white-space:nowrap;">Network API (nightly)</td>
        <td style="padding:9px 14px;">HCP/HCO master records including NPI, specialty,
        address, affiliations, license status. Feeds Network as the golden-record source.
        Network then publishes to CRM and Align.</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);background:var(--surface,#f7f9fc);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">Veeva Network</td>
        <td style="padding:9px 14px;white-space:nowrap;">Veeva CRM</td>
        <td style="padding:9px 14px;white-space:nowrap;">Network–CRM connector (real-time)</td>
        <td style="padding:9px 14px;">Account_vod__c and Address_vod__c records synced to CRM.
        DCR corrections in Network propagate immediately — reps see updated HCP data without
        manual intervention. Affiliation records drive territory re-assignment in Align.</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">Veeva Align</td>
        <td style="padding:9px 14px;white-space:nowrap;">Veeva CRM</td>
        <td style="padding:9px 14px;white-space:nowrap;">TSF publish event</td>
        <td style="padding:9px 14px;">Territory Snapshot File maps HCP → Territory → Rep.
        Published alignment activates CRM data access controls immediately. Rep can only
        view/call HCPs in their published territory. Prior TSF versions retained for IC audit.</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);background:var(--surface,#f7f9fc);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">Vault PromoMats</td>
        <td style="padding:9px 14px;white-space:nowrap;">Veeva CRM (CLM / AE)</td>
        <td style="padding:9px 14px;white-space:nowrap;">Native Vault–CRM connector</td>
        <td style="padding:9px 14px;">Approved promotional content → CLM presentations on
        rep iPads. Approved Email templates pushed to CRM Approved Email library. Content
        expiry in PromoMats automatically removes expired content from CRM — reps cannot
        present or send expired materials.</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">Veeva CRM</td>
        <td style="padding:9px 14px;white-space:nowrap;">Commercial CDW</td>
        <td style="padding:9px 14px;white-space:nowrap;">REST API / MuleSoft / Informatica</td>
        <td style="padding:9px 14px;">Call activity, sample transactions, Approved Email
        sends, CLM slide engagement data → data warehouse (Snowflake / Databricks). Joined
        to IQVIA Rx data for field force effectiveness analytics and IC calculations.</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);background:var(--surface,#f7f9fc);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">IQVIA / Symphony</td>
        <td style="padding:9px 14px;white-space:nowrap;">Commercial CDW</td>
        <td style="padding:9px 14px;white-space:nowrap;">SFTP → weekly ETL</td>
        <td style="padding:9px 14px;">Weekly prescription data (TRx, NRx, NBRx by HCP and
        territory). Loaded into CDW and joined to CRM call data to compute field force
        effectiveness metrics, HCP response curves, and IC attainment. Also surfaces in
        Veeva Align as HCP-level performance metrics.</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">HR System (Workday / SAP)</td>
        <td style="padding:9px 14px;white-space:nowrap;">Veeva CRM + Align</td>
        <td style="padding:9px 14px;white-space:nowrap;">API / SFTP roster sync</td>
        <td style="padding:9px 14px;">New hire event → auto-provisions rep in CRM with
        correct territory, role, product access, and call targets on Day 1. Termination event
        → same-day de-provisioning across CRM, Align, and all downstream analytics systems.
        Manager hierarchy changes propagate to Align Roster automatically.</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);background:var(--surface,#f7f9fc);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">Vault MedComms (MI System)</td>
        <td style="padding:9px 14px;white-space:nowrap;">Vault Safety / PV</td>
        <td style="padding:9px 14px;white-space:nowrap;">Manual transfer or API</td>
        <td style="padding:9px 14px;">Adverse events captured during Medical Information
        inquiries transferred to Pharmacovigilance for ICSR processing. Regulatory requirement:
        serious, unexpected AEs must reach PV within 24 hours. Any break in this transfer
        is a P1 compliance incident. Non-serious AEs included in periodic safety reports (PSURs).</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">Vault CTMS</td>
        <td style="padding:9px 14px;white-space:nowrap;">Vault EDC &amp; eTMF</td>
        <td style="padding:9px 14px;white-space:nowrap;">Native Vault integration</td>
        <td style="padding:9px 14px;">Site and subject data shared across CTMS, EDC, and eTMF
        without re-entry. Enrollment status synchronized in real time. TMF documents
        cross-linked to study/site records. Enables single-source-of-truth for clinical
        operations and regulatory inspection readiness.</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);background:var(--surface,#f7f9fc);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">Specialty Pharmacy (SP) Data</td>
        <td style="padding:9px 14px;white-space:nowrap;">Commercial CDW</td>
        <td style="padding:9px 14px;white-space:nowrap;">SFTP / Hub platform API</td>
        <td style="padding:9px 14px;">Patient dispense data, fill rates, persistency and
        adherence metrics from specialty pharmacy partners. Loaded into CDW for hub analytics,
        patient support programme performance, and GTN revenue recognition. Critical for
        specialty products where channel data is sparse.</td>
      </tr>
      <tr style="border-bottom:1px solid var(--border,#dde3ec);">
        <td style="padding:9px 14px;font-weight:600;white-space:nowrap;">CRM Events Management</td>
        <td style="padding:9px 14px;white-space:nowrap;">CDW → Open Payments (CMS)</td>
        <td style="padding:9px 14px;white-space:nowrap;">ETL / API → annual submission</td>
        <td style="padding:9px 14px;">HCP spend data from events (honoraria, meals, travel,
        consulting fees) flows from CRM Events Management into CDW, then into the annual CMS
        Sunshine Act (Open Payments) submission. Every dollar spent on a covered HCP must be
        reported. CRM is the system of record for spend capture — accuracy is a compliance
        requirement.</td>
      </tr>
    </tbody>
  </table>
...
VEEVA_ALIGN = """
  <h2 id="veeva-align">Veeva Align &#8212; Territory Management &amp; Alignment</h2>
  <p>Veeva Align is the system of record for field force territory design. It determines every
  sales representative&#8217;s geographic or account-based scope, call-frequency targets, and
  quota. Changes made in Align publish directly into Veeva CRM via the
  <strong>Territory Snapshot File (TSF)</strong>, controlling which representatives can see and
  interact with which HCP accounts. Without a valid alignment, a rep cannot create a call record
  for an HCP in CRM.</p>

  <h3 id="veeva-align-process">Veeva Align — Five-Step Activation Process</h3>
  <div class="crm-obj-grid" style="margin:24px 0;">
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">①</div>
        <div>
          <div class="crm-obj-name">Design Territory Geography</div>
          <div class="crm-obj-api">Territory_vod__c</div>
        </div>
      </div>
      <div class="crm-obj-desc">Commercial Operations defines territory boundaries — geographic
      (zip-code-based) or account-based (IDN, hospital). National → Region → District →
      Territory hierarchy is configured. Each territory gets a unique ID and is linked to a
    ...
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">②</div>
        <div>
          <div class="crm-obj-name">Assign HCPs to Territories</div>
          <div class="crm-obj-api">Address-based routing · HCP_Territory_vod__c</div>
        </div>
      </div>
      <div class="crm-obj-desc">Every HCP in Veeva Network is matched to a territory using their
      primary practice address. Affiliations (HCP works at multiple sites) create multi-territory
      assignments. When a Network address is corrected, Align re-routes the HCP
      automatically.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">③</div>
        <div>
          <div class="crm-obj-name">Assign Reps to Territories (Roster)</div>
          <div class="crm-obj-api">Roster_vod__c · HR integration (Workday/SAP)</div>
        </div>
      </div>
      <div class="crm-obj-desc">The active rep list with territory assignments and manager
      hierarchy. New hire provisioning is triggered by the Roster — when HR creates a new
      employee record, Align auto-provisions the rep in CRM with the correct territory, role,
      and product access. Terminations trigger same-day de-provisioning.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">④</div>
        <div>
          <div class="crm-obj-name">Set Call Frequency &amp; Quota Targets</div>
          <div class="crm-obj-api">Goal_vod__c · Call_Target_vod__c</div>
        </div>
      </div>
      <div class="crm-obj-desc">Call frequency targets (e.g., Tier A HCPs: 8 calls per quarter;
      Tier B: 4 calls per quarter) and Rx quota targets are set per territory. These drive the
      Incentive Compensation (IC) calculations — every target is traceable back to the
      alignment version that was active during the performance period.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">⑤</div>
        <div>
          <div class="crm-obj-name">Publish TSF → Veeva CRM</div>
          <div class="crm-obj-api">Territory Snapshot File · TSF publish event</div>
        </div>
      </div>
      <div class="crm-obj-desc">Publishing a new alignment activates all territory changes in
      CRM immediately. The TSF is a versioned snapshot mapping every HCP to a territory and
      rep. Once published, CRM enforces data access controls: a rep can only view and call
      HCPs assigned to their territory. Prior alignment versions are retained for IC
      audit purposes.</div>
    </div>
  </div>

  <h3 id="veeva-align-objects">Veeva Align — Key Objects Reference</h3>
  <div class="crm-obj-grid" style="margin:24px 0;">
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">🗺️</div>
        <div>
          <div class="crm-obj-name">Territory</div>
          <div class="crm-obj-api">Territory_vod__c</div>
        </div>
      </div>
      <div class="crm-obj-desc">Geographic or account-based unit within the field force
      hierarchy (National → Region → District → Territory). Defines the rep&#8217;s
      responsibility scope, product assignments, and call plan. Each territory has a unique
      ID that links to CRM, IC, and analytics systems.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">📄</div>
        <div>
          <div class="crm-obj-name">TSF — Territory Snapshot File</div>
          <div class="crm-obj-api">Published via Align → CRM sync</div>
        </div>
      </div>
      <div class="crm-obj-desc">Master alignment file mapping every HCP to a territory and
      rep. Published to CRM to activate data access controls. Controls which rep can see and
      call which HCPs. Versioned — each published snapshot is retained for compliance and
      IC audit. A new TSF publish overwrites the prior active alignment in CRM.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">📸</div>
        <div>
          <div class="crm-obj-name">Alignment</div>
          <div class="crm-obj-api">Alignment_vod__c</div>
        </div>
      </div>
      <div class="crm-obj-desc">Versioned snapshot of the full field force structure at a
      point in time. Publishing a new alignment activates territory changes in CRM immediately.
      Mid-year realignments (e.g., following a sales force expansion or product launch) create
      a new alignment version — the old version is locked and used for IC proration
      calculations.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">🎯</div>
        <div>
          <div class="crm-obj-name">Goal Setting</div>
          <div class="crm-obj-api">Goal_vod__c · Call_Target_vod__c</div>
        </div>
      </div>
      <div class="crm-obj-desc">Call frequency targets (calls per quarter by HCP tier) and
      Rx quota targets per territory. Drives Incentive Compensation calculations downstream.
      Targets are set during annual planning and can be adjusted mid-year via a new alignment
      version. IC systems pull Goal_vod__c records directly to compute attainment.</div>
    </div>
    <div class="crm-obj-card">
      <div class="crm-obj-header">
        <div class="crm-obj-icon">👤</div>
        <div>
          <div class="crm-obj-name">Roster</div>
          <div class="crm-obj-api">Roster_vod__c · HR System integration</div>
        </div>
      </div>
      <div class="crm-obj-desc">Active rep list with territory assignments and manager
      hierarchy. Integrated with HR systems (Workday, SAP) via SFTP or API. New hire triggers
      automatic CRM + Align provisioning — rep receives correct territory, role, product
      access, and call targets on Day 1. Termination triggers same-day de-provisioning across
      CRM, Align, and all downstream systems.</div>
    </div>
  </div>

  <div class="callout callout-info" style="margin:24px 0;">
    <strong>Key compliance point:</strong> Veeva Align is the enforcer of data access
    boundaries in CRM. A representative cannot view prescribing data, create call records,
    drop samples, or send approved emails for any HCP outside their published territory
    alignment. This boundary is enforced at the platform level — it cannot be overridden
    by the rep or their manager without a formal realignment event.
  </div>
"""
  ...
  <figure class="vis-embed" aria-label="Veeva CRM User Setup Flow">
    ...
    <div class="vis-inner">
      <svg viewBox="0 0 960 420" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Veeva CRM user creation flow">
        ...
        <rect width="960" height="420" fill="#F8FAFC" rx="10"/>
        ...
        <text x="85" y="72" text-anchor="middle" fill="#0B6B6B" font-size="10" font-weight="700" font-family="sans-serif">1. Setup Portal</text>
        ...
        <text x="245" y="72" text-anchor="middle" fill="#0B6B6B" font-size="10" font-weight="700" font-family="sans-serif">2. User Record</text>
        ...
        <text x="415" y="72" text-anchor="middle" fill="#0B6B6B" font-size="10" font-weight="700" font-family="sans-serif">3. License Type</text>
        ...
        <text x="585" y="72" text-anchor="middle" fill="#0B6B6B" font-size="10" font-weight="700" font-family="sans-serif">4. Profile Assignment</text>
        ...
        <text x="755" y="72" text-anchor="middle" fill="#0B6B6B" font-size="10" font-weight="700" font-family="sans-serif">5. Permission Sets</text>
        ...
        <!-- Step 8: Active -->
        <rect x="340" y="174" width="150" height="88" rx="7" fill="#E8F5EB" stroke="#27AE60" stroke-width="2"/>
        ...
        <text x="30" y="328" fill="#0B6B6B" font-size="9.5" font-weight="700" font-family="sans-serif">Key User Record Fields:</text>
  ...
  <figure class="vis-embed" aria-label="Veeva CRM Permission Architecture">
    ...
    <div class="vis-inner">
      <svg viewBox="0 0 900 520" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Veeva CRM permission model architecture diagram">
        ...
        <rect width="900" height="520" fill="#F8FAFC" rx="10"/>
        ...
        <text x="60" y="74" fill="#0B6B6B" font-size="11" font-weight="700" font-family="sans-serif">LAYER 1 &#8212; Profile (Base Access)</text>
        ...
        <text x="60" y="168" fill="#0B6B6B" font-size="11" font-weight="700" font-family="sans-serif">LAYER 2 &#8212; Permission Sets (Additive Feature Grants)</text>
...
<section class="fm-page" id="abstract" role="region" aria-label="Abstract">
  <div class="fm-inner">
    ...
    <h2 class="fm-heading">A Practitioner's Complete Reference to Pharma R&amp;D, Commercial, Medical Affairs &amp; Market Access</h2>
    <div class="fm-rule"></div>
    <div class="fm-body">
      <p>This guide provides a comprehensive, story-driven reference covering the full spectrum of pharmaceutical operations — from the earliest stages of laboratory discovery and R&amp;D regulatory strategy through clinical development, commercialisation, medical affairs, market access, and post-launch lifecycle management. Written for practitioners, consultants, and cross-functional professionals operating at the intersection of science, strategy, and systems, it integrates operational process, regulatory framework, technology platform, and pricing strategy into a single cohesive reference.</p>
      <p>The guide spans fourteen chapters and one reference section, encompassing: the R&amp;D-to-market pipeline; R&amp;D regulatory affairs including eTMF, RIM, and submission management (Veeva Vault RIM); commercial field operations and sales force effectiveness; medical affairs strategy, evidence generation, and MSL operations; the commercial–medical firewall; market access strategy covering pricing, reimbursement, payer relations, Gross-to-Net management, 340B compliance, and HEOR (Model N, Anaplan); product launch management; organisational roles and team structures; US and international regulatory compliance (21 CFR, GxP, ICH, AKS, Sunshine Act, PDMA, PhRMA Code, MDRP, IRA 2022, False Claims Act); the Veeva technology ecosystem (CRM, Vault PromoMats, Vault Medical, Vault RIM, eTMF, Network, Events Management, User Management); Vault CRM — the next-generation Veeva platform covering migration rationale, module architecture, admin setup, user management, permission sets, and integrations with PromoMats, MedComm, and Network; and pharmaceutical strategy encompassing brand positioning, portfolio management, lifecycle planning, global launch sequencing, competitive intelligence, stakeholder strategy, omnichannel execution, and integrated brand planning.</p>
      <p>Throughout, abstract process is grounded in concrete Veeva object architecture, data-flow diagrams, and operational decision trees. Interactive SVG process maps — all zoomable — visualise key workflows including the Market Access GTN waterfall, regulatory submission lifecycle, and launch readiness milestones. A 200+ term glossary provides precise definitions spanning R&amp;D regulatory, commercial, medical affairs, and market access terminology.</p>
      <div class="fm-meta-grid">
        ...
        <div class="fm-meta-item"><span class="fm-meta-label">Chapters</span><span class="fm-meta-val">14 + Glossary</span></div>
        ...
        <div class="fm-meta-item"><span class="fm-meta-label">Systems</span><span class="fm-meta-val">Veeva CRM, Vault PromoMats, Vault Medical, Vault RIM, eTMF, Network, Events Mgmt, Model N, Anaplan</span></div>
        <div class="fm-meta-item"><span class="fm-meta-label">Edition</span><span class="fm-meta-val">May 2026</span></div>
      </div>
      <p class="fm-keywords"><strong>Keywords:</strong> pharmaceutical R&amp;D · regulatory affairs · eTMF · Veeva Vault RIM · commercial affairs · medical affairs · market access · Veeva CRM · Vault CRM · Vault PromoMats · Vault Medical · FDA regulations · GxP compliance · 21 CFR Part 11 · Anti-Kickback Statute · Sunshine Act · product launch · HCP engagement · MSL operations · Gross-to-Net · Model N · Anaplan · 340B compliance · HEOR · ICER · MDRP · IRA 2022 · drug commercialisation · Vault CRM migration · permission sets · admin setup</p>
    </div>
  </div>
</section>
...
<section class="fm-page" id="preface" role="region" aria-label="Preface">
  <div class="fm-inner">
    ...
    <h2 class="fm-heading">Why This Guide Exists — and Who It Is For</h2>
    <div class="fm-rule"></div>
    <div class="fm-body fm-preface-body">
      <p>Pharmaceutical operations are, in practice, far more technically complex than their job titles suggest. A "sales representative" operates inside a validated CRM platform with multiple compliance checkpoints before a single sample can be transferred. A "medical science liaison" manages scientific exchange under a documented engagement plan, with every interaction recorded, every unsolicited request logged, and every response letter reviewed before it is sent. A "market access manager" negotiates formulary placement using a gross-to-net model that spans WAC pricing, PBM rebate tiers, government price calculations, 340B eligibility, and chargeback reconciliation — all tracked in a revenue management platform like Model N. An "R&amp;D regulatory affairs lead" manages a Trial Master File that must satisfy auditors in five regulatory zones, maintained in real time inside Veeva Vault eTMF.</p>
      <p>None of this complexity is well-documented in any single place. Regulatory frameworks live in Federal Register notices and ICH guidelines. Veeva object architecture lives in administrator guides. Market access economics live in consulting white papers. MSL best-practice lives in position statements. Process maps circulate inside individual companies in PowerPoint decks that are never published externally. Someone moving from R&amp;D into commercial, or from medical affairs into market access, has no single reference to orient themselves.</p>
      <p>This guide is my attempt to synthesise everything: the regulatory foundations, the operational processes, the technology platforms, the pricing and access economics, and the organisational structures — into a single cohesive reference that a practitioner can actually use. Every section is written to answer the question a new hire asks in their first month, a consultant faces before their first engagement, and an experienced professional confronts when they cross into a new function.</p>
      <p>The scope has grown with each edition. The guide now covers fourteen chapters:</p>
      <p><strong>Part I — Foundation</strong> (Ch 1–2) traces the drug from target identification through IND, Phase I–III trials, NDA/BLA submission, FDA review, and approval — including expedited programmes (Breakthrough Therapy, Fast Track, Priority Review, Accelerated Approval) and the R&amp;D Regulatory function that governs eTMF, Veeva Vault RIM, regulatory submissions, health authority interactions, and post-approval variation management.</p>
      <p><strong>Part II — Commercial Affairs</strong> (Ch 3) covers brand planning, sales force effectiveness, MLR content approval, PDMA sample management, and HCP engagement inside Veeva CRM and Vault PromoMats.</p>
      <p><strong>Part III — Medical Affairs</strong> (Ch 4) covers medical strategy, evidence generation, MSL field operations, scientific exchange, publications, and pharmacovigilance — supported by Veeva Vault Medical.</p>
      <p><strong>Part IV — Market Access</strong> (Ch 5) covers the full payer landscape — PBMs, commercial plans, Medicaid, Medicare Part B/D, and the VA — gross-to-net waterfall economics, formulary contracting and rebate strategy, government pricing compliance (AMP, Best Price, MDRP, 340B, ASP), HEOR and value-based contracting, patient support programmes, and how Model N and Anaplan automate and govern these processes end to end.</p>
      <p><strong>Parts V–VII</strong> (Ch 6–12) cover the commercial–medical firewall, the R&amp;D-to-launch bridge, the 36-month launch timeline, every organisational role, the full regulatory compliance framework (21 CFR, GxP, AKS, Sunshine Act, PDMA, False Claims Act, IRA 2022), integrated annual operating cycles, and the complete Veeva platform ecosystem — including Veeva CRM, Vault PromoMats, Vault Medical, Network MDM, and Events Management.</p>
      <p><strong>Part VIII — Vault CRM</strong> (Ch 13) addresses the next generation of Veeva's CRM platform: why pharmaceutical companies are migrating from the legacy Salesforce-based Veeva CRM to the native Vault CRM platform, what changes in the architecture and terminology, how each module works (Accounts, CLM, Approved Email, Sampling, Events, Engage, Cycle Plans, Analytics, Medical Interactions), how to set up users and configure permissions in the new model, and how Vault CRM integrates with Vault PromoMats, MedComm, and Network — with a practical migration roadmap.</p>
      <p><strong>Part IX — Strategy</strong> (Ch 14) synthesises the decision-making layer that sits above every function: how brand positioning is set, how portfolio and pipeline investments are prioritised, how lifecycle management extends product value beyond the initial launch window, how global launch sequencing is designed, and how all functional plans are unified in the Integrated Brand Plan — told through the story of NovaCure Therapeutics and the launch of Meridian.</p>
      <p>The Veeva and platform chapters reflect hard-won operational knowledge: object architecture, permission models, CLM mechanics, Network MDM integration, Vault RIM submission lifecycles — documented with API names, field-level detail, and the compliance logic that drives every design decision. Similarly, the Model N and Anaplan sections go beyond marketing copy to explain the actual data flows, calculation logic, and integration patterns that practitioners work with daily.</p>
      <p>This is a living document. Regulations change. Platforms release new versions. PhRMA revises its Code. The IRA rewrites the Medicare negotiation landscape. The edition date on the cover reflects the state of all frameworks as of that month.</p>
      <p>If you are entering pharma for the first time, start with Chapter 1 and read sequentially — the guide is structured as a story, not a reference manual. If you are an experienced professional looking for a specific topic, the sidebar navigation, the A–Z glossary, and the search bar will take you directly there.</p>
      <div class="fm-sig">
  ...
  <div class="fm-inner fm-toc-inner">
    ...
    <div class="fm-toc-grid">
      ...
      <a href="#intro" class="fm-toc-entry fm-toc-special">
        ...
        <span class="fm-toc-desc">Setting the scene — the pharma ecosystem, key stakeholders, and how R&amp;D, commercial, medical affairs, and market access fit together</span>
      </a>
      ...
      <div class="fm-toc-part">Part IV — Market Access</div>

      <a href="#ch-ma" class="fm-toc-entry">
        <span class="fm-toc-num">05</span>
        <span class="fm-toc-title">Market Access</span>
        <span class="fm-toc-dots"></span>
        <span class="fm-toc-desc">Payer landscape · PBMs, commercial plans, Medicaid, Medicare, VA · WAC &amp; gross-to-net waterfall · Formulary contracting &amp; rebate strategy · Government pricing compliance (AMP, Best Price, 340B) · HEOR, cost-effectiveness &amp; value dossiers · Patient access programmes · Model N revenue management · Anaplan connected planning</span>
      </a>

      <div class="fm-toc-part">Part V — Integration</div>

      <a href="#ch12" class="fm-toc-entry">
      ...
      <div class="fm-toc-part">Part VI — People &amp; Rules</div>
      ...
      <div class="fm-toc-part">Part VII — Systems</div>

      <a href="#ch11" class="fm-toc-entry">
        <span class="fm-toc-num">12</span>
      ...
      <div class="fm-toc-part">Part VIII &#8212; Vault CRM</div>

      <a href="#ch-vault-crm" class="fm-toc-entry">
        <span class="fm-toc-num">13</span>
        <span class="fm-toc-title">Vault CRM</span>
        <span class="fm-toc-dots"></span>
        <span class="fm-toc-desc">Why migrate from Veeva CRM to Vault CRM · Vault platform architecture · Object architecture diagram · Modules &amp; objects · Commercial workflow &amp; call objects · MSL workflow &amp; firewall · Sample management PDMA · Territory management (Vault Align) · Analytics &amp; SFE · Admin setup · User management &amp; permission sets · PromoMats, MedComm &amp; Network integrations · Migration roadmap</span>
      </a>

      <div class="fm-toc-part">Part IX &#8212; Strategy</div>

      <a href="#ch14" class="fm-toc-entry">
        <span class="fm-toc-num">14</span>
        <span class="fm-toc-title">Strategy</span>
        <span class="fm-toc-dots"></span>
        <span class="fm-toc-desc">Four-phase strategy framework · Brand positioning &amp; competitive landscape · Portfolio &amp; pipeline management · Lifecycle &amp; indication expansion · Global launch sequencing · Competitive intelligence · Stakeholder strategy · Omnichannel &amp; digital · Integrated Brand Plan</span>
      </a>
      ...
      <a href="#glossary" class="fm-toc-entry fm-toc-special">
        ...
        <span class="fm-toc-dots"></span>
        <span class="fm-toc-desc">200+ definitions covering R&amp;D regulatory, commercial affairs, medical affairs, market access (GTN, 340B, HEOR, Model N, Anaplan), and Veeva platform terminology</span>
      </a>
...
CH13_VAULT_CRM = """
  <div class="ch-running">Chapter Thirteen · Part VIII &#8212; Vault CRM</div>
  <div class="ch-decorator">
    <div class="ch-big-num">13</div>
    <div class="ch-heading-block">
      <div class="ch-label">
        <span class="ch-pill" style="background:#E05A00;">Ch 13</span>
        <span style="color:#E05A00;">Chapter Thirteen</span>
      </div>
      <h1>Vault CRM &#8212; The Next Generation Platform</h1>
    </div>
  </div>

  <p class="lead">For over a decade, Veeva CRM on Salesforce was the operating system of pharmaceutical commercial teams worldwide. Now Veeva is building something entirely new — <strong>Vault CRM</strong> — a native Vault platform product that replaces the Salesforce foundation entirely. This chapter explains why this shift is happening, what changes for every user and administrator, and how to navigate the transition.</p>

  <p>It is 2024. Marcus Alvarez, the CRM Systems Lead at NovaTerra Pharmaceuticals, is sitting in a webinar when the Veeva product team announces the Vault CRM General Availability roadmap. By 2030, Veeva will end-of-life the Salesforce-based Veeva CRM. Every pharmaceutical company running Veeva CRM — tens of thousands globally — will need to migrate. Marcus pulls out a notebook. The question is no longer <em>if</em>, but <em>when</em> and <em>how</em>.</p>

  <p>This chapter walks through everything Marcus needs to know, and everything <em>you</em> need to know: the platform architecture, the modules, the admin setup, the user and permission model, the integrations with PromoMats, MedComm, and Network, and the migration roadmap from legacy CRM to Vault CRM.</p>

  <!-- ═══════════════════════════════════
       WHY MIGRATE
  ═══════════════════════════════════ -->
  <h2 id="vcrm-why-migrate">Why Migrate to Vault CRM?</h2>

  <p>The move from Salesforce-based Veeva CRM to Vault CRM is not just a platform upgrade — it is a foundational architectural shift. Understanding the <em>why</em> makes the <em>how</em> much easier to navigate.</p>

  <h3>The Limitations of the Salesforce Foundation</h3>
  <p>Veeva CRM was built on top of Salesforce — a general-purpose CRM platform — and Veeva extended it with pharmaceutical-specific objects and logic. But this created structural constraints. Every Salesforce platform release had to be tested against Veeva's customizations. Salesforce licensing costs sat on top of Veeva's own fees. Pharma-specific compliance requirements (21 CFR Part 11, PDMA, Sunshine Act) were implemented as overlays on a general-purpose platform, not natively baked in. API limits, governor limits, and Salesforce's multi-tenant architecture constrained what Veeva could build.</p>

  <p>Vault, by contrast, is Veeva's own platform — built from the ground up for life sciences. It already powers Vault PromoMats, Vault Medical, Vault RIM, Vault eTMF, and Vault Quality. Moving CRM to Vault means the entire Veeva product suite — commercial, medical, regulatory, quality — runs on a single unified platform with a single data model, single security framework, and single integration layer.</p>

  <h3>What Changes for Users</h3>

  <div class="crm-obj-grid" style="margin:20px 0;">
    <div>
      <div class="crm-section-label comm">◈ Key Terminology Changes: Veeva CRM → Vault CRM</div>
      <table style="width:100%;border-collapse:collapse;font-size:13px;margin-top:8px;">
        <thead>
          <tr style="background:#0A3D62;color:#fff;">
            <th style="padding:8px 12px;text-align:left;">Veeva CRM (Salesforce)</th>
            <th style="padding:8px 12px;text-align:left;">Vault CRM (Native Vault)</th>
            <th style="padding:8px 12px;text-align:left;">What It Means</th>
          </tr>
        </thead>
        <tbody>
          <tr style="background:#F8FAFC;">
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Field-Level Security (FLS)</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;font-weight:600;">Field Permission</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Controls which fields a user can read or edit</td>
          </tr>
          <tr>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Record Types</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;font-weight:600;">Object Types</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Categorizes records within an object (e.g., HCP vs HCO Account)</td>
          </tr>
          <tr style="background:#F8FAFC;">
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Permission Sets</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;font-weight:600;">Permission Sets (same term)</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Additive permissions layered on top of base profile</td>
          </tr>
          <tr>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Profiles</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;font-weight:600;">Security Profiles</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Base permission set assigned to each user role</td>
          </tr>
          <tr style="background:#F8FAFC;">
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Workflows</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;font-weight:600;">Lifecycle Actions / Entry Actions</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Automated actions triggered by record state changes</td>
          </tr>
          <tr>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Validation Rules</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;font-weight:600;">Field Validation Formulas</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Enforce data quality on save</td>
          </tr>
          <tr style="background:#F8FAFC;">
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Apex / Triggers</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;font-weight:600;">Vault Java SDK / Vault Actions</td>
            <td style="padding:7px 12px;border-bottom:1px solid #E2E8F0;">Custom business logic executed server-side</td>
          </tr>
          <tr>
            <td style="padding:7px 12px;">Related Lists</td>
            <td style="padding:7px 12px;font-weight:600;">Related Object Sections</td>
            <td style="padding:7px 12px;">Child records displayed on a parent record page</td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <h3>The Business Case in Three Points</h3>
  <p><strong>1. One platform, one data model.</strong> When a rep submits a Call Report in Vault CRM, the content engagement data flows directly to Vault PromoMats — no integration middleware, no API call, no batch sync. The content is <em>native</em> to the same Vault instance. Medical teams using Vault Medical see the same Account and Contact records as commercial teams in Vault CRM. Network MDM feeds master data directly. The walls between systems dissolve.</p>
  <p><strong>2. Purpose-built compliance.</strong> PDMA sample controls, 21 CFR Part 11 audit trails, Sunshine Act transfer-of-value tracking — these are not Salesforce customizations bolted on by Veeva. In Vault CRM, they are native platform capabilities, validated out of the box, maintained by Veeva across every platform update.</p>
  <p><strong>3. Reduced total cost of ownership.</strong> One Vault subscription replaces separate Salesforce + Veeva CRM licensing. One validation package covers all products. One IT team manages one platform. One vendor manages all integrations between CRM, PromoMats, Medical, RIM, and Network.</p>

  <!-- ═══════════════════════════════════
       PLATFORM ARCHITECTURE
  ═══════════════════════════════════ -->
  <h2 id="vcrm-architecture">Vault CRM Platform Architecture</h2>

  <p>Vault CRM is built on the Vault platform — the same platform that powers Vault PromoMats, Vault Medical, Vault RIM, and Vault Quality. Understanding the platform's core concepts is the foundation for everything else.</p>

  <h3>The Vault Data Model</h3>
  <p>In Vault, everything is either an <strong>Object</strong> (like a database table) or a <strong>Document</strong> (a file with a lifecycle). CRM lives primarily in Objects. Each Object has:</p>
  <ul>
    <li><strong>Fields</strong> — data attributes (text, number, date, picklist, lookup)</li>
    <li><strong>Object Types</strong> — categorizations of records within the object (replaces Salesforce Record Types)</li>
    <li><strong>Lifecycles</strong> — defined states a record moves through (e.g., Draft → Active → Inactive)</li>
    <li><strong>Relationships</strong> — lookup and master-detail links between objects</li>
  </ul>

  <p>Every record in Vault has an immutable audit trail: who created it, who modified it, when, and what changed. This is the 21 CFR Part 11 compliance baked in at the platform level — not a Veeva customization layered on top.</p>

  <h3>The Application Model</h3>
  <p>Vault CRM is organized as an <strong>Application</strong> within the Vault platform. A single Vault instance can host multiple applications — Commercial CRM, Medical CRM, Events Management, and so on — sharing the same data layer, the same user directory, and the same security framework. This is fundamentally different from Salesforce, where each "app" was a package with its own permission sets and its own upgrade cadence.</p>

  <!-- ═══════════════════════════════════
       MODULES AND OBJECTS
  ═══════════════════════════════════ -->
  <h2 id="vcrm-modules">Vault CRM Modules &amp; Objects</h2>

  <p>Vault CRM ships as a modular platform. Companies activate the modules they need. Each module brings its own objects, page layouts, and business logic. Here is what each module does and who uses it:</p>

  <div class="crm-obj-grid" style="margin:20px 0;">
    <div>
      <div class="crm-section-label comm">◈ Core CRM Modules</div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Accounts &amp; Contacts</div>
        <div class="crm-obj-api">account__v, contact__v — Foundation objects</div>
        <div class="crm-obj-desc">Every HCP, HCO, and account relationship. Synchronized with Network MDM for master data governance. Supports HCP (physician, NP, PA) and HCO (hospital, clinic, IDN) object types. Territory alignment driven by Veeva Align. The account record is the anchor for all downstream activities — calls, emails, events, and sample drops.</div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Calls &amp; CLM</div>
        <div class="crm-obj-api">call__v, clm_presentation__v — Field activity objects</div>
        <div class="crm-obj-desc">The call report captures every rep–HCP interaction. CLM (Closed Loop Marketing) embeds approved content directly into the call — Vault PromoMats content displayed in the CLM viewer, engagement tracked at slide level. Reaction captures (positive, negative, neutral) feed back into brand analytics. CLM content is pulled directly from PromoMats — no content synchronization job required; it is the same Vault instance.</div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Approved Email</div>
        <div class="crm-obj-api">approved_email__v — HCP email engagement</div>
        <div class="crm-obj-desc">Reps send pre-approved, MLR-reviewed emails to HCPs directly from within CRM. Email templates reside in PromoMats and are referenced, not copied — so an MLR withdrawal in PromoMats instantly removes the template from CRM use. Open rates, link clicks, and forward tracking create an HCP engagement signal used by Next Best Action.</div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Sampling</div>
        <div class="crm-obj-api">sample_transaction__v — PDMA compliance</div>
        <div class="crm-obj-desc">Full PDMA sample management: rep inventory tracking (lot numbers, quantities), signature capture (physical or electronic), HCP eligibility verification (DEA registration, state license), reconciliation reports. Every sample transaction creates an immutable audit record. Vault's native 21 CFR Part 11 audit trail covers the signature capture — no separate electronic signature module required.</div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Events Management</div>
        <div class="crm-obj-api">event__v, event_attendee__v — Speaker programs &amp; advisory boards</div>
        <div class="crm-obj-desc">Speaker programs, advisory boards, medical symposia. FMV (Fair Market Value) cap enforcement on honoraria, meals, and travel. Automatic HCP spend tracking rolls up to the annual Open Payments (Sunshine Act) submission. Anti-Kickback Statute guardrails built in: venue caps, meal caps, educational purpose documentation, prohibited attendee lists.</div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Cycle Plans</div>
        <div class="crm-obj-api">cycle_plan__v, cycle_plan_target__v — Territory planning</div>
        <div class="crm-obj-desc">Defines which HCPs a rep should call on, with what frequency, in what detail priority for a given cycle (typically monthly or quarterly). Cycle plans drive the rep's daily call list. Targets are pre-loaded by regional managers; reps cannot spontaneously add targets outside the approved list. Plan vs. actual call performance is tracked at cycle close.</div>
      </div>

      <div class="crm-obj-card med" style="margin-bottom:12px;">
        <div class="crm-obj-name med">Medical Interactions</div>
        <div class="crm-obj-api">medical_event__v, medical_inquiry__v — Medical Affairs use</div>
        <div class="crm-obj-desc">MSL field interactions, scientific exchange records, medical inquiry logs, and KOL engagement. Fully firewalled from commercial activity — MSL records are not visible to commercial reps, and commercial call data is not visible to MSLs. The firewall is enforced at the object-type level, not by separate system access. Medical inquiries trigger the standard response letter workflow in Vault Medical.</div>
      </div>

      <div class="crm-obj-card med" style="margin-bottom:12px;">
        <div class="crm-obj-name med">Engage (Remote Detailing)</div>
        <div class="crm-obj-api">engage_session__v — Virtual HCP engagement</div>
        <div class="crm-obj-desc">Web-conference-based virtual detailing. The rep shares CLM content via browser to the HCP's device — no software install required on the HCP side. Engagement metrics captured identically to in-person CLM. Supports hybrid workflows: start as a remote call, continue as an in-person follow-up, all linked to the same Account and Call record chain.</div>
      </div>
    </div>
  </div>

  <!-- ═══════════════════════════════════
       VAULT CRM OBJECT ARCHITECTURE
  ═══════════════════════════════════ -->
  <h2 id="vcrm-architecture-detail">Vault CRM Object Architecture</h2>

  <p>Vault CRM organises its data into the same four functional layers as Veeva CRM, but with native Vault object naming and a unified security model. Understanding how these layers connect is essential for both administrators configuring the platform and practitioners using it daily.</p>

  <figure class="vis-embed" aria-label="Vault CRM Object Architecture">
    <div class="vis-label"><span class="vis-icon">◈</span> Vault CRM — Object Architecture &amp; Data Relationships</div>
    <div class="vis-inner" style="padding:24px 20px;">
      <svg viewBox="0 0 960 480" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:700px;display:block;">
        <defs>
          <marker id="vcrm-arr" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto"><path d="M0,1 L0,6 L6,3.5 z" fill="#0B6B6B"/></marker>
          <marker id="vcrm-arrb" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto"><path d="M0,1 L0,6 L6,3.5 z" fill="#1B3A6B"/></marker>
        </defs>
        <rect width="960" height="480" fill="#F0FAFA"/>

        <!-- Layer labels (left) -->
        <rect x="0" y="20" width="120" height="80" fill="#0B5050" rx="4"/>
        <text x="60" y="55" text-anchor="middle" fill="#99E6E6" font-size="10" font-weight="700">LAYER 1</text>
        <text x="60" y="70" text-anchor="middle" fill="#CCFFFF" font-size="9">Foundation</text>
        <text x="60" y="83" text-anchor="middle" fill="#99E6E6" font-size="8">Master Data</text>

        <rect x="0" y="140" width="120" height="80" fill="#0B3060" rx="4"/>
        <text x="60" y="175" text-anchor="middle" fill="#99C0FF" font-size="10" font-weight="700">LAYER 2</text>
        <text x="60" y="190" text-anchor="middle" fill="#CCE0FF" font-size="9">Planning</text>
        <text x="60" y="203" text-anchor="middle" fill="#99C0FF" font-size="8">Pre-call setup</text>

        <rect x="0" y="260" width="120" height="80" fill="#3A1060" rx="4"/>
        <text x="60" y="295" text-anchor="middle" fill="#C0A0FF" font-size="10" font-weight="700">LAYER 3</text>
        <text x="60" y="310" text-anchor="middle" fill="#E0D0FF" font-size="9">Activity</text>
        <text x="60" y="323" text-anchor="middle" fill="#C0A0FF" font-size="8">Field interactions</text>

        <rect x="0" y="380" width="120" height="80" fill="#1A3A10" rx="4"/>
        <text x="60" y="415" text-anchor="middle" fill="#80D060" font-size="10" font-weight="700">LAYER 4</text>
        <text x="60" y="430" text-anchor="middle" fill="#B0E890" font-size="9">Analytics</text>
        <text x="60" y="443" text-anchor="middle" fill="#80D060" font-size="8">Insights &amp; reporting</text>

        <!-- Layer 1: Foundation objects -->
        <rect x="140" y="25" width="140" height="68" rx="6" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1.5"/>
        <text x="210" y="48" text-anchor="middle" fill="#0B5050" font-size="11" font-weight="700">account__v</text>
        <text x="210" y="63" text-anchor="middle" fill="#0B6B6B" font-size="9.5">HCP / HCO Master</text>
        <text x="210" y="78" text-anchor="middle" fill="#4A5568" font-size="8">Network-synced · Audit trail</text>

        <rect x="300" y="25" width="140" height="68" rx="6" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1.5"/>
        <text x="370" y="48" text-anchor="middle" fill="#0B5050" font-size="11" font-weight="700">contact__v</text>
        <text x="370" y="63" text-anchor="middle" fill="#0B6B6B" font-size="9.5">HCP Profile Detail</text>
        <text x="370" y="78" text-anchor="middle" fill="#4A5568" font-size="8">Specialty · NPI · License</text>

        <rect x="460" y="25" width="140" height="68" rx="6" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1.5"/>
        <text x="530" y="48" text-anchor="middle" fill="#0B5050" font-size="11" font-weight="700">territory__v</text>
        <text x="530" y="63" text-anchor="middle" fill="#0B6B6B" font-size="9.5">Territory Alignment</text>
        <text x="530" y="78" text-anchor="middle" fill="#4A5568" font-size="8">From Vault Align · TSF</text>

        <rect x="620" y="25" width="140" height="68" rx="6" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1.5"/>
        <text x="690" y="48" text-anchor="middle" fill="#0B5050" font-size="11" font-weight="700">product__v</text>
        <text x="690" y="63" text-anchor="middle" fill="#0B6B6B" font-size="9.5">Product Catalog</text>
        <text x="690" y="78" text-anchor="middle" fill="#4A5568" font-size="8">Brand · Formulation · Indication</text>

        <rect x="780" y="25" width="155" height="68" rx="6" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1.5"/>
        <text x="857" y="48" text-anchor="middle" fill="#0B5050" font-size="11" font-weight="700">network_account__v</text>
        <text x="857" y="63" text-anchor="middle" fill="#0B6B6B" font-size="9.5">Network MDM Link</text>
        <text x="857" y="78" text-anchor="middle" fill="#4A5568" font-size="8">DEA · License · Exclusion</text>

        <!-- Layer 2: Planning -->
        <rect x="140" y="145" width="160" height="68" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="220" y="168" text-anchor="middle" fill="#0B3060" font-size="11" font-weight="700">cycle_plan__v</text>
        <text x="220" y="183" text-anchor="middle" fill="#1B3A6B" font-size="9.5">Cycle Plan</text>
        <text x="220" y="198" text-anchor="middle" fill="#4A5568" font-size="8">Targets · Freq · Segment</text>

        <rect x="320" y="145" width="160" height="68" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="400" y="168" text-anchor="middle" fill="#0B3060" font-size="11" font-weight="700">clm_presentation__v</text>
        <text x="400" y="183" text-anchor="middle" fill="#1B3A6B" font-size="9.5">CLM Presentation</text>
        <text x="400" y="198" text-anchor="middle" fill="#4A5568" font-size="8">From PromoMats · MLR cleared</text>

        <rect x="500" y="145" width="160" height="68" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="580" y="168" text-anchor="middle" fill="#0B3060" font-size="11" font-weight="700">approved_email__v</text>
        <text x="580" y="183" text-anchor="middle" fill="#1B3A6B" font-size="9.5">Approved Email Template</text>
        <text x="580" y="198" text-anchor="middle" fill="#4A5568" font-size="8">Consent-gated · Cadence-limited</text>

        <rect x="680" y="145" width="160" height="68" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="760" y="168" text-anchor="middle" fill="#0B3060" font-size="11" font-weight="700">sample_inventory__v</text>
        <text x="760" y="183" text-anchor="middle" fill="#1B3A6B" font-size="9.5">Rep Sample Inventory</text>
        <text x="760" y="198" text-anchor="middle" fill="#4A5568" font-size="8">Lot # · Qty · Expiry</text>

        <!-- Layer 3: Activity -->
        <rect x="140" y="265" width="140" height="68" rx="6" fill="#F0E8FF" stroke="#6030A0" stroke-width="1.5"/>
        <text x="210" y="288" text-anchor="middle" fill="#3A0060" font-size="11" font-weight="700">call__v</text>
        <text x="210" y="303" text-anchor="middle" fill="#6030A0" font-size="9.5">Call Report</text>
        <text x="210" y="318" text-anchor="middle" fill="#4A5568" font-size="8">Commercial &amp; Medical types</text>

        <rect x="300" y="265" width="140" height="68" rx="6" fill="#F0E8FF" stroke="#6030A0" stroke-width="1.5"/>
        <text x="370" y="288" text-anchor="middle" fill="#3A0060" font-size="11" font-weight="700">product_detail__v</text>
        <text x="370" y="303" text-anchor="middle" fill="#6030A0" font-size="9.5">Product Detailed</text>
        <text x="370" y="318" text-anchor="middle" fill="#4A5568" font-size="8">Child of call · Priority 1/2/3</text>

        <rect x="460" y="265" width="140" height="68" rx="6" fill="#F0E8FF" stroke="#6030A0" stroke-width="1.5"/>
        <text x="530" y="288" text-anchor="middle" fill="#3A0060" font-size="11" font-weight="700">key_message__v</text>
        <text x="530" y="303" text-anchor="middle" fill="#6030A0" font-size="9.5">Key Message Reaction</text>
        <text x="530" y="318" text-anchor="middle" fill="#4A5568" font-size="8">Agree / Neutral / Disagree</text>

        <rect x="620" y="265" width="140" height="68" rx="6" fill="#F0E8FF" stroke="#6030A0" stroke-width="1.5"/>
        <text x="690" y="288" text-anchor="middle" fill="#3A0060" font-size="11" font-weight="700">sample_transaction__v</text>
        <text x="690" y="303" text-anchor="middle" fill="#6030A0" font-size="9.5">Sample Drop Record</text>
        <text x="690" y="318" text-anchor="middle" fill="#4A5568" font-size="8">e-Sig · PDMA compliance</text>

        <rect x="780" y="265" width="155" height="68" rx="6" fill="#F0E8FF" stroke="#6030A0" stroke-width="1.5"/>
        <text x="857" y="288" text-anchor="middle" fill="#3A0060" font-size="11" font-weight="700">medical_interaction__v</text>
        <text x="857" y="303" text-anchor="middle" fill="#6030A0" font-size="9.5">MSL Scientific Exchange</text>
        <text x="857" y="318" text-anchor="middle" fill="#4A5568" font-size="8">Firewalled from commercial</text>

        <!-- Layer 4: Analytics -->
        <rect x="140" y="385" width="180" height="68" rx="6" fill="#E8F5E8" stroke="#2A7A2A" stroke-width="1.5"/>
        <text x="230" y="408" text-anchor="middle" fill="#1A4A1A" font-size="11" font-weight="700">cycle_plan_target__v</text>
        <text x="230" y="423" text-anchor="middle" fill="#2A7A2A" font-size="9.5">Plan vs Actual Attainment</text>
        <text x="230" y="438" text-anchor="middle" fill="#4A5568" font-size="8">Call rate · Reach · Freq</text>

        <rect x="340" y="385" width="180" height="68" rx="6" fill="#E8F5E8" stroke="#2A7A2A" stroke-width="1.5"/>
        <text x="430" y="408" text-anchor="middle" fill="#1A4A1A" font-size="11" font-weight="700">clm_engagement__v</text>
        <text x="430" y="423" text-anchor="middle" fill="#2A7A2A" font-size="9.5">Slide Engagement Data</text>
        <text x="430" y="438" text-anchor="middle" fill="#4A5568" font-size="8">Time · Swipes · Reactions</text>

        <rect x="540" y="385" width="180" height="68" rx="6" fill="#E8F5E8" stroke="#2A7A2A" stroke-width="1.5"/>
        <text x="630" y="408" text-anchor="middle" fill="#1A4A1A" font-size="11" font-weight="700">hcp_engagement_score__v</text>
        <text x="630" y="423" text-anchor="middle" fill="#2A7A2A" font-size="9.5">Next Best Action Input</text>
        <text x="630" y="438" text-anchor="middle" fill="#4A5568" font-size="8">Rx trend · Call history</text>

        <rect x="740" y="385" width="180" height="68" rx="6" fill="#E8F5E8" stroke="#2A7A2A" stroke-width="1.5"/>
        <text x="830" y="408" text-anchor="middle" fill="#1A4A1A" font-size="11" font-weight="700">insight__v</text>
        <text x="830" y="423" text-anchor="middle" fill="#2A7A2A" font-size="9.5">MSL Field Insights</text>
        <text x="830" y="438" text-anchor="middle" fill="#4A5568" font-size="8">Category · Priority · Area</text>

        <!-- Connecting arrows (simplified vertical) -->
        <line x1="210" y1="93" x2="210" y2="145" stroke="#0B8B8B" stroke-width="1.5" marker-end="url(#vcrm-arr)"/>
        <line x1="210" y1="213" x2="210" y2="265" stroke="#6030A0" stroke-width="1.5" marker-end="url(#vcrm-arr)"/>
        <line x1="210" y1="333" x2="230" y2="385" stroke="#2A7A2A" stroke-width="1.5" marker-end="url(#vcrm-arr)"/>
      </svg>
    </div>
    <figcaption class="vis-cap">Vault CRM Object Architecture — four layers from master data through planning, activity capture, and analytics</figcaption>
  </figure>

  <p>The key difference from Veeva CRM's Salesforce architecture: every object in Vault CRM has a <strong>native lifecycle</strong> (state machine), a <strong>built-in audit trail</strong> at the platform level, and <strong>object-type–based access control</strong> instead of profile + record-type combinations. This means fewer configuration layers, more consistent enforcement, and easier validation for 21 CFR Part 11 compliance.</p>

  <!-- ═══════════════════════════════════
       COMMERCIAL WORKFLOW
  ═══════════════════════════════════ -->
  <h2 id="vcrm-commercial">Commercial Workflow in Vault CRM</h2>

  <p>For a territory representative, the Vault CRM daily workflow is: review the cycle plan priority list → prep the call → execute the call with CLM → submit the call report → send follow-up Approved Email. Every step is enforced by the platform — the rep cannot skip the e-signature on a sample drop, cannot use withdrawn CLM content, cannot send a non-approved email template. The compliance guardrails are the workflow, not a separate checklist.</p>

  <h3>Commercial Objects &amp; Business Functions</h3>
  <div class="crm-obj-grid" style="margin:20px 0;">
    <div>
      <div class="crm-section-label comm">◈ Commercial Call Objects — Vault CRM</div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Call Report (call__v)</div>
        <div class="crm-obj-api">call__v · Object Type: Detail Call / Phone Call / Virtual Call / Group Call</div>
        <div class="crm-obj-desc">The primary activity record for every commercial interaction. Object Type determines which fields appear on the page layout. The call lifecycle: Draft → In Progress → Submitted → Locked. Once Submitted, the record is immutable — 21 CFR Part 11 compliant by platform design. Drives SFE metrics: call rate, reach and frequency, next call objective. The rep cannot submit without completing all required fields — validation is enforced at lifecycle state transition, not just on field save.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">call_date__v</span>
          <span class="crm-field-pill">channel__v</span>
          <span class="crm-field-pill">state__v (lifecycle)</span>
          <span class="crm-field-pill">territory__v</span>
          <span class="crm-field-pill">next_call_objective__v</span>
        </div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Product Detailed (product_detail__v)</div>
        <div class="crm-obj-api">product_detail__v — child of call__v — one record per brand discussed</div>
        <div class="crm-obj-desc">Records which product was detailed, at what priority (1st, 2nd, or 3rd), and which CLM presentation was used. The system enforces that only products linked to the rep's active cycle plan can be selected — reps cannot ad-hoc detail unapproved products. The Product Detailed record is the unit of SFE measurement for detail mix and promotional compliance.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">product__v</span>
          <span class="crm-field-pill">detail_priority__v</span>
          <span class="crm-field-pill">clm_presentation__v</span>
          <span class="crm-field-pill">discussion_topic__v</span>
        </div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Key Message Reaction (key_message__v)</div>
        <div class="crm-obj-api">key_message__v — child of call__v — one record per message discussed</div>
        <div class="crm-obj-desc">The rep records the HCP's reaction to each approved key message: Strongly Agree / Agree / Neutral / Disagree / Not Discussed. These reactions flow directly to PromoMats analytics — because PromoMats and Vault CRM are the same Vault instance, brand teams see slide-level reaction data in real time without any integration middleware. Messages with persistently neutral or negative reactions trigger a PromoMats content review workflow automatically.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">key_message__v</span>
          <span class="crm-field-pill">reaction__v</span>
          <span class="crm-field-pill">product__v</span>
        </div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Approved Email (approved_email__v)</div>
        <div class="crm-obj-api">approved_email__v — HCP consent-gated, cadence-enforced</div>
        <div class="crm-obj-desc">Reps select from PromoMats-approved templates referenced directly in the same Vault instance — there is no template library to synchronize. The system gates sending on two conditions: HCP multichannel consent (consent__v object) must be on file, and the per-HCP cadence limit for the template type must not be exceeded. Engagement tracking (opens, clicks, forwards) creates an HCP digital engagement signal fed into Next Best Action scoring.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">email_template__v</span>
          <span class="crm-field-pill">sent_date__v</span>
          <span class="crm-field-pill">consent__v</span>
          <span class="crm-field-pill">open_flag__v</span>
        </div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Cycle Plan &amp; Cycle Plan Target</div>
        <div class="crm-obj-api">cycle_plan__v / cycle_plan_target__v — territory planning objects</div>
        <div class="crm-obj-desc">The Cycle Plan defines the HCP target universe and call frequency goals for a promotional cycle (typically monthly or quarterly). Cycle Plan Target is the junction object: one record per HCP in the plan, holding the target call count, actual call count, and attainment percentage. This drives the rep's daily prioritised call list — the system ranks HCPs by attainment gap, segment priority, and Next Best Action score. Managers review attainment in real time without waiting for a reporting cycle.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">target_calls__v</span>
          <span class="crm-field-pill">actual_calls__v</span>
          <span class="crm-field-pill">start_date__v</span>
          <span class="crm-field-pill">segment_priority__v</span>
          <span class="crm-field-pill">attainment_pct__v</span>
        </div>
      </div>
    </div>
  </div>

  <h3>The Commercial Call Workflow — Step by Step</h3>
  <figure class="vis-embed" aria-label="Vault CRM Commercial Call Workflow">
    <div class="vis-label"><span class="vis-icon">◈</span> Vault CRM — Commercial Rep Daily Workflow</div>
    <div class="vis-inner" style="padding:20px 16px;">
      <svg viewBox="0 0 960 200" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:700px;display:block;">
        <rect width="960" height="200" fill="#F0FAFA"/>
        <defs>
          <marker id="carr" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto"><path d="M0,1 L0,6 L6,3.5 z" fill="#0B6B6B"/></marker>
        </defs>
        <!-- 8 steps -->
        <rect x="4" y="40" width="104" height="80" rx="5" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1.5"/>
        <text x="56" y="66" text-anchor="middle" fill="#0B5050" font-size="11" font-weight="700">① Plan</text>
        <text x="56" y="81" text-anchor="middle" fill="#0B6B6B" font-size="9">Cycle plan target</text>
        <text x="56" y="94" text-anchor="middle" fill="#4A5568" font-size="8">Priority HCP list</text>
        <text x="56" y="111" text-anchor="middle" fill="#4A5568" font-size="8">NBA score · Attainment</text>

        <line x1="108" y1="80" x2="118" y2="80" stroke="#0B8B8B" stroke-width="1.5" marker-end="url(#carr)"/>

        <rect x="118" y="40" width="104" height="80" rx="5" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1.5"/>
        <text x="170" y="66" text-anchor="middle" fill="#0B5050" font-size="11" font-weight="700">② Prep</text>
        <text x="170" y="81" text-anchor="middle" fill="#0B6B6B" font-size="9">Review account__v</text>
        <text x="170" y="94" text-anchor="middle" fill="#4A5568" font-size="8">Prior calls · Rx data</text>
        <text x="170" y="111" text-anchor="middle" fill="#4A5568" font-size="8">Load CLM deck</text>

        <line x1="222" y1="80" x2="232" y2="80" stroke="#0B8B8B" stroke-width="1.5" marker-end="url(#carr)"/>

        <rect x="232" y="40" width="104" height="80" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="284" y="66" text-anchor="middle" fill="#0B3060" font-size="11" font-weight="700">③ CLM</text>
        <text x="284" y="81" text-anchor="middle" fill="#1B3A6B" font-size="9">Present approved</text>
        <text x="284" y="94" text-anchor="middle" fill="#4A5568" font-size="8">content from</text>
        <text x="284" y="111" text-anchor="middle" fill="#4A5568" font-size="8">PromoMats live</text>

        <line x1="336" y1="80" x2="346" y2="80" stroke="#0B8B8B" stroke-width="1.5" marker-end="url(#carr)"/>

        <rect x="346" y="40" width="104" height="80" rx="5" fill="#F0E8FF" stroke="#6030A0" stroke-width="1.5"/>
        <text x="398" y="62" text-anchor="middle" fill="#3A0060" font-size="11" font-weight="700">④ Capture</text>
        <text x="398" y="77" text-anchor="middle" fill="#6030A0" font-size="9">Key message</text>
        <text x="398" y="90" text-anchor="middle" fill="#6030A0" font-size="9">reactions</text>
        <text x="398" y="103" text-anchor="middle" fill="#4A5568" font-size="8">call__v created</text>
        <text x="398" y="116" text-anchor="middle" fill="#4A5568" font-size="8">Draft → In Progress</text>

        <line x1="450" y1="80" x2="460" y2="80" stroke="#0B8B8B" stroke-width="1.5" marker-end="url(#carr)"/>

        <rect x="460" y="40" width="104" height="80" rx="5" fill="#1A2010" stroke="#4A6010" stroke-width="2"/>
        <text x="512" y="62" text-anchor="middle" fill="#AADA50" font-size="11" font-weight="700">⑤ Sample</text>
        <text x="512" y="77" text-anchor="middle" fill="#8ABA30" font-size="9">If applicable:</text>
        <text x="512" y="90" text-anchor="middle" fill="#8ABA30" font-size="9">HCP e-signature</text>
        <text x="512" y="103" text-anchor="middle" fill="#5A7A30" font-size="8">DEA check · PDMA</text>
        <text x="512" y="116" text-anchor="middle" fill="#5A7A30" font-size="8">Inventory decremented</text>

        <line x1="564" y1="80" x2="574" y2="80" stroke="#0B8B8B" stroke-width="1.5" marker-end="url(#carr)"/>

        <rect x="574" y="40" width="104" height="80" rx="5" fill="#F0E8FF" stroke="#6030A0" stroke-width="1.5"/>
        <text x="626" y="62" text-anchor="middle" fill="#3A0060" font-size="11" font-weight="700">⑥ Submit</text>
        <text x="626" y="77" text-anchor="middle" fill="#6030A0" font-size="9">Lifecycle →</text>
        <text x="626" y="90" text-anchor="middle" fill="#6030A0" font-size="9">Submitted</text>
        <text x="626" y="103" text-anchor="middle" fill="#4A5568" font-size="8">Record locked</text>
        <text x="626" y="116" text-anchor="middle" fill="#4A5568" font-size="8">Audit trail sealed</text>

        <line x1="678" y1="80" x2="688" y2="80" stroke="#0B8B8B" stroke-width="1.5" marker-end="url(#carr)"/>

        <rect x="688" y="40" width="104" height="80" rx="5" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1.5"/>
        <text x="740" y="62" text-anchor="middle" fill="#0B5050" font-size="11" font-weight="700">⑦ Email</text>
        <text x="740" y="77" text-anchor="middle" fill="#0B6B6B" font-size="9">Approved Email</text>
        <text x="740" y="90" text-anchor="middle" fill="#0B6B6B" font-size="9">follow-up</text>
        <text x="740" y="103" text-anchor="middle" fill="#4A5568" font-size="8">Consent check</text>
        <text x="740" y="116" text-anchor="middle" fill="#4A5568" font-size="8">Cadence enforced</text>

        <line x1="792" y1="80" x2="802" y2="80" stroke="#0B8B8B" stroke-width="1.5" marker-end="url(#carr)"/>

        <rect x="802" y="40" width="154" height="80" rx="5" fill="#E8F5E8" stroke="#2A7A2A" stroke-width="1.5"/>
        <text x="879" y="62" text-anchor="middle" fill="#1A4A1A" font-size="11" font-weight="700">⑧ Analytics</text>
        <text x="879" y="77" text-anchor="middle" fill="#2A7A2A" font-size="9">Cycle attainment</text>
        <text x="879" y="90" text-anchor="middle" fill="#2A7A2A" font-size="9">updated · NBA</text>
        <text x="879" y="103" text-anchor="middle" fill="#4A5568" font-size="8">Engagement signal</text>
        <text x="879" y="116" text-anchor="middle" fill="#4A5568" font-size="8">PromoMats feedback</text>
      </svg>
    </div>
    <figcaption class="vis-cap">Vault CRM commercial rep workflow — from cycle plan through call capture to analytics feedback loop</figcaption>
  </figure>

  <!-- ═══════════════════════════════════
       MSL WORKFLOW
  ═══════════════════════════════════ -->
  <h2 id="vcrm-msl">MSL Workflow in Vault CRM</h2>

  <p>The MSL's experience in Vault CRM is architecturally distinct from the commercial rep's — not just through different page layouts, but through different Object Types on the same call__v object. The MSL Call Object Type omits all promotional fields: no CLM presentation selector, no product detail priority, no sample drop. What the MSL sees is a scientific exchange workspace with free-text discussion topics, insight capture, and medical inquiry routing.</p>

  <p>The firewall in Vault CRM is cleaner than in Veeva CRM. In the Salesforce-based system, firewall enforcement relied on profile + record type combinations that could become inconsistent across org configuration updates. In Vault CRM, the firewall is enforced at the Object Type level within the Security Profile — a Commercial Rep Security Profile cannot access the Medical Object Types, period. There is no configuration path that accidentally bridges the firewall.</p>

  <h3>MSL Objects &amp; Scientific Exchange Workflow</h3>
  <div class="crm-obj-grid" style="margin:20px 0;">
    <div>
      <div class="crm-section-label med">◈ MSL Objects — Vault CRM</div>

      <div class="crm-obj-card med" style="margin-bottom:12px;">
        <div class="crm-obj-name med">MSL Call Report (call__v — Medical Object Type)</div>
        <div class="crm-obj-api">call__v · Object Type: MSL Interaction / Medical Call / Congress Engagement</div>
        <div class="crm-obj-desc">The same call__v object as commercial, but under the Medical Object Type which surfaces entirely different fields: scientific discussion topics (free text), therapeutic area focus, exchange quality rating, and insight category. No product detail priority, no CLM deck selector, no sample fields. The record is invisible to commercial reps — Object Type security enforces the firewall at the data layer, not just through UI configuration.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">discussion_topic__v</span>
          <span class="crm-field-pill">scientific_exchange_type__v</span>
          <span class="crm-field-pill">ta_focus__v</span>
          <span class="crm-field-pill">insight_category__v</span>
          <span class="crm-field-pill">exchange_quality__v</span>
        </div>
      </div>

      <div class="crm-obj-card med" style="margin-bottom:12px;">
        <div class="crm-obj-name med">Medical Inquiry (medical_inquiry__v)</div>
        <div class="crm-obj-api">medical_inquiry__v — routes to Vault Medical response letter workflow</div>
        <div class="crm-obj-desc">When an HCP raises an unsolicited question — on-label or off-label — the MSL (or commercial rep routing to medical) creates a Medical Inquiry record. Because Vault CRM and Vault MedComm run on the same Vault instance, the inquiry is immediately visible to the medical information team in MedComm without any API call or data transfer. The response letter workflow is triggered natively in Vault. An adverse event flag on the inquiry automatically initiates the pharmacovigilance notification workflow.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">inquiry_type__v</span>
          <span class="crm-field-pill">product__v</span>
          <span class="crm-field-pill">question_text__v</span>
          <span class="crm-field-pill">ae_flag__v</span>
          <span class="crm-field-pill">response_status__v</span>
        </div>
      </div>

      <div class="crm-obj-card med" style="margin-bottom:12px;">
        <div class="crm-obj-name med">Field Insight (insight__v)</div>
        <div class="crm-obj-api">insight__v — structured scientific observation from the field</div>
        <div class="crm-obj-desc">Every MSL call can generate one or more Insight records — structured observations about HCP scientific thinking, competitive intelligence, unmet medical needs, or publication interest. Insights are categorized (Clinical / Market / Competitive / Scientific / Patient), prioritised, and surfaced to the MSL Director's dashboard. Vault's native reporting layer means no separate BI tool is needed for insight trend analysis — the data lives and is analysed in the same system.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">category__v</span>
          <span class="crm-field-pill">priority__v</span>
          <span class="crm-field-pill">ta_area__v</span>
          <span class="crm-field-pill">action_required__v</span>
        </div>
      </div>

      <div class="crm-obj-card med" style="margin-bottom:12px;">
        <div class="crm-obj-name med">KOL Profile (account__v — KOL Object Type)</div>
        <div class="crm-obj-api">account__v · Object Type: KOL — extends the standard HCP account</div>
        <div class="crm-obj-desc">The KOL Object Type extends the standard account record with fields specific to scientific engagement management: publications count, congress presentations, advisory board history, IIS grant history, tier classification (National / Regional / Local), and MSL engagement plan status. Both commercial and medical teams can read the KOL account — but commercial sees the promotional engagement history, and medical sees the scientific exchange history. Neither can see the other's activity records.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">kol_tier__v</span>
          <span class="crm-field-pill">publications_count__v</span>
          <span class="crm-field-pill">advisory_board_history__v</span>
          <span class="crm-field-pill">iis_grant_status__v</span>
          <span class="crm-field-pill">engagement_plan_status__v</span>
        </div>
      </div>
    </div>
  </div>

  <figure class="vis-embed" aria-label="Vault CRM MSL Scientific Exchange Workflow">
    <div class="vis-label"><span class="vis-icon">◈</span> Vault CRM MSL — Scientific Exchange Workflow &amp; Firewall</div>
    <div class="vis-inner" style="padding:20px 16px;">
      <svg viewBox="0 0 960 260" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:700px;display:block;">
        <rect width="960" height="260" fill="#F0FAFA"/>
        <!-- Phase columns -->
        <rect x="0" y="0" width="192" height="28" fill="#0B5050" rx="0"/>
        <text x="96" y="18" text-anchor="middle" fill="#99E6E6" font-size="10" font-weight="700">PRE-MEETING</text>
        <rect x="192" y="0" width="288" height="28" fill="#0A3060" rx="0"/>
        <text x="336" y="18" text-anchor="middle" fill="#99C0FF" font-size="10" font-weight="700">SCIENTIFIC EXCHANGE</text>
        <rect x="480" y="0" width="240" height="28" fill="#3A1060" rx="0"/>
        <text x="600" y="18" text-anchor="middle" fill="#C0A0FF" font-size="10" font-weight="700">POST-CALL DOCUMENTATION</text>
        <rect x="720" y="0" width="240" height="28" fill="#1A3A10" rx="0"/>
        <text x="840" y="18" text-anchor="middle" fill="#80D060" font-size="10" font-weight="700">FOLLOW-UP &amp; ANALYTICS</text>
        <line x1="192" y1="0" x2="192" y2="260" stroke="#0B6B6B" stroke-width="1" stroke-dasharray="4,3"/>
        <line x1="480" y1="0" x2="480" y2="260" stroke="#0B6B6B" stroke-width="1" stroke-dasharray="4,3"/>
        <line x1="720" y1="0" x2="720" y2="260" stroke="#0B6B6B" stroke-width="1" stroke-dasharray="4,3"/>

        <!-- Row 1: Objects -->
        <text x="480" y="46" text-anchor="middle" fill="#4A5568" font-size="8" font-weight="600" letter-spacing="1">VAULT CRM OBJECTS USED</text>
        <rect x="8" y="52" width="176" height="48" rx="5" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1"/>
        <text x="96" y="70" text-anchor="middle" fill="#0B5050" font-size="10" font-weight="700">account__v (KOL type)</text>
        <text x="96" y="84" text-anchor="middle" fill="#4A5568" font-size="8.5">Prior exchanges · Tier · Publications</text>
        <text x="96" y="96" text-anchor="middle" fill="#4A5568" font-size="8.5">Advisory board history</text>

        <rect x="200" y="52" width="136" height="48" rx="5" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1"/>
        <text x="268" y="70" text-anchor="middle" fill="#0B5050" font-size="10" font-weight="700">call__v</text>
        <text x="268" y="84" text-anchor="middle" fill="#4A5568" font-size="8.5">Medical Object Type</text>
        <text x="268" y="96" text-anchor="middle" fill="#4A5568" font-size="8.5">Non-promo fields only</text>

        <rect x="346" y="52" width="124" height="48" rx="5" fill="#E0F7F7" stroke="#0B8B8B" stroke-width="1"/>
        <text x="408" y="70" text-anchor="middle" fill="#0B5050" font-size="10" font-weight="700">medical_inquiry__v</text>
        <text x="408" y="84" text-anchor="middle" fill="#4A5568" font-size="8.5">If HCP raises question</text>
        <text x="408" y="96" text-anchor="middle" fill="#4A5568" font-size="8.5">Routes to MedComm</text>

        <rect x="488" y="52" width="224" height="48" rx="5" fill="#F0E8FF" stroke="#6030A0" stroke-width="1"/>
        <text x="600" y="70" text-anchor="middle" fill="#3A0060" font-size="10" font-weight="700">insight__v + call__v submitted</text>
        <text x="600" y="84" text-anchor="middle" fill="#4A5568" font-size="8.5">Lifecycle → Submitted · Record locked</text>
        <text x="600" y="96" text-anchor="middle" fill="#4A5568" font-size="8.5">Invisible to commercial profiles</text>

        <rect x="728" y="52" width="224" height="48" rx="5" fill="#E8F5E8" stroke="#2A7A2A" stroke-width="1"/>
        <text x="840" y="70" text-anchor="middle" fill="#1A4A1A" font-size="10" font-weight="700">SRL via Vault MedComm</text>
        <text x="840" y="84" text-anchor="middle" fill="#4A5568" font-size="8.5">Response letter natively routed</text>
        <text x="840" y="96" text-anchor="middle" fill="#4A5568" font-size="8.5">Insight trends → MSL dashboard</text>

        <!-- Row 2: MSL Actions -->
        <text x="480" y="122" text-anchor="middle" fill="#4A5568" font-size="8" font-weight="600" letter-spacing="1">MSL ACTION</text>
        <rect x="8" y="128" width="176" height="52" rx="5" fill="#F0FAFA" stroke="#99E6E6" stroke-width="1"/>
        <text x="96" y="146" text-anchor="middle" fill="#2D3748" font-size="9.5">Review KOL profile in Vault CRM</text>
        <text x="96" y="160" text-anchor="middle" fill="#2D3748" font-size="9.5">Load Vault Medical scientific deck</text>
        <text x="96" y="172" text-anchor="middle" fill="#4A5568" font-size="8.5">Check prior insight categories</text>

        <rect x="200" y="128" width="270" height="52" rx="5" fill="#F0FAFA" stroke="#99E6E6" stroke-width="1"/>
        <text x="335" y="146" text-anchor="middle" fill="#2D3748" font-size="9.5">On-label scientific discussion via Vault Medical content</text>
        <text x="335" y="160" text-anchor="middle" fill="#2D3748" font-size="9.5">If off-label unsolicited → medical_inquiry__v created</text>
        <text x="335" y="172" text-anchor="middle" fill="#4A5568" font-size="8.5">Cannot show PromoMats promotional CLM — system blocked by Object Type</text>

        <rect x="488" y="128" width="224" height="52" rx="5" fill="#F0FAFA" stroke="#99E6E6" stroke-width="1"/>
        <text x="600" y="146" text-anchor="middle" fill="#2D3748" font-size="9.5">Submit call report + insights</text>
        <text x="600" y="160" text-anchor="middle" fill="#2D3748" font-size="9.5">Audit trail sealed by Vault platform</text>
        <text x="600" y="172" text-anchor="middle" fill="#4A5568" font-size="8.5">Data visible to MSL Director only</text>

        <rect x="728" y="128" width="224" height="52" rx="5" fill="#F0FAFA" stroke="#99E6E6" stroke-width="1"/>
        <text x="840" y="146" text-anchor="middle" fill="#2D3748" font-size="9.5">MedComm team handles SRL</text>
        <text x="840" y="160" text-anchor="middle" fill="#2D3748" font-size="9.5">MSL Director reviews insight patterns</text>
        <text x="840" y="172" text-anchor="middle" fill="#4A5568" font-size="8.5">Evidence gaps → MA strategy update</text>

        <!-- Row 3: Firewall guardrails -->
        <text x="480" y="202" text-anchor="middle" fill="#8B1A1A" font-size="8" font-weight="700" letter-spacing="1">VAULT CRM COMMERCIAL-MEDICAL FIREWALL — ENFORCED BY OBJECT TYPE SECURITY</text>
        <rect x="8" y="208" width="440" height="44" rx="5" fill="#FFF8E8" stroke="#FDE68A" stroke-width="1.5"/>
        <text x="228" y="226" text-anchor="middle" fill="#6B4A00" font-size="9" font-weight="700">Commercial Rep Security Profile: NO access to Medical Object Types</text>
        <text x="228" y="240" text-anchor="middle" fill="#6B4A00" font-size="8.5">call__v (Medical type) · medical_inquiry__v · insight__v → all invisible to commercial</text>
        <text x="228" y="252" text-anchor="middle" fill="#6B4A00" font-size="8.5">Enforced at platform level, not UI configuration — cannot be misconfigured</text>

        <rect x="460" y="208" width="492" height="44" rx="5" fill="#F0FFF0" stroke="#68D391" stroke-width="1.5"/>
        <text x="706" y="226" text-anchor="middle" fill="#1A5A1A" font-size="9" font-weight="700">MSL Security Profile: NO access to Commercial Object Types</text>
        <text x="706" y="240" text-anchor="middle" fill="#1A5A1A" font-size="8.5">call__v (Detail Call type) · product_detail__v · sample_transaction__v → all invisible to MSL</text>
        <text x="706" y="252" text-anchor="middle" fill="#1A5A1A" font-size="8.5">Both share account__v foundation — HCP record visible to both, activity firewalled</text>
      </svg>
    </div>
    <figcaption class="vis-cap">Vault CRM MSL scientific exchange workflow and commercial-medical firewall — enforced natively at Object Type level</figcaption>
  </figure>

  <!-- ═══════════════════════════════════
       SAMPLE MANAGEMENT
  ═══════════════════════════════════ -->
  <h2 id="vcrm-sample">Sample Management — PDMA Compliance in Vault CRM</h2>

  <p>The Prescription Drug Marketing Act (21 CFR Part 203) requires that every drug sample transferred to a licensed HCP be documented with a signed receipt, lot number, quantity, and an auditable chain of custody. In Vault CRM, PDMA compliance is enforced at the platform level — the rep cannot submit a Call Report containing a sample transaction without an HCP e-signature. The 21 CFR Part 11 audit trail is native to Vault, not an overlay bolted onto Salesforce.</p>

  <p>Three specific improvements over Veeva CRM's PDMA implementation are worth noting. First, the e-signature is captured using Vault's native electronic signature module — the same module used across Vault PromoMats and Vault Quality — so signature validation is part of the central platform validation package, not a separate CRM-specific validation. Second, lot number and expiry tracking are enforced at object save: a sample transaction cannot be created against an expired lot. Third, the quarterly reconciliation report is generated natively from the sample_transaction__v object, without a separate reporting extract — the data never leaves the Vault compliance envelope.</p>

  <div class="crm-obj-grid" style="margin:20px 0;">
    <div>
      <div class="crm-section-label comm">◈ Sample Management Objects — Vault CRM</div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Sample Transaction (sample_transaction__v)</div>
        <div class="crm-obj-api">sample_transaction__v — PDMA-compliant sample drop record</div>
        <div class="crm-obj-desc">Created when a rep transfers samples to an HCP. Required fields enforced by lifecycle entry criteria: lot number (validated against sample_inventory__v), quantity, HCP DEA registration check (via Network MDM link), and e-signature capture. The transaction lifecycle: Pending → Signed → Submitted → Locked. A locked transaction cannot be modified — the audit trail is immutable. Adverse event reporting workflows are auto-triggered if the rep marks an unexpected product reaction during the same call.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">lot_number__v</span>
          <span class="crm-field-pill">quantity__v</span>
          <span class="crm-field-pill">hcp_signature__v</span>
          <span class="crm-field-pill">dea_number__v</span>
          <span class="crm-field-pill">expiry_date__v</span>
        </div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Sample Inventory (sample_inventory__v)</div>
        <div class="crm-obj-api">sample_inventory__v — rep's live sample balance</div>
        <div class="crm-obj-desc">Tracks the rep's current inventory by product, lot number, and quantity. Every sample_transaction__v decrements the balance in real time. When balance reaches a reorder threshold, the rep is notified within the app. Annual physical count results are reconciled against the inventory object — discrepancies flag a compliance event routed to the Sample Management team. The inventory record is updated by the distribution system when new lots are allocated to the rep's territory.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">product__v</span>
          <span class="crm-field-pill">lot_number__v</span>
          <span class="crm-field-pill">quantity_on_hand__v</span>
          <span class="crm-field-pill">reorder_threshold__v</span>
        </div>
      </div>
    </div>
  </div>
  ...
  ═══════════════════════════════════ -->
  <h2 id="vcrm-territory">Territory Management — Vault Align Integration</h2>

  <p>Vault CRM's territory structure is managed by <strong>Vault Align</strong> — the Vault-native territory alignment platform that replaces the Veeva Align integration with Salesforce Territory Management. The transition from Veeva Align (which published data into Salesforce CRM via the Territory Snapshot File) to Vault Align is one of the most operationally significant changes in the Vault CRM migration.</p>

  <p>In Vault Align, territory design, HCP assignment, and cycle plan targets are managed in the same Vault platform as CRM. Changes made in Vault Align propagate to Vault CRM instantly — there is no TSF (Territory Snapshot File) export/import cycle, no batch sync, no overnight processing window. When a District Manager realigns territories mid-cycle — moving 40 HCPs from Rep A's territory to Rep B's — the affected reps see their updated account lists immediately.</p>

  <div class="crm-obj-grid" style="margin:20px 0;">
    <div>
      <div class="crm-section-label comm">◈ Territory &amp; Alignment Objects — Vault CRM</div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Territory (territory__v)</div>
        <div class="crm-obj-api">territory__v — geographic or account-based scope</div>
        <div class="crm-obj-desc">Defines the rep's working geography (zip-code based) or account portfolio (IDN, hospital, specialty account-based). Territory hierarchy: National → Regional → District → Territory. Each level is configured in Vault Align and published to Vault CRM. Role hierarchy in CRM mirrors territory hierarchy — a District Manager's role automatically grants visibility into all accounts within their district's territories.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">territory_id__v</span>
          <span class="crm-field-pill">territory_type__v</span>
          <span class="crm-field-pill">alignment_version__v</span>
          <span class="crm-field-pill">effective_date__v</span>
        </div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:12px;">
        <div class="crm-obj-name comm">Account Territory Assignment (account_territory__v)</div>
        <div class="crm-obj-api">account_territory__v — links HCP/HCO to territory</div>
        <div class="crm-obj-desc">The junction object that assigns each HCP or HCO account to one or more territories. Multi-territory assignment supports shared accounts (e.g., a hospital system covered by multiple KAMs). When Vault Align publishes a new alignment version, these junction records are updated atomically — no partial state where some reps see the old alignment and others see the new one.</div>
        <div class="crm-obj-fields">
          <span class="crm-field-pill">account__v</span>
          <span class="crm-field-pill">territory__v</span>
          <span class="crm-field-pill">alignment_version__v</span>
          <span class="crm-field-pill">primary_flag__v</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- ═══════════════════════════════════
       ANALYTICS & SFE
  ═══════════════════════════════════ -->
  <h2 id="vcrm-analytics">Analytics, SFE &amp; Next Best Action</h2>

  <p>Sales Force Effectiveness (SFE) analytics in Vault CRM are served natively from the Vault reporting layer — no separate BI tool required for core operational metrics. Managers access cycle plan attainment, reach and frequency, call rate, and message adoption from within the CRM interface. Advanced analytics (predictive HCP segmentation, market share correlation, omnichannel engagement scoring) are available through Vault CRM's embedded AI layer or exported to enterprise BI platforms via the Vault API.</p>

  <h3>Key SFE Metrics Available Natively</h3>
  <div class="crm-obj-grid" style="margin:16px 0;">
    <div>
      <div class="crm-section-label comm">◈ SFE Analytics Objects &amp; Dashboards</div>

      <div class="crm-obj-card comm" style="margin-bottom:10px;">
        <div class="crm-obj-name comm">Cycle Plan Attainment</div>
        <div class="crm-obj-api">Derived from cycle_plan_target__v — real-time plan vs actual</div>
        <div class="crm-obj-desc">For each HCP in the cycle plan, the system tracks: Target Calls, Actual Calls, Attainment %, and Days Remaining in Cycle. Reps see their daily call list ranked by attainment gap + segment priority. Managers see a district roll-up — rep attainment vs. district average — without needing a report extract. End-of-cycle attainment drives incentive compensation calculations in the IC system.</div>
      </div>

      <div class="crm-obj-card comm" style="margin-bottom:10px;">
        <div class="crm-obj-name comm">Reach &amp; Frequency (R&amp;F)</div>
        <div class="crm-obj-api">Calculated from call__v records against cycle_plan_target__v</div>
        <div class="crm-obj-desc">Reach = the percentage of targeted HCPs called at least once in the cycle. Frequency = average calls per reached HCP. Both metrics are standard KPIs in pharmaceutical SFE — reach above 80% and frequency within the 2–4 calls/quarter target range indicate a healthy promotional campaign. These values update in real time as call reports are submitted.</div>
      </div>

      <div class="crm-obj-card med" style="margin-bottom:10px;">
        <div class="crm-obj-name med">Next Best Action (NBA)</div>
        <div class="crm-obj-api">AI-driven recommendation surface within Vault CRM mobile app</div>
        <div class="crm-obj-desc">Next Best Action synthesises: Rx trend data (from IQVIA/Symphony loaded via Vault API), HCP engagement history (calls, emails, CLM reactions), attainment gap vs. cycle plan target, and approved email open rates. The output is a ranked daily call list with a recommended action for each HCP: "Detail product X — Rx trend declining — last called 28 days ago — two approved emails opened this month." NBA recommendations are visible in the rep's mobile app home screen and update overnight as new data arrives.</div>
      </div>

      <div class="crm-obj-card med" style="margin-bottom:10px;">
        <div class="crm-obj-name med">CLM Message Adoption Analytics</div>
        <div class="crm-obj-api">clm_engagement__v + key_message__v — slide-level engagement heatmap</div>
        <div class="crm-obj-desc">Because Vault CRM and Vault PromoMats are the same platform, engagement data (which slides were shown, for how long, with what reaction) flows directly into PromoMats analytics without an ETL pipeline. Brand managers see a slide-level heatmap: which messages are landing (high positive reaction, long dwell time), which are being skipped, and which are generating negative reactions. This feedback loop is the foundation of evidence-based message optimisation — MLR revision cycles are triggered by data, not intuition.</div>
      </div>
    </div>
  </div>
  ...
  <!-- ═══════════════════════════════════
       ADMIN SETUP
  ═══════════════════════════════════ -->
  <h2 id="vcrm-admin">Admin Setup — Step by Step</h2>

  <p>Marcus spent his first week in the Vault CRM admin console following this setup sequence. Here is the story-driven walkthrough, step by step:</p>

  <h3>Step 1: Configure Your Vault Instance</h3>
  <p>Every Vault CRM deployment starts with a provisioned Vault instance. Veeva provides a Production vault and a Sandbox vault. The admin's first tasks are:</p>
  <ul>
    <li>Set the <strong>timezone, date formats, and locale</strong> in Admin → Settings → General Settings</li>
    <li>Configure <strong>password policies</strong> (complexity, rotation frequency, SSO integration) under Admin → Security → Password Policies</li>
    <li>Enable <strong>SAML SSO</strong> for your identity provider (Okta, Azure AD, Ping) so users log in with their corporate credentials — not a separate Vault password</li>
    <li>Review <strong>IP range restrictions</strong> to limit admin console access to corporate IP ranges</li>
  </ul>

  <h3>Step 2: Set Up Object Types</h3>
  <p>Object Types (replacing Salesforce Record Types) define the categories of records within each object. For the Account object, typical Object Types are: <strong>HCP</strong> (for physicians, NPs, PAs), <strong>HCO</strong> (hospitals, clinics, IDNs), and <strong>Payer Organization</strong>. For Call reports: <strong>Detail Call</strong>, <strong>MSL Interaction</strong>, <strong>Phone Call</strong>, <strong>Virtual Call</strong>.</p>
  <p>Navigate to Admin → Objects → [Object Name] → Object Types → Create. Assign each Object Type its own page layout, so an HCP account page shows different fields than an HCO account page.</p>

  <h3>Step 3: Configure Page Layouts</h3>
  <p>Page Layouts in Vault CRM control which fields appear on a record, in what order, and which sections are visible. Unlike Salesforce, where layouts are assigned per Profile + Record Type combination, Vault assigns layouts per Object Type — simpler and less error-prone. Go to Admin → Objects → [Object] → Page Layouts → Create. Drag fields into sections. Mark required fields. Hide fields that do not apply to a given type.</p>

  <h3>Step 4: Define Picklist Values</h3>
  <p>Picklist values (drop-down options) in Vault are centrally managed under Admin → Picklists. A single picklist can be reused across multiple objects and fields. This is a significant improvement over Salesforce where each field's picklist was managed independently — in Vault, updating a picklist in one place updates all fields referencing it simultaneously.</p>

  <h3>Step 5: Configure Lifecycles</h3>
  <p>Lifecycles replace Salesforce workflows and control how records move through defined states. A Call Report lifecycle might have states: <strong>Planned → In Progress → Submitted → Approved → Locked</strong>. Entry actions (auto-populate fields when entering a state), entry criteria (conditions that must be true to transition), and allowed users (who can move the record to which state) are all configured here. Navigate to Admin → Objects → [Object] → Lifecycles.</p>

  <h3>Step 6: Set Up Product Catalog</h3>
  <p>Products are managed under the Product object. Create one Product record per brand/formulation/indication. Link each Product to the CLM Presentations and Approved Email templates that reps are authorized to use for that product. Assign products to Cycle Plans to control which products appear in a rep's detail priority.</p>

  <!-- ═══════════════════════════════════
       USER MANAGEMENT
  ═══════════════════════════════════ -->
  <h2 id="vcrm-user-mgmt">User Management in Vault CRM</h2>

  <p>Marcus's second week was spent building the user model. In Vault CRM, every user sits at the intersection of four control layers: <strong>Security Profile</strong> (what objects they can see), <strong>Permission Sets</strong> (what actions they can take), <strong>Role</strong> (where they sit in the hierarchy), and <strong>Object Type access</strong> (which record categories they can work with).</p>

  <h3>Creating a New User</h3>
  <p>In the Vault admin console, navigate to Admin → Users &amp; Groups → Users → Create. Fill in:</p>
  <ul>
    <li><strong>User Name</strong> (must be unique; typically corporate email)</li>
    <li><strong>Security Profile</strong> — the base permission set</li>
    <li><strong>License Type</strong> — Full User, Read-Only, or Portal User</li>
    <li><strong>Default Locale, Timezone, Language</strong></li>
    <li><strong>Active status</strong> — inactive users cannot log in but their records are preserved</li>
  </ul>
  <p>Then assign the user to a <strong>Group</strong> (e.g., Territory Sales Team, MSL Team) and a <strong>Role</strong> in the role hierarchy. The role determines data visibility — a rep sees only accounts in their territory; a regional manager sees all accounts in their region.</p>

  <h3>Bulk User Management</h3>
  <p>For large deployments (hundreds or thousands of reps), use the <strong>Vault Loader</strong> or the <strong>User API</strong> to bulk-create and update users via CSV upload. Each row maps to a user record. The same Vault Loader can manage territory assignments, product authorizations, and cycle plan targets in bulk — making periodic field force realignment manageable without manual data entry.</p>

  <!-- ═══════════════════════════════════
       PERMISSION SETS
  ═══════════════════════════════════ -->
  <h2 id="vcrm-permissions">Permission Sets &amp; Security Model</h2>

  <p>The Vault CRM security model is both simpler and more powerful than Salesforce. Here is how it works:</p>

  <h3>Security Profiles (Base Permissions)</h3>
  <p>A Security Profile defines the baseline: which objects a user can access (read, create, edit, delete), which fields are visible (Field Permissions), and which object types are available. Think of it as the foundation — it defines the floor of what a user can do. Standard profiles include: <strong>Commercial Rep</strong>, <strong>Regional Manager</strong>, <strong>MSL</strong>, <strong>Medical Affairs Manager</strong>, <strong>CRM Administrator</strong>, and <strong>Read Only</strong>.</p>

  <h3>Permission Sets (Additive Expansions)</h3>
  <p>Permission Sets add capabilities on top of the Security Profile. A Commercial Rep might have the <em>Sample Management</em> Permission Set activated (enabling sample drop capabilities) and the <em>Approved Email</em> Permission Set activated. An MSL gets the <em>Medical Interactions</em> and <em>Publications Access</em> Permission Sets. A key account manager might additionally receive the <em>Payer Account Access</em> Permission Set.</p>
  <p>The key architectural principle: Permission Sets can only <em>expand</em> what a Security Profile allows — they cannot override restrictions. If the Security Profile says a rep cannot delete Account records, no Permission Set can grant that ability. Deletion rights require a Security Profile change — a deliberate design to prevent privilege escalation through Permission Set assignment.</p>

  <h3>Role Hierarchy &amp; Data Visibility</h3>
  <p>Roles control which records a user can <em>see</em>. Vault uses an ownership-based model: a record is visible to the owner and everyone above them in the role hierarchy. A Territory Rep owns their Account records; their District Manager sees all Territory Reps' records; the Regional VP sees all District Managers' records. This is configured under Admin → Security → Roles. Cross-territory visibility (needed for KAM or home-office analytics) is handled through Sharing Rules — granting read or read/write access to records based on criteria (e.g., "all Accounts in IDN type are visible to the KAM team").</p>

  <h3>The Medical–Commercial Firewall in Vault CRM</h3>
  <p>In Vault CRM, the commercial–medical firewall is implemented through Object Type access within the Security Profile. Commercial Rep profiles have access to the <em>Commercial</em> object types only (Detail Call, Approved Email, Sample Transaction). MSL profiles have access to <em>Medical</em> object types only (Medical Interaction, Medical Inquiry, Scientific Exchange). The Account object is shared — both see the same HCP record — but the activity records below it are type-firewalled. This is cleaner and more auditable than the Salesforce implementation, where firewall enforcement relied on Profiles + Record Type visibility combinations that were notoriously complex to maintain.</p>

  <!-- ═══════════════════════════════════
       PROMOMATS INTEGRATION
  ═══════════════════════════════════ -->
  <h2 id="vcrm-promomats">Integration with Vault PromoMats</h2>

  <p>The PromoMats integration is where Vault CRM's native platform advantage becomes most visible. Because Vault CRM and Vault PromoMats are both Vault applications, the integration is not an external API call — it is an <em>intra-vault reference</em>.</p>

  <h3>How CLM Content Flows</h3>
  <p>When a brand team uploads a new CLM presentation to PromoMats and routes it through the MLR review workflow, the approved content becomes available in Vault CRM automatically — no sync job, no content export, no IT ticket. The CLM Viewer in the rep's mobile app references the PromoMats document ID directly. When the rep launches CLM during a call, the approved slides are served in real time from PromoMats.</p>

  <p>The consequence is immediate and powerful: when MLR approves a content update — a corrected efficacy claim, a label change, a competitor response slide — it appears in every rep's CLM deck within minutes. When MLR withdraws content — a safety update, a promotional piece taken out of circulation — it disappears from CRM immediately. There is no window where reps can accidentally use withdrawn content.</p>

  <h3>Approved Email Template Synchronization</h3>
  <p>Approved Email templates work the same way. An email template approved in PromoMats (with the mandatory ISI footer, the approved subject line, the compliant body text) is referenced by Vault CRM, not copied into it. The rep selects from a menu of active approved templates. Archived templates no longer appear. Templates requiring personalization (HCP name, product name, territory) use Vault's token system — approved variable slots within a fixed structure that cannot be altered by the rep.</p>

  <h3>Engagement Data Flowing Back to PromoMats</h3>
  <p>CLM engagement data — which slides were shown, for how long, with what key message reaction (positive, negative, neutral, none) — flows from CRM back to PromoMats analytics. Brand managers can see, at slide level, which parts of the CLM presentation are resonating and which are being skipped. A slide with consistently negative reactions triggers a content review cycle. This closed-loop feedback is the foundation of the brand's evidence-based promotional strategy.</p>

  <!-- ═══════════════════════════════════
       MEDCOMM INTEGRATION
  ═══════════════════════════════════ -->
  <h2 id="vcrm-medcomm">Integration with Vault MedComm (Medical)</h2>

  <p>Vault MedComm is the medical affairs application within the Vault platform — covering scientific exchange, medical inquiry management, publication planning, and MSL field operations. Its integration with Vault CRM is governed by the commercial–medical firewall while enabling shared infrastructure where appropriate.</p>

  <h3>Shared Account &amp; Contact Foundation</h3>
  <p>Both Vault CRM (commercial) and Vault MedComm (medical) read from the same Account and Contact objects. When a commercial rep updates an HCP's phone number in CRM, the MSL sees the updated record in MedComm immediately — no sync delay, no duplicate records to reconcile. The master data layer is truly shared.</p>

  <h3>Medical Inquiry Routing</h3>
  <p>When a commercial rep receives an unsolicited medical question from an HCP during a call — for example, a question about off-label use — the rep cannot answer it directly (FDCA Sec. 502(n) constraints on off-label promotion). Instead, the rep flags the inquiry in the Call Report, triggering a Medical Information Request workflow in Vault MedComm. The medical information team receives the inquiry, prepares a compliant Standard Response Letter (a Vault MedComm document with its own MLR-cleared lifecycle), and sends it to the HCP — all within Vault, all audited. The rep receives a notification that the inquiry was handled.</p>

  <h3>KOL Engagement Coordination</h3>
  <p>KOL records exist in the Account object, visible to both commercial and medical. But the <em>type</em> of engagement is firewalled. Commercial engagement (detail calls, speaker bureau invitations) flows through Vault CRM. Medical engagement (advisory board participation, IIS grants, publication authorship) flows through Vault MedComm. The Vault platform prevents overlap: an MSL cannot see the commercial detail history; a rep cannot see the scientific exchange notes. But both can see whether the KOL has an upcoming congress attendance — enabling coordinated approach without crossing the firewall.</p>

  <!-- ═══════════════════════════════════
       NETWORK INTEGRATION
  ═══════════════════════════════════ -->
  <h2 id="vcrm-network">Integration with Veeva Network (MDM)</h2>

  <p>Veeva Network is the master data management (MDM) layer — the authoritative source of HCP identity, credentials, affiliations, and contact information. In Vault CRM, the Network integration is a first-class, real-time connection.</p>

  <h3>How Master Data Flows</h3>
  <p>When an HCP record is created or updated in Network — new DEA registration, address change, specialty update, new hospital affiliation — the change propagates to Vault CRM accounts in real time. The CRM account record is a <em>subscriber</em> to the Network master. Local edits (territory-specific notes, call preferences, internal identifiers) are stored in CRM-only fields that do not flow back to Network. This unidirectional model keeps Network clean while allowing operational flexibility in CRM.</p>

  <p>Network's <strong>DCR (Data Change Request)</strong> workflow lets CRM users flag errors in master data — wrong address, incorrect specialty, duplicate record — without being able to directly edit the master. DCRs go to the Network stewardship team for review and approval, maintaining data governance integrity.</p>

  <h3>HCP Eligibility &amp; Compliance Checks</h3>
  <p>Network maintains each HCP's <strong>license status</strong>, <strong>DEA registration</strong>, <strong>exclusion list</strong> status (OIG, GSA), and <strong>state-level sample eligibility</strong>. Vault CRM pulls these attributes at call time. Before a rep can create a sample transaction for an HCP, CRM automatically checks Network for current DEA registration and state license validity. If an HCP has been placed on the OIG exclusion list, the system blocks sample drops and flags the account for compliance review — without requiring the rep to manually check compliance databases.</p>

  <!-- ═══════════════════════════════════
       MIGRATION ROADMAP
  ═══════════════════════════════════ -->
  <h2 id="vcrm-migration">Migration Roadmap: Veeva CRM → Vault CRM</h2>

  <p>Marcus closed his notebook at the end of the week with an eight-phase plan. Full-lifecycle migrations from legacy Veeva CRM (Salesforce-based) to next-generation Vault CRM require a structured, zero-data-loss methodology covering every dimension — from CRM audit and data extraction through configuration rebuild, integration re-mapping, global wave rollout, and post-go-live hypercare. One team, end-to-end ownership.</p>

  <!-- Key outcome metrics -->
  <div style="display:flex;gap:10px;flex-wrap:wrap;margin:20px 0 24px 0;">
    <div style="flex:1;min-width:110px;background:#EBF0F8;border:1px solid #1B3A6B;border-radius:6px;padding:10px 12px;text-align:center;">
      <div style="font-size:17px;font-weight:700;color:#1B3A6B;">Zero</div>
      <div style="font-size:9.5px;color:#4A5568;margin-top:3px;">Data Loss</div>
    </div>
    <div style="flex:1;min-width:110px;background:#EBF0F8;border:1px solid #0B6B6B;border-radius:6px;padding:10px 12px;text-align:center;">
      <div style="font-size:17px;font-weight:700;color:#0B6B6B;">30%</div>
      <div style="font-size:9.5px;color:#4A5568;margin-top:3px;">Faster Go-Live</div>
    </div>
    <div style="flex:1;min-width:110px;background:#EBF0F8;border:1px solid #0B6B6B;border-radius:6px;padding:10px 12px;text-align:center;">
      <div style="font-size:17px;font-weight:700;color:#0B6B6B;">95%+</div>
      <div style="font-size:9.5px;color:#4A5568;margin-top:3px;">Rep Adoption</div>
    </div>
    <div style="flex:1;min-width:110px;background:#EBF0F8;border:1px solid #4A2080;border-radius:6px;padding:10px 12px;text-align:center;">
      <div style="font-size:17px;font-weight:700;color:#4A2080;">40%</div>
      <div style="font-size:9.5px;color:#4A5568;margin-top:3px;">Lower Risk</div>
    </div>
    <div style="flex:1;min-width:110px;background:#1A1030;border:1px solid #4A2080;border-radius:6px;padding:10px 12px;text-align:center;">
      <div style="font-size:13px;font-weight:700;color:#C0A0FF;">AI Accel.</div>
      <div style="font-size:9.5px;color:#9060D0;margin-top:3px;">Migration Accelerators</div>
    </div>
  </div>

  <!-- 8-Phase SVG -->
  <figure class="vis-embed" aria-label="8-Phase Migration Methodology">
    <div class="vis-label"><span class="vis-icon">◈</span> 8-Phase Migration Methodology — Veeva CRM to Vault CRM</div>
    <div class="vis-inner" style="padding:20px;">
      <svg viewBox="0 0 960 230" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:700px;display:block;">
        <defs>
          <marker id="migArr" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto">
            <path d="M0,0 L0,6 L6,3 z" fill="#94A3B8"/>
          </marker>
        </defs>
        <rect width="960" height="230" fill="#F8FAFC"/>

        <!-- Band headers -->
        <rect x="0"   y="0" width="240" height="20" fill="#EBF0F8"/>
        <text x="120" y="14" text-anchor="middle" fill="#1B3A6B" font-size="8" font-weight="700" letter-spacing="1.2">DISCOVERY &amp; DATA</text>
        <rect x="240" y="0" width="240" height="20" fill="#E0F7F7"/>
        <text x="360" y="14" text-anchor="middle" fill="#0B6060" font-size="8" font-weight="700" letter-spacing="1.2">CONFIGURATION &amp; REPORTING</text>
        <rect x="480" y="0" width="240" height="20" fill="#1A1030"/>
        <text x="600" y="14" text-anchor="middle" fill="#C0A0FF" font-size="8" font-weight="700" letter-spacing="1.2">INTEGRATION &amp; ROLLOUT</text>
        <rect x="720" y="0" width="240" height="20" fill="#1A1010"/>
        <text x="840" y="14" text-anchor="middle" fill="#FFA657" font-size="8" font-weight="700" letter-spacing="1.2">CHANGE &amp; ADOPTION</text>
        <line x1="240" y1="0" x2="240" y2="230" stroke="#E2E8F0" stroke-width="1"/>
        <line x1="480" y1="0" x2="480" y2="230" stroke="#E2E8F0" stroke-width="1"/>
        <line x1="720" y1="0" x2="720" y2="230" stroke="#E2E8F0" stroke-width="1"/>

        <!-- Phase 1 -->
        <rect x="6" y="26" width="110" height="82" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <circle cx="18" cy="26" r="10" fill="#1B3A6B"/>
        <text x="18" y="30" text-anchor="middle" fill="#EBF0F8" font-size="8.5" font-weight="700">1</text>
        <text x="61" y="47" text-anchor="middle" fill="#1B3A6B" font-size="9.5" font-weight="700">Strategy &amp;</text>
        <text x="61" y="60" text-anchor="middle" fill="#1B3A6B" font-size="9.5" font-weight="700">Planning</text>
        <text x="61" y="77" text-anchor="middle" fill="#4A5568" font-size="7.5">Discovery workshops</text>
        <text x="61" y="89" text-anchor="middle" fill="#4A5568" font-size="7.5">CRM audit · Inventory</text>
        <line x1="116" y1="67" x2="123" y2="67" stroke="#94A3B8" stroke-width="1.5" marker-end="url(#migArr)"/>

        <!-- Phase 2 -->
        <rect x="124" y="26" width="110" height="82" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <circle cx="136" cy="26" r="10" fill="#1B3A6B"/>
        <text x="136" y="30" text-anchor="middle" fill="#EBF0F8" font-size="8.5" font-weight="700">2</text>
        <text x="179" y="47" text-anchor="middle" fill="#1B3A6B" font-size="9.5" font-weight="700">Data</text>
        <text x="179" y="60" text-anchor="middle" fill="#1B3A6B" font-size="9.5" font-weight="700">Migration</text>
        <text x="179" y="77" text-anchor="middle" fill="#4A5568" font-size="7.5">Extraction · Cleansing</text>
        <text x="179" y="89" text-anchor="middle" fill="#4A5568" font-size="7.5">Transform · Validated load</text>
        <line x1="234" y1="67" x2="248" y2="67" stroke="#94A3B8" stroke-width="1.5" marker-end="url(#migArr)"/>

        <!-- Phase 3 -->
        <rect x="248" y="26" width="110" height="82" rx="6" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <circle cx="260" cy="26" r="10" fill="#0B6060"/>
        <text x="260" y="30" text-anchor="middle" fill="#E0F7F7" font-size="8.5" font-weight="700">3</text>
        <text x="303" y="47" text-anchor="middle" fill="#0B6060" font-size="9.5" font-weight="700">Configuration</text>
        <text x="303" y="60" text-anchor="middle" fill="#0B6060" font-size="9.5" font-weight="700">Transfer</text>
        <text x="303" y="77" text-anchor="middle" fill="#4A5568" font-size="7.5">Rules · Workflows</text>
        <text x="303" y="89" text-anchor="middle" fill="#4A5568" font-size="7.5">Admin configs in Vault</text>
        <line x1="358" y1="67" x2="364" y2="67" stroke="#94A3B8" stroke-width="1.5" marker-end="url(#migArr)"/>

        <!-- Phase 4 -->
        <rect x="364" y="26" width="110" height="82" rx="6" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <circle cx="376" cy="26" r="10" fill="#0B6060"/>
        <text x="376" y="30" text-anchor="middle" fill="#E0F7F7" font-size="8.5" font-weight="700">4</text>
        <text x="419" y="47" text-anchor="middle" fill="#0B6060" font-size="9.5" font-weight="700">Reports &amp;</text>
        <text x="419" y="60" text-anchor="middle" fill="#0B6060" font-size="9.5" font-weight="700">Analytics</text>
        <text x="419" y="77" text-anchor="middle" fill="#4A5568" font-size="7.5">Dashboards · Call reports</text>
        <text x="419" y="89" text-anchor="middle" fill="#4A5568" font-size="7.5">Territory analytics rebuilt</text>
        <line x1="474" y1="67" x2="488" y2="67" stroke="#94A3B8" stroke-width="1.5" marker-end="url(#migArr)"/>

        <!-- Phase 5 -->
        <rect x="488" y="26" width="110" height="82" rx="6" fill="#1A1030" stroke="#4A2080" stroke-width="1.5"/>
        <circle cx="500" cy="26" r="10" fill="#4A2080"/>
        <text x="500" y="30" text-anchor="middle" fill="#E0CCFF" font-size="8.5" font-weight="700">5</text>
        <text x="543" y="47" text-anchor="middle" fill="#C0A0FF" font-size="9.5" font-weight="700">Systems</text>
        <text x="543" y="60" text-anchor="middle" fill="#C0A0FF" font-size="9.5" font-weight="700">Integration</text>
        <text x="543" y="77" text-anchor="middle" fill="#9060D0" font-size="7.5">ERP · MDM · Data Cloud</text>
        <text x="543" y="89" text-anchor="middle" fill="#9060D0" font-size="7.5">PromoMats re-mapping</text>
        <line x1="598" y1="67" x2="604" y2="67" stroke="#9060D0" stroke-width="1.5" marker-end="url(#migArr)"/>

        <!-- Phase 6 -->
        <rect x="604" y="26" width="110" height="82" rx="6" fill="#1A1030" stroke="#4A2080" stroke-width="1.5"/>
        <circle cx="616" cy="26" r="10" fill="#4A2080"/>
        <text x="616" y="30" text-anchor="middle" fill="#E0CCFF" font-size="8.5" font-weight="700">6</text>
        <text x="659" y="47" text-anchor="middle" fill="#C0A0FF" font-size="9.5" font-weight="700">Global</text>
        <text x="659" y="60" text-anchor="middle" fill="#C0A0FF" font-size="9.5" font-weight="700">Rollouts</text>
        <text x="659" y="77" text-anchor="middle" fill="#9060D0" font-size="7.5">Country wave rollout</text>
        <text x="659" y="89" text-anchor="middle" fill="#9060D0" font-size="7.5">Localisation · Regulatory</text>
        <line x1="714" y1="67" x2="728" y2="67" stroke="#9060D0" stroke-width="1.5" marker-end="url(#migArr)"/>

        <!-- Phase 7 -->
        <rect x="728" y="26" width="110" height="82" rx="6" fill="#1A1010" stroke="#5A2000" stroke-width="1.5"/>
        <circle cx="740" cy="26" r="10" fill="#7A3000"/>
        <text x="740" y="30" text-anchor="middle" fill="#FFE8D0" font-size="8.5" font-weight="700">7</text>
        <text x="783" y="47" text-anchor="middle" fill="#FFA657" font-size="9.5" font-weight="700">Business</text>
        <text x="783" y="60" text-anchor="middle" fill="#FFA657" font-size="9.5" font-weight="700">Process Svcs</text>
        <text x="783" y="77" text-anchor="middle" fill="#7A4020" font-size="7.5">SOP redesign · Re-eng.</text>
        <text x="783" y="89" text-anchor="middle" fill="#7A4020" font-size="7.5">Change management</text>
        <line x1="838" y1="67" x2="844" y2="67" stroke="#FFA657" stroke-width="1.5" marker-end="url(#migArr)"/>

        <!-- Phase 8 -->
        <rect x="844" y="26" width="110" height="82" rx="6" fill="#1A1010" stroke="#5A2000" stroke-width="1.5"/>
        <circle cx="856" cy="26" r="10" fill="#7A3000"/>
        <text x="856" y="30" text-anchor="middle" fill="#FFE8D0" font-size="8.5" font-weight="700">8</text>
        <text x="899" y="47" text-anchor="middle" fill="#FFA657" font-size="9.5" font-weight="700">User</text>
        <text x="899" y="60" text-anchor="middle" fill="#FFA657" font-size="9.5" font-weight="700">Onboarding</text>
        <text x="899" y="77" text-anchor="middle" fill="#7A4020" font-size="7.5">Role-based training</text>
        <text x="899" y="89" text-anchor="middle" fill="#7A4020" font-size="7.5">Mobile · Hypercare</text>

        <!-- Delivery row label -->
        <rect x="0" y="120" width="960" height="14" fill="#F8FAFC"/>
        <text x="480" y="131" text-anchor="middle" fill="#4A5568" font-size="7.5" font-weight="600" letter-spacing="1.2">WHAT GETS DELIVERED</text>

        <!-- Delivery card 1 -->
        <rect x="6" y="138" width="152" height="56" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1"/>
        <text x="82" y="153" text-anchor="middle" fill="#1B3A6B" font-size="8.5" font-weight="700">Migration Assessment</text>
        <text x="82" y="166" text-anchor="middle" fill="#4A5568" font-size="7.5">CRM audit · Data quality scoring</text>
        <text x="82" y="178" text-anchor="middle" fill="#4A5568" font-size="7.5">Integration mapping</text>

        <!-- Delivery card 2 -->
        <rect x="164" y="138" width="152" height="56" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1"/>
        <text x="240" y="153" text-anchor="middle" fill="#1B3A6B" font-size="8.5" font-weight="700">Data Extract &amp; Transform</text>
        <text x="240" y="166" text-anchor="middle" fill="#4A5568" font-size="7.5">Full extraction · Deduplication</text>
        <text x="240" y="178" text-anchor="middle" fill="#4A5568" font-size="7.5">Enrichment · Rollback controls</text>

        <!-- Delivery card 3 -->
        <rect x="322" y="138" width="152" height="56" rx="5" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1"/>
        <text x="398" y="153" text-anchor="middle" fill="#0B6060" font-size="8.5" font-weight="700">Config &amp; Custom Build</text>
        <text x="398" y="166" text-anchor="middle" fill="#4A5568" font-size="7.5">Object &amp; field config</text>
        <text x="398" y="178" text-anchor="middle" fill="#4A5568" font-size="7.5">Workflow · Territory setup</text>

        <!-- Delivery card 4 -->
        <rect x="480" y="138" width="152" height="56" rx="5" fill="#1A1030" stroke="#4A2080" stroke-width="1"/>
        <text x="556" y="153" text-anchor="middle" fill="#C0A0FF" font-size="8.5" font-weight="700">Integration Architecture</text>
        <text x="556" y="166" text-anchor="middle" fill="#9060D0" font-size="7.5">Vault API · Commercial Data Cloud</text>
        <text x="556" y="178" text-anchor="middle" fill="#9060D0" font-size="7.5">ERP &amp; third-party connectors</text>

        <!-- Delivery card 5 -->
        <rect x="638" y="138" width="152" height="56" rx="5" fill="#1A1010" stroke="#5A2000" stroke-width="1"/>
        <text x="714" y="153" text-anchor="middle" fill="#FFA657" font-size="8.5" font-weight="700">Training &amp; Change Mgmt</text>
        <text x="714" y="166" text-anchor="middle" fill="#7A4020" font-size="7.5">Rep &amp; manager training</text>
        <text x="714" y="178" text-anchor="middle" fill="#7A4020" font-size="7.5">Mobile enablement · Adoption</text>

        <!-- Delivery card 6 -->
        <rect x="796" y="138" width="158" height="56" rx="5" fill="#1A1010" stroke="#5A2000" stroke-width="1"/>
        <text x="875" y="153" text-anchor="middle" fill="#FFA657" font-size="8.5" font-weight="700">Hypercare &amp; Stabilisation</text>
        <text x="875" y="166" text-anchor="middle" fill="#7A4020" font-size="7.5">Dedicated hypercare team</text>
        <text x="875" y="178" text-anchor="middle" fill="#7A4020" font-size="7.5">24/7 monitoring · Performance</text>
      </svg>
    </div>
    <figcaption class="vis-cap">8-phase migration methodology — from CRM audit and data extraction through go-live hypercare and stabilisation</figcaption>
  </figure>

  <h3>Phase 1 — Strategy &amp; Planning</h3>
  <p>Discovery workshops establish the migration scope, business objectives, risk register, and timeline. A current-state CRM audit inventories every custom object, field, workflow rule, integration point, and Apex trigger in legacy Veeva CRM. The data inventory classifies all record types by volume and retention requirement — call reports, sample transactions, event records, consent records, and HCP account data — and scores each dataset for quality, completeness, and deduplication need. The output is a signed-off migration charter: what moves, what gets rebuilt natively in Vault, and what gets decommissioned.</p>

  <h3>Phase 2 — Data Migration</h3>
  <p>Full data extraction from Salesforce-based Veeva CRM uses either the Salesforce Data Loader or Veeva OpenData API depending on data type. All extracted records go through a cleansing and transformation pipeline: deduplication of HCP accounts against the Network MDM master, field-level mapping from Salesforce schema to Vault object schema (`_vod__c` → `__v`), and lookback-period scoping (typically 3–7 years per compliance requirements). Every transformed dataset is loaded into the Vault sandbox with a validated load protocol — row counts reconciled, sample transaction receipts verified, and a rollback safety checkpoint cleared before any production load. <strong>Zero data loss</strong> is enforced through automated reconciliation at each stage.</p>

  <h3>Phase 3 — Configuration Transfer</h3>
  <p>Business rules, workflows, and admin configurations are rebuilt natively in Vault CRM — not migrated. Salesforce constructs (Apex triggers, Process Builder flows, Visualforce pages) have no direct migration path; each must be re-implemented using Vault SDK, Lifecycle Entry Actions, and the Vault Page Layout Engine. This phase rebuilds Object Types and Field Permission Sets, lifecycle stage workflows for call reports and medical inquiries, PDMA-compliant sample management rules, territory and cycle plan structures, and the MLR content workflow linking PromoMats to the CLM content library. All configurations are validated in Vault UAT before promotion to production.</p>

  <h3>Phase 4 — Reports &amp; Analytics</h3>
  <p>Every dashboard, call report, SFE metric, and territory analytics view is rebuilt in Vault CRM's reporting layer and in Veeva Commercial Data Cloud. This includes rep-level call rate and reach/frequency dashboards, manager territory rollup views, sample utilisation and PDMA reconciliation reports, CLM content engagement heatmaps, and the Next Best Action scoring feeds. Validated output is compared numerically against the equivalent legacy Veeva CRM reports on the same data period to confirm equivalence before cutover sign-off.</p>

  <h3>Phase 5 — Systems Integration</h3>
  <p>All inbound and outbound integration touchpoints are re-mapped for Vault CRM's API-first architecture. Key integrations rebuilt in this phase: Network MDM ↔ Vault Account sync (real-time HCP/HCO master data), PromoMats ↔ Vault CRM CLM content pipeline, Commercial Data Cloud territory and alignment sync, ERP-to-sample-inventory feed, IQVIA/prescription data ingest, and any third-party data connectors (patient hub, specialty pharmacy, market data). All integrations are validated end-to-end in staging with automated regression tests before production cutover.</p>

  <h3>Phase 6 — Global Rollouts</h3>
  <p>Large pharmaceutical organisations execute country-by-country wave rollouts rather than a single global cutover. Waves are sequenced by market complexity, data volume, and regulatory requirements. Each country wave includes localisation (language, regulatory field requirements, local consent laws — GDPR, PDPA, country-specific HCP data rules), local training, and a country-specific hypercare window. Wave sequencing typically runs US first (highest volume, most complex configuration), followed by European markets, then emerging markets. A global control tower monitors all wave status in real time and maintains a single escalation path.</p>

  <h3>Phase 7 — Business Process Services</h3>
  <p>Migration is also an opportunity to re-engineer commercial and medical workflows rather than simply replicate legacy processes. SOPs for call reporting, sample management, Approved Email cadence, MSL insight capture, and event management are updated to leverage Vault CRM's native capabilities — Veeva AI pre-call intelligence, Next Best Action, and automated compliance checks. Change management communications, field leadership briefings, and a Center of Excellence (CoE) governance model are established to own ongoing configuration and change request management post-go-live.</p>

  <h3>Phase 8 — User Onboarding &amp; Hypercare</h3>
  <p>Role-based training covers commercial reps (call reporting, CLM, sample management, Approved Email), MSLs (scientific exchange workflow, insight capture, Medical Inquiry), managers (territory dashboards, cycle plan management), and admins (user management, permission sets, integration monitoring). Mobile app enablement is executed device-by-device for the full field force with offline sync validation. Post-go-live, a dedicated hypercare team provides 24/7 issue monitoring, same-day configuration fixes, and a structured 30/60/90-day stabilisation review. Adoption is measured weekly — CRM usage rates, call submission compliance, sample reconciliation rates — and reported to commercial leadership with an explicit adoption gate before hypercare stand-down.</p>

  <p style="margin-top:28px;padding:16px 20px;background:#EAF6F6;border-left:4px solid #0D8B8B;border-radius:0 8px 8px 0;font-style:italic;color:#0A3D62;">Marcus signed off on the eight-phase migration plan at the end of Month 1. Phase 1 had already surfaced three integration gaps no one had documented and a data quality issue in 14% of HCP records that would have caused silent failures in the Network sync. The validated load protocol in Phase 2 would catch any remaining issues before a single rep touched the new system. By Month 13, NovaTerra's 800 commercial reps and 120 MSLs would be on a single Vault platform — zero data loss, one vendor, one support contract, one validation package, one version of truth. The system built in the age of on-premise Salesforce infrastructure had given way to something purpose-built for the age of life sciences AI.</p>
"""

CH14_STRATEGY = """
  <div class="ch-running">Chapter Fourteen · Part IX &#8212; Strategy</div>
  <div class="ch-decorator">
    <div class="ch-big-num">14</div>
    <div class="ch-heading-block">
      <div class="ch-label">
        <span class="ch-pill" style="background:#0D8B8B;">Ch 14</span>
        <span style="color:#0D8B8B;">Chapter Fourteen</span>
      </div>
      <h1>Strategy &#8212; How Decisions Get Made</h1>
    </div>
  </div>

  <p class="lead">Every chapter so far has described <em>what</em> pharmaceutical functions do. This one explains <em>how the big decisions get made</em> &#8212; which products to build, which markets to enter, which patients to prioritise &#8212; and how R&amp;D, Commercial, Medical Affairs, and Market Access align behind a single plan that turns a molecule into a market success.</p>

  <p>It is January. Thirty-six months before the anticipated FDA approval date of Meridian, NovaCure Therapeutics&#x27; CDK4/6 inhibitor for HR+/HER2&#x2212; breast cancer. The strategy conference room holds twelve people: the heads of R&amp;D, Commercial, Medical Affairs, Market Access, Finance, and Regulatory. Sarah Chen, VP of Global Strategy, stands at the front. Behind her, a single slide with a single question:</p>

  <p style="text-align:center;font-size:1.15em;font-style:italic;color:#0A3D62;margin:28px 0;padding:20px 24px;background:#EAF6F6;border-left:4px solid #0D8B8B;border-radius:0 8px 8px 0;">"Who is Meridian for &#8212; and why will they choose it over everything else available?"</p>

  <p>R&amp;D wanted to lead with the mechanism of action. Commercial wanted to lead with the PFS endpoint from MERIDIAN-3. Medical Affairs wanted to lead with the tolerability profile. Market Access wanted to lead with the ICER model. Regulatory wanted to make sure no one said anything that wasn&#x27;t on the label yet.</p>

  <p>Sarah let the silence hang for five seconds, then said: <em>"All of you are right. And all of you are looking at the wrong question. Before we decide how to communicate Meridian, we need to decide where it fits, against what, and for whom. That is strategy. Everything else &#8212; the messages, the content, the field plans, the payer dossiers &#8212; follows from those choices."</em></p>

  <p>What followed was twelve months of structured work that produced the Integrated Brand Plan: one document every function could execute from. This chapter walks through how that process works.</p>

  <h2 id="ch13-framework">The Four-Phase Strategy Journey</h2>

  <p>Pharmaceutical brand strategy is not a single meeting or a single slide deck. It is a continuous cycle with four distinct phases, each producing outputs that become inputs for the next. Miss a phase and you get a strategy that looks coherent on paper but collapses when R&amp;D, Commercial, and Market Access try to execute it simultaneously &#8212; each pulling in a different direction because they never genuinely aligned.</p>

  <figure class="vis-embed" id="ch13-framework-svg" aria-label="Strategy Framework">
    <div class="vis-label"><span class="vis-icon">&#9670;</span> The Four-Phase Pharmaceutical Strategy Framework &#8212; Discover, Define, Align, Execute</div>
    <div class="vis-inner">
      <svg viewBox="0 0 800 360" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-height:400px;">
        <defs>
          <marker id="s1a" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
            <path d="M0,0 L0,6 L8,3 z" fill="#64B5B5"/>
          </marker>
        </defs>
        <rect width="800" height="360" fill="#EAF6F6"/>
        <!-- Phase 1: DISCOVER -->
        <rect x="18" y="28" width="178" height="294" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="18" y="28" width="178" height="34" rx="8" fill="#A8DADC"/>
        <rect x="18" y="50" width="178" height="12" fill="#A8DADC"/>
        <text x="107" y="50" text-anchor="middle" font-size="12" font-weight="700" fill="#0A3D62">&#9312; DISCOVER</text>
        <text x="32" y="78" font-size="9.5" fill="#374151">&#9658; Market landscape analysis</text>
        <text x="32" y="93" font-size="9.5" fill="#374151">&#9658; Patient journey mapping</text>
        <text x="32" y="108" font-size="9.5" fill="#374151">&#9658; Competitive intelligence</text>
        <text x="32" y="123" font-size="9.5" fill="#374151">&#9658; Unmet need identification</text>
        <text x="32" y="138" font-size="9.5" fill="#374151">&#9658; Payer &amp; HTA landscape</text>
        <text x="32" y="153" font-size="9.5" fill="#374151">&#9658; KOL insight interviews</text>
        <text x="32" y="168" font-size="9.5" fill="#374151">&#9658; Prescription data (IQVIA)</text>
        <text x="32" y="183" font-size="9.5" fill="#374151">&#9658; Burden of disease study</text>
        <rect x="32" y="256" width="148" height="18" rx="9" fill="#D0EEEE" stroke="#80C8C8"/>
        <text x="106" y="269" text-anchor="middle" font-size="9" fill="#0A3D62" font-weight="600">T&#8722;36 to T&#8722;24 months</text>
        <text x="107" y="300" text-anchor="middle" font-size="8.5" fill="#0A6B6B" font-style="italic">Before Phase III readout</text>
        <!-- Arrow 1&#8594;2 -->
        <line x1="197" y1="175" x2="215" y2="175" stroke="#64B5B5" stroke-width="2.5" marker-end="url(#s1a)"/>
        <!-- Phase 2: DEFINE -->
        <rect x="215" y="28" width="178" height="294" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="215" y="28" width="178" height="34" rx="8" fill="#F5D58A"/>
        <rect x="215" y="50" width="178" height="12" fill="#F5D58A"/>
        <text x="304" y="50" text-anchor="middle" font-size="12" font-weight="700" fill="#0A3D62">&#9313; DEFINE</text>
        <text x="229" y="78" font-size="9.5" fill="#374151">&#9658; Brand positioning statement</text>
        <text x="229" y="93" font-size="9.5" fill="#374151">&#9658; Target patient profile</text>
        <text x="229" y="108" font-size="9.5" fill="#374151">&#9658; Indication priority sequence</text>
        <text x="229" y="123" font-size="9.5" fill="#374151">&#9658; Value narrative &amp; proof points</text>
        <text x="229" y="138" font-size="9.5" fill="#374151">&#9658; Competitive differentiation</text>
        <text x="229" y="153" font-size="9.5" fill="#374151">&#9658; Country launch sequence</text>
        <text x="229" y="168" font-size="9.5" fill="#374151">&#9658; Lifecycle management plan</text>
        <text x="229" y="183" font-size="9.5" fill="#374151">&#9658; Portfolio priority decision</text>
        <rect x="229" y="256" width="148" height="18" rx="9" fill="#FDF0D8" stroke="#F5D58A"/>
        <text x="303" y="269" text-anchor="middle" font-size="9" fill="#0A3D62" font-weight="600">T&#8722;24 to T&#8722;12 months</text>
        <text x="304" y="300" text-anchor="middle" font-size="8.5" fill="#9A6412" font-style="italic">After Phase III readout</text>
        <!-- Arrow 2&#8594;3 -->
        <line x1="394" y1="175" x2="412" y2="175" stroke="#64B5B5" stroke-width="2.5" marker-end="url(#s1a)"/>
        <!-- Phase 3: ALIGN -->
        <rect x="412" y="28" width="178" height="294" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="412" y="28" width="178" height="34" rx="8" fill="#B8D0E8"/>
        <rect x="412" y="50" width="178" height="12" fill="#B8D0E8"/>
        <text x="501" y="50" text-anchor="middle" font-size="12" font-weight="700" fill="#0A3D62">&#9314; ALIGN</text>
        <text x="426" y="78" font-size="9.5" fill="#374151">&#9658; IBP cross-functional workshop</text>
        <text x="426" y="93" font-size="9.5" fill="#374151">&#9658; Function objective-setting</text>
        <text x="426" y="108" font-size="9.5" fill="#374151">&#9658; Evidence gap assessment</text>
        <text x="426" y="123" font-size="9.5" fill="#374151">&#9658; Budget allocation by function</text>
        <text x="426" y="138" font-size="9.5" fill="#374151">&#9658; KPI &amp; milestone agreement</text>
        <text x="426" y="153" font-size="9.5" fill="#374151">&#9658; Stakeholder engagement plan</text>
        <text x="426" y="168" font-size="9.5" fill="#374151">&#9658; Risk &amp; scenario modelling</text>
        <text x="426" y="183" font-size="9.5" fill="#374151">&#9658; War-game simulation</text>
        <rect x="426" y="256" width="148" height="18" rx="9" fill="#DCECf8" stroke="#B8D0E8"/>
        <text x="500" y="269" text-anchor="middle" font-size="9" fill="#0A3D62" font-weight="600">T&#8722;12 to T&#8722;6 months</text>
        <text x="501" y="300" text-anchor="middle" font-size="8.5" fill="#0A3D62" font-style="italic">Pre-NDA/BLA submission</text>
        <!-- Arrow 3&#8594;4 -->
        <line x1="591" y1="175" x2="609" y2="175" stroke="#64B5B5" stroke-width="2.5" marker-end="url(#s1a)"/>
        <!-- Phase 4: EXECUTE -->
        <rect x="609" y="28" width="173" height="294" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="609" y="28" width="173" height="34" rx="8" fill="#FFBCAD"/>
        <rect x="609" y="50" width="173" height="12" fill="#FFBCAD"/>
        <text x="695" y="50" text-anchor="middle" font-size="12" font-weight="700" fill="#0A3D62">&#9315; EXECUTE</text>
        <text x="623" y="78" font-size="9.5" fill="#374151">&#9658; Sales force deployment</text>
        <text x="623" y="93" font-size="9.5" fill="#374151">&#9658; HCP engagement (CRM)</text>
        <text x="623" y="108" font-size="9.5" fill="#374151">&#9658; Formulary contracting</text>
        <text x="623" y="123" font-size="9.5" fill="#374151">&#9658; HTA submissions &amp; response</text>
        <text x="623" y="138" font-size="9.5" fill="#374151">&#9658; MSL scientific exchange</text>
        <text x="623" y="153" font-size="9.5" fill="#374151">&#9658; Congress &amp; publications</text>
        <text x="623" y="168" font-size="9.5" fill="#374151">&#9658; Patient access programmes</text>
        <text x="623" y="183" font-size="9.5" fill="#374151">&#9658; Performance &amp; re-strategy</text>
        <rect x="623" y="256" width="145" height="18" rx="9" fill="#FFE8E4" stroke="#FFBCAD"/>
        <text x="695" y="269" text-anchor="middle" font-size="9" fill="#0A3D62" font-weight="600">T&#8722;0: Launch day onward</text>
        <text x="695" y="300" text-anchor="middle" font-size="8.5" fill="#B83224" font-style="italic">Continuous optimisation</text>
        <!-- Footer note -->
        <text x="400" y="345" text-anchor="middle" font-size="9" fill="#64748B">Strategy is a loop &#8212; post-launch data feeds back into DISCOVER for lifecycle decisions, indication expansions, and portfolio choices</text>
      </svg>
    </div>
    <figcaption class="vis-cap">The four-phase brand strategy journey &#8212; each phase produces outputs that become inputs for the next</figcaption>
  </figure>

  <h2 id="ch13-positioning">Brand Positioning &#8212; Finding the White Space</h2>

  <p>Brand positioning answers one question: <em>in the mind of the target prescriber, what is this drug, for whom, and why is it different from everything else?</em> It sounds simple. In practice it is one of the most contentious exercises in pharmaceutical brand planning, because it requires every function to agree on a single statement &#8212; and that statement constrains what every function can say and do for the next several years.</p>

  <p>At NovaCure, the positioning work began six months after the Phase III readout from MERIDIAN-3. The trial had demonstrated a median PFS of 24.3 months versus 16.1 months for the standard-of-care comparator &#8212; a statistically significant and clinically meaningful improvement. But the truly differentiated finding was in the safety profile: Grade 3/4 haematological toxicity of 8.2% versus 43.7% for palbociclib-class CDK4/6 inhibitors. That single data point, Sarah realised, was the strategic anchor. Not the PFS benefit &#8212; every CDK4/6 inhibitor had PFS benefit. The tolerability was the white space.</p>

  <figure class="vis-embed" id="ch13-positioning-svg" aria-label="Brand Positioning Map">
    <div class="vis-label"><span class="vis-icon">&#9670;</span> Brand Positioning Map &#8212; Meridian vs. CDK4/6 Inhibitor Competitive Landscape</div>
    <div class="vis-inner">
      <svg viewBox="0 0 800 480" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-height:520px;">
        <defs>
          <marker id="s2a" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto">
            <path d="M0,0 L0,6 L7,3 z" fill="#374151"/>
          </marker>
          <marker id="s2b" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto">
            <path d="M0,0 L0,6 L7,3 z" fill="#0D8B8B"/>
          </marker>
        </defs>
        <rect width="800" height="480" fill="#EAF6F6"/>
        <!-- Quadrant backgrounds -->
        <rect x="80" y="55" width="310" height="195" fill="#FFF0E8" opacity="0.7" rx="4"/>
        <rect x="390" y="55" width="350" height="195" fill="#D6F0F0" opacity="0.7" rx="4"/>
        <rect x="80" y="250" width="310" height="170" fill="#F5F5F0" opacity="0.6" rx="4"/>
        <rect x="390" y="250" width="350" height="170" fill="#FDF0D8" opacity="0.5" rx="4"/>
        <!-- Grid -->
        <line x1="80" y1="250" x2="760" y2="250" stroke="#374151" stroke-width="1.5" marker-end="url(#s2a)"/>
        <line x1="390" y1="440" x2="390" y2="44" stroke="#374151" stroke-width="1.5" marker-end="url(#s2a)"/>
        <line x1="80" y1="250" x2="80" y2="44" stroke="#D0D0D0" stroke-width="0.5"/>
        <line x1="760" y1="44" x2="760" y2="440" stroke="#D0D0D0" stroke-width="0.5"/>
        <!-- Axis labels -->
        <text x="420" y="464" text-anchor="middle" font-size="11" font-weight="700" fill="#374151">Tolerability Profile</text>
        <text x="100" y="264" font-size="9" fill="#64748B">Challenging</text>
        <text x="700" y="264" font-size="9" fill="#64748B">Excellent</text>
        <text x="395" y="50" font-size="9" fill="#64748B">Breakthrough</text>
        <text x="395" y="440" font-size="9" fill="#64748B">Modest</text>
        <!-- Y-axis label -->
        <text transform="translate(26,260) rotate(-90)" text-anchor="middle" font-size="11" font-weight="700" fill="#374151">Demonstrated Efficacy</text>
        <!-- Quadrant labels -->
        <text x="235" y="76" text-anchor="middle" font-size="10" font-weight="600" fill="#B83224">High Efficacy /</text>
        <text x="235" y="90" text-anchor="middle" font-size="10" font-weight="600" fill="#B83224">Side Effect Burden</text>
        <text x="565" y="76" text-anchor="middle" font-size="10" font-weight="600" fill="#0A6B6B">Best-in-Class Zone &#x2605;</text>
        <text x="235" y="360" text-anchor="middle" font-size="10" fill="#64748B">Limited Differentiation</text>
        <text x="565" y="360" text-anchor="middle" font-size="10" fill="#9A6412">Convenience Play</text>
        <!-- Abemaciclib circle -->
        <circle cx="185" cy="140" r="34" fill="#FFE8E4" stroke="#E8503A" stroke-width="2"/>
        <text x="185" y="136" text-anchor="middle" font-size="9" font-weight="700" fill="#B83224">Abema-</text>
        <text x="185" y="149" text-anchor="middle" font-size="9" font-weight="700" fill="#B83224">ciclib</text>
        <!-- Palbociclib circle -->
        <circle cx="290" cy="165" r="36" fill="#FDF0D8" stroke="#C4851A" stroke-width="2"/>
        <text x="290" y="161" text-anchor="middle" font-size="9" font-weight="700" fill="#9A6412">Palbo-</text>
        <text x="290" y="174" text-anchor="middle" font-size="9" font-weight="700" fill="#9A6412">ciclib</text>
        <!-- Ribociclib circle -->
        <circle cx="455" cy="158" r="32" fill="#DCECf8" stroke="#0D5580" stroke-width="2"/>
        <text x="455" y="154" text-anchor="middle" font-size="9" font-weight="700" fill="#0A3D62">Ribo-</text>
        <text x="455" y="167" text-anchor="middle" font-size="9" font-weight="700" fill="#0A3D62">ciclib</text>
        <!-- MERIDIAN star circle -->
        <circle cx="615" cy="108" r="42" fill="#D0EEEE" stroke="#0D8B8B" stroke-width="3"/>
        <text x="615" y="101" text-anchor="middle" font-size="10" font-weight="700" fill="#0A3D62">MERIDIAN</text>
        <text x="615" y="115" text-anchor="middle" font-size="8.5" fill="#0A3D62">(NovaCure)</text>
        <text x="656" y="80" font-size="20" fill="#0D8B8B">&#x2605;</text>
        <!-- Target sweet spot -->
        <circle cx="615" cy="120" r="90" fill="none" stroke="#0D8B8B" stroke-width="1.5" stroke-dasharray="6,4"/>
        <text x="706" y="90" font-size="8.5" fill="#0A6B6B" font-style="italic">Target</text>
        <text x="706" y="102" font-size="8.5" fill="#0A6B6B" font-style="italic">sweet spot</text>
        <!-- Gap arrow -->
        <line x1="495" y1="148" x2="568" y2="122" stroke="#0D8B8B" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#s2b)"/>
        <text x="510" y="162" font-size="8" fill="#0A6B6B">Competitor gap &#8594;</text>
        <!-- Legend box -->
        <rect x="80" y="418" width="680" height="46" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1"/>
        <text x="96" y="436" font-size="9" font-weight="700" fill="#374151">Note: Bubble size reflects relative market share. Positions reflect oncologist perception data from 847-HCP primary market research survey (NovaCure, 2023).</text>
        <text x="96" y="452" font-size="9" fill="#64748B">Meridian's tolerability advantage (Grade 3/4 haematological toxicity 8.2% vs 43.7% for palbociclib class) is the primary positioning anchor and key differentiator.</text>
      </svg>
    </div>
    <figcaption class="vis-cap">Brand positioning map &#8212; Meridian occupies the upper-right &ldquo;best-in-class&rdquo; quadrant: breakthrough efficacy with the best tolerability profile in class</figcaption>
  </figure>

  <p>The positioning statement NovaCure ultimately adopted was: <em>"Meridian is the CDK4/6 inhibitor for HR+/HER2&#x2212; advanced breast cancer patients who deserve a best-in-class efficacy without the haematological burden that limits the quality of life and treatment continuity of current options."</em> Six weeks of debate condensed into one sentence. That sentence then constrained &#8212; productively &#8212; every decision that followed: the target patient profile (patients where treatment tolerability matters most &#8212; older patients, those with comorbidities, those already managing prior toxicities), the message hierarchy for the sales force, the endpoint selection for the outcomes studies Medical Affairs would run, and the clinical evidence package Market Access would need for NICE and HAS submissions.</p>

  <h2 id="ch13-portfolio">Portfolio &amp; Pipeline Strategy</h2>

  <p>Brand strategy for a single product is hard. Portfolio strategy &#8212; deciding how to allocate resources, prioritise development timelines, and sequence launches across multiple assets simultaneously &#8212; is an order of magnitude harder. At any given moment, a mid-size pharma company has five to fifteen clinical-stage assets competing for the same pool of manufacturing capacity, medical affairs bandwidth, commercial pre-launch investment, and regulatory team attention.</p>

  <p>The framework NovaCure uses is familiar to any strategy consultant but rarely executed well: a priority matrix plotting each asset on two dimensions: <strong>strategic value</strong> (a composite of market size, unmet need, pricing potential, and fit with commercial capabilities) against <strong>probability of technical and regulatory success</strong> (based on mechanism confidence, Phase II data quality, competitive landscape, and precedent regulatory pathways). The bubble size represents current investment.</p>

  <p>At the time of Meridian&#x27;s Phase III readout, NovaCure had four other clinical assets. The portfolio committee&#x27;s decision was straightforward once the matrix was drawn: Meridian sat in the upper-right quadrant alone &#8212; high strategic value, high probability of success. Two assets were deprioritised (moved to partnership discussions). One was fast-tracked as a combination partner for Meridian&#x27;s own lifecycle plan. This freed up $180M in projected pre-launch spend that was redirected entirely to Meridian&#x27;s market preparation.</p>

  <div class="crm-obj-grid" style="grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:14px;margin:28px 0;">
    <div class="crm-obj-card med">
      <div class="crm-obj-name med">Strategic Value Score</div>
      <div class="crm-obj-desc">Composite score (0&#8211;100) across: addressable patient population, unmet medical need severity, peak pricing potential, reimbursement pathway feasibility, commercial capability fit, and patent life at launch. NovaCure&#x27;s Meridian scored 88/100 &#8212; highest in the pipeline at the time of portfolio review.</div>
    </div>
    <div class="crm-obj-card comm">
      <div class="crm-obj-name comm">Probability of Technical Success (PTS)</div>
      <div class="crm-obj-desc">Probability that the asset will achieve regulatory approval given its current development stage. Industry benchmarks: Phase I &#8594; approval &#x2248;9.6%; Phase II &#8594; approval &#x2248;15.9%; Phase III &#8594; approval &#x2248;57.8% (CSDD 2023). Meridian entered portfolio review at Phase III with a PTS estimate of 74% given strong Phase II PoC data and precedent CDK4/6 pathway approvals.</div>
    </div>
    <div class="crm-obj-card shared">
      <div class="crm-obj-name shared">Risk-Adjusted Net Present Value (rNPV)</div>
      <div class="crm-obj-desc">The financial expression of strategic and probability scores: expected peak sales &#215; probability of success &#215; net present value discount factor. rNPV is the universal currency of portfolio prioritisation &#8212; it forces every asset onto a common scale regardless of indication or development stage. Meridian&#x27;s rNPV at Phase III entry was $2.1B, making it the dominant asset in the portfolio by a factor of 3.4&#215;.</div>
    </div>
    <div class="crm-obj-card med">
      <div class="crm-obj-name med">Build vs. Buy vs. License</div>
      <div class="crm-obj-desc">Not all pipeline assets need to be internally developed. In-licensing (bringing in an external asset for a milestone + royalty), co-development (sharing cost and risk), and acquisition (buying the company) are all valid portfolio choices. NovaCure licensed Meridian&#x27;s manufacturing partner&#x27;s CDK4/6 scaffold under a 2019 collaboration agreement, retaining full commercialisation rights in ex-Japan markets.</div>
    </div>
  </div>

  <h2 id="ch13-lifecycle">Indication &amp; Lifecycle Strategy</h2>

  <p>A drug approved in a single indication is a drug with a planned obsolescence date. The moment a compound achieves its first approval, the lifecycle team&#x27;s job begins: identifying the next indication, the next combination, the next formulation, the next patient population &#8212; anything that can generate a new patent claim, extend the exclusivity runway, and maintain commercial relevance as generic competition approaches.</p>

  <p>For Meridian, the lifecycle roadmap was agreed at the IBP workshop eighteen months before launch. Indication 1 (first-line HR+/HER2&#x2212; advanced breast cancer) was the beachhead. Indication 2 &#8212; neoadjuvant use in early-stage disease &#8212; had a Phase II trial already enrolling, with Phase III to begin at launch. A combination study with NovaCure&#x27;s PI3K inhibitor was in Phase I. And a paediatric investigation plan (PIP) was being filed with EMA to secure Paediatric Use Marketing Authorisation (PUMA) &#8212; which would extend the EU data exclusivity period by two years. Every one of these moves was planned, budgeted, and assigned to a trial team before Meridian had a single approved patient.</p>

  <figure class="vis-embed" id="ch13-lifecycle-svg" aria-label="Lifecycle and Indication Expansion">
    <div class="vis-label"><span class="vis-icon">&#9670;</span> Meridian &#8212; Lifecycle Strategy &amp; Indication Expansion Revenue Model</div>
    <div class="vis-inner">
      <svg viewBox="0 0 800 390" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-height:430px;">
        <defs>
          <marker id="s3a" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto">
            <path d="M0,0 L0,6 L7,3 z" fill="#0D8B8B"/>
          </marker>
          <marker id="s3b" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto">
            <path d="M0,0 L0,6 L7,3 z" fill="#E8503A"/>
          </marker>
        </defs>
        <rect width="800" height="390" fill="#EAF6F6"/>
        <!-- Chart area background -->
        <rect x="70" y="30" width="700" height="290" rx="4" fill="white" stroke="#A8D8D8" stroke-width="1"/>
        <!-- Revenue bands (stacked area approximation) -->
        <!-- Ind 1 base revenue band -->
        <path d="M70,320 C130,310 200,260 270,210 C340,165 390,150 450,148 C510,147 560,155 600,170 C640,185 660,200 700,230 C720,245 750,270 770,320 Z" fill="#D0EEEE" opacity="0.8"/>
        <!-- Ind 2 additive band (starts Year 3) -->
        <path d="M270,210 C310,195 350,182 400,172 C450,162 500,155 550,150 C600,146 650,145 700,142 C720,141 750,140 770,138 L770,170 C750,172 720,173 700,175 C650,178 600,182 550,188 C500,194 450,200 400,208 C350,216 310,224 270,232 Z" fill="#FDF0D8" opacity="0.7"/>
        <!-- Combination therapy band (starts Year 6) -->
        <path d="M450,148 C490,140 530,132 570,126 C610,121 650,118 700,115 C720,114 750,113 770,112 L770,138 C750,140 720,141 700,142 C650,145 600,146 550,150 C500,155 450,162 450,148 Z" fill="#FFE8E4" opacity="0.7"/>
        <!-- Main revenue curve -->
        <path d="M70,320 C100,318 140,310 180,290 C220,268 250,245 280,220 C320,190 360,168 410,152 C460,138 510,128 555,122 C600,117 645,112 700,108 C730,107 755,106 770,106" fill="none" stroke="#0D5580" stroke-width="2.5"/>
        <!-- LOE cliff -->
        <path d="M700,108 L720,108 L722,200 L780,260" fill="none" stroke="#E8503A" stroke-width="2.5" stroke-dasharray="6,3"/>
        <!-- Year markers (x-axis) -->
        <line x1="70" y1="320" x2="770" y2="320" stroke="#374151" stroke-width="1.2"/>
        <line x1="70" y1="30" x2="70" y2="320" stroke="#374151" stroke-width="1.2"/>
        <!-- Year tick marks every ~58px (0-12 years) -->
        <text x="70"  y="336" text-anchor="middle" font-size="9" fill="#374151">Y0</text>
        <text x="128" y="336" text-anchor="middle" font-size="9" fill="#374151">Y1</text>
        <text x="186" y="336" text-anchor="middle" font-size="9" fill="#374151">Y2</text>
        <text x="244" y="336" text-anchor="middle" font-size="9" fill="#374151">Y3</text>
        <text x="302" y="336" text-anchor="middle" font-size="9" fill="#374151">Y4</text>
        <text x="360" y="336" text-anchor="middle" font-size="9" fill="#374151">Y5</text>
        <text x="418" y="336" text-anchor="middle" font-size="9" fill="#374151">Y6</text>
        <text x="476" y="336" text-anchor="middle" font-size="9" fill="#374151">Y7</text>
        <text x="534" y="336" text-anchor="middle" font-size="9" fill="#374151">Y8</text>
        <text x="592" y="336" text-anchor="middle" font-size="9" fill="#374151">Y9</text>
        <text x="650" y="336" text-anchor="middle" font-size="9" fill="#374151">Y10</text>
        <text x="708" y="336" text-anchor="middle" font-size="9" fill="#374151">Y11</text>
        <text x="760" y="336" text-anchor="middle" font-size="9" fill="#374151">Y12+</text>
        <!-- Y-axis labels -->
        <text x="62" y="323" text-anchor="end" font-size="9" fill="#374151">$0</text>
        <text x="62" y="250" text-anchor="end" font-size="9" fill="#374151">$300M</text>
        <text x="62" y="180" text-anchor="end" font-size="9" fill="#374151">$600M</text>
        <text x="62" y="110" text-anchor="end" font-size="9" fill="#374151">$900M</text>
        <text x="62" y="50" text-anchor="end" font-size="9" fill="#374151">$1.2B</text>
        <!-- Horizontal grid lines -->
        <line x1="70" y1="250" x2="770" y2="250" stroke="#E2E8F0" stroke-width="0.7" stroke-dasharray="4,3"/>
        <line x1="70" y1="180" x2="770" y2="180" stroke="#E2E8F0" stroke-width="0.7" stroke-dasharray="4,3"/>
        <line x1="70" y1="110" x2="770" y2="110" stroke="#E2E8F0" stroke-width="0.7" stroke-dasharray="4,3"/>
        <!-- Indication expansion annotations -->
        <line x1="244" y1="200" x2="244" y2="160" stroke="#0D8B8B" stroke-width="1.5" stroke-dasharray="4,3" marker-end="url(#s3a)"/>
        <text x="250" y="155" font-size="8.5" fill="#0A6B6B" font-weight="600">Ind 2: Neoadjuvant</text>
        <text x="250" y="166" font-size="8" fill="#0A6B6B">early breast cancer</text>
        <line x1="418" y1="140" x2="418" y2="98" stroke="#C4851A" stroke-width="1.5" stroke-dasharray="4,3"/>
        <text x="424" y="93" font-size="8.5" fill="#9A6412" font-weight="600">Combination: +PI3Ki</text>
        <text x="424" y="104" font-size="8" fill="#9A6412">approved combination</text>
        <line x1="592" y1="120" x2="592" y2="80" stroke="#0D5580" stroke-width="1.5" stroke-dasharray="4,3"/>
        <text x="598" y="75" font-size="8.5" fill="#0A3D62" font-weight="600">New formulation</text>
        <text x="598" y="86" font-size="8" fill="#0A3D62">once-weekly oral</text>
        <!-- LOE annotation -->
        <text x="720" y="188" font-size="9" fill="#E8503A" font-weight="700">LOE / Patent</text>
        <text x="720" y="200" font-size="9" fill="#E8503A" font-weight="700">Cliff Year 12</text>
        <!-- Legend -->
        <rect x="70" y="352" width="700" height="30" rx="6" fill="white" stroke="#A8D8D8" stroke-width="1"/>
        <rect x="84" y="361" width="14" height="12" rx="2" fill="#D0EEEE"/>
        <text x="102" y="371" font-size="8.5" fill="#374151">Ind 1: Advanced HR+/HER2&#8722; (1L)</text>
        <rect x="265" y="361" width="14" height="12" rx="2" fill="#FDF0D8"/>
        <text x="283" y="371" font-size="8.5" fill="#374151">Ind 2: Neoadjuvant early BC</text>
        <rect x="436" y="361" width="14" height="12" rx="2" fill="#FFE8E4"/>
        <text x="454" y="371" font-size="8.5" fill="#374151">Combination therapy</text>
        <rect x="565" y="361" width="14" height="12" rx="2" fill="#FFF0E8"/>
        <text x="583" y="371" font-size="8.5" fill="#374151">New formulation</text>
        <rect x="672" y="361" width="14" height="12" rx="2" fill="#FFE8E4" stroke="#E8503A" stroke-width="1"/>
        <text x="690" y="371" font-size="8.5" fill="#E8503A">LOE decline</text>
      </svg>
    </div>
    <figcaption class="vis-cap">Meridian&#x27;s lifecycle strategy &#8212; three indication expansions and a new formulation extend peak revenue from $400M (Ind 1 alone) to $1.1B before patent expiry at Year 12</figcaption>
  </figure>

  <h2 id="ch13-launch-sequence">Launch Sequencing &amp; Market Selection</h2>

  <p>No pharmaceutical company launches everywhere at once. The regulatory timelines alone make simultaneous global launch impossible &#8212; FDA approval, EMA approval, and PMDA (Japan) approval follow different submission and review timelines, and Health Canada, TGA, and ANVISA add further lag. But even if timelines permitted it, commercial logic argues against simultaneous global launch: manufacturing is constrained at launch, medical affairs teams are stretched, and market access negotiations in high-complexity markets (NICE, HAS, G-BA) can take eighteen months after approval to complete.</p>

  <p>NovaCure&#x27;s launch sequencing for Meridian was driven by four factors: HTA complexity (countries where payer negotiations could delay commercial availability were deprioritised in Wave 1), pricing reference risk (countries that influence reference pricing for other markets &#8212; notably Germany and the UK &#8212; were handled carefully to avoid setting low anchors), commercial capability (territories where NovaCure had established oncology commercial infrastructure were prioritised), and patient need urgency (where there was significant unmet need and no meaningful generic CDK4/6 access).</p>

  <figure class="vis-embed" id="ch13-launch-svg" aria-label="Launch Wave Sequence">
    <div class="vis-label"><span class="vis-icon">&#9670;</span> Meridian Global Launch Sequencing &#8212; Three-Wave Market Entry Strategy</div>
    <div class="vis-inner">
      <svg viewBox="0 0 800 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-height:460px;">
        <rect width="800" height="420" fill="#EAF6F6"/>
        <!-- Header -->
        <rect x="0" y="0" width="800" height="36" rx="8" fill="#A8DADC"/>
        <rect x="0" y="24" width="800" height="12" fill="#A8DADC"/>
        <text x="400" y="22" text-anchor="middle" font-size="12" font-weight="700" fill="#0A3D62">Global Launch Sequencing &#8212; Month-by-Month Timeline (T=0: FDA Approval)</text>
        <!-- Timeline x-axis: months 0-36 across 660px (x=100 to x=760) -->
        <!-- Month markers every 6 months = 110px each -->
        <line x1="100" y1="58" x2="762" y2="58" stroke="#374151" stroke-width="1"/>
        <text x="100" y="52" text-anchor="middle" font-size="9" fill="#374151">M0</text>
        <text x="210" y="52" text-anchor="middle" font-size="9" fill="#374151">M6</text>
        <text x="320" y="52" text-anchor="middle" font-size="9" fill="#374151">M12</text>
        <text x="430" y="52" text-anchor="middle" font-size="9" fill="#374151">M18</text>
        <text x="540" y="52" text-anchor="middle" font-size="9" fill="#374151">M24</text>
        <text x="650" y="52" text-anchor="middle" font-size="9" fill="#374151">M30</text>
        <text x="762" y="52" text-anchor="middle" font-size="9" fill="#374151">M36</text>
        <!-- Tick marks -->
        <line x1="100" y1="55" x2="100" y2="62" stroke="#374151" stroke-width="1"/>
        <line x1="210" y1="55" x2="210" y2="62" stroke="#374151" stroke-width="1"/>
        <line x1="320" y1="55" x2="320" y2="62" stroke="#374151" stroke-width="1"/>
        <line x1="430" y1="55" x2="430" y2="62" stroke="#374151" stroke-width="1"/>
        <line x1="540" y1="55" x2="540" y2="62" stroke="#374151" stroke-width="1"/>
        <line x1="650" y1="55" x2="650" y2="62" stroke="#374151" stroke-width="1"/>
        <line x1="762" y1="55" x2="762" y2="62" stroke="#374151" stroke-width="1"/>

        <!-- WAVE 1 header -->
        <rect x="10" y="70" width="88" height="60" rx="6" fill="#A8DADC"/>
        <text x="54" y="96" text-anchor="middle" font-size="10" font-weight="700" fill="#0A3D62">WAVE 1</text>
        <text x="54" y="110" text-anchor="middle" font-size="8.5" fill="#0A3D62">Month 0&#8211;6</text>
        <text x="54" y="122" text-anchor="middle" font-size="8" fill="#0A5555">Core markets</text>
        <!-- Wave 1 country bars -->
        <rect x="100" y="74" width="220" height="22" rx="4" fill="#DCECf8" stroke="#B8D0E8" stroke-width="1"/>
        <text x="110" y="89" font-size="9.5" font-weight="600" fill="#0A3D62">&#127482;&#127480; USA &#8212; FDA Approval Day 0</text>
        <rect x="100" y="100" width="160" height="22" rx="4" fill="#DCECf8" stroke="#B8D0E8" stroke-width="1"/>
        <text x="110" y="115" font-size="9.5" fill="#0A3D62">&#127468;&#127463; Germany &#8212; AMNOG (M1)</text>
        <rect x="100" y="126" width="140" height="22" rx="4" fill="#DCECf8" stroke="#B8D0E8" stroke-width="1"/>
        <text x="110" y="141" font-size="9.5" fill="#0A3D62">&#127464;&#127462; Canada &#8212; Health Canada (M3)</text>

        <!-- WAVE 2 header -->
        <rect x="10" y="162" width="88" height="60" rx="6" fill="#F5D58A"/>
        <text x="54" y="188" text-anchor="middle" font-size="10" font-weight="700" fill="#0A3D62">WAVE 2</text>
        <text x="54" y="202" text-anchor="middle" font-size="8.5" fill="#0A3D62">Month 6&#8211;18</text>
        <text x="54" y="214" text-anchor="middle" font-size="8" fill="#9A6412">EU + Japan</text>
        <!-- Wave 2 country bars -->
        <rect x="210" y="166" width="220" height="22" rx="4" fill="#FDF0D8" stroke="#F5D58A" stroke-width="1"/>
        <text x="220" y="181" font-size="9.5" fill="#0A3D62">&#127482;&#127463; UK &#8212; NICE appraisal (M6&#8211;12)</text>
        <rect x="210" y="192" width="240" height="22" rx="4" fill="#FDF0D8" stroke="#F5D58A" stroke-width="1"/>
        <text x="220" y="207" font-size="9.5" fill="#0A3D62">&#127467;&#127479; France &#8212; HAS / ASMR (M8&#8211;14)</text>
        <rect x="210" y="218" width="200" height="22" rx="4" fill="#FDF0D8" stroke="#F5D58A" stroke-width="1"/>
        <text x="220" y="233" font-size="9.5" fill="#0A3D62">&#127471;&#127477; Japan &#8212; PMDA / NHI (M10&#8211;18)</text>

        <!-- WAVE 3 header -->
        <rect x="10" y="256" width="88" height="60" rx="6" fill="#FFBCAD"/>
        <text x="54" y="282" text-anchor="middle" font-size="10" font-weight="700" fill="#0A3D62">WAVE 3</text>
        <text x="54" y="296" text-anchor="middle" font-size="8.5" fill="#0A3D62">Month 18&#8211;36</text>
        <text x="54" y="308" text-anchor="middle" font-size="8" fill="#B83224">Expansion</text>
        <!-- Wave 3 bars -->
        <rect x="430" y="260" width="220" height="22" rx="4" fill="#FFE8E4" stroke="#FFBCAD" stroke-width="1"/>
        <text x="440" y="275" font-size="9.5" fill="#0A3D62">&#127470;&#127481; Italy / Spain &#8212; AIFA / AEMPS (M18)</text>
        <rect x="430" y="286" width="240" height="22" rx="4" fill="#FFE8E4" stroke="#FFBCAD" stroke-width="1"/>
        <text x="440" y="301" font-size="9.5" fill="#0A3D62">&#127462;&#127482; Australia &#8212; PBAC (M20)</text>
        <rect x="430" y="312" width="280" height="22" rx="4" fill="#FFE8E4" stroke="#FFBCAD" stroke-width="1"/>
        <text x="440" y="327" font-size="9.5" fill="#0A3D62">&#127463;&#127479; Brazil / ROW &#8212; ANVISA + distributors (M24+)</text>

        <!-- Revenue ramp curve overlay -->
        <path d="M100,340 C140,338 180,332 220,320 C260,306 300,288 350,272 C400,256 450,245 510,238 C570,232 630,228 760,225" fill="none" stroke="#0D5580" stroke-width="2.5" stroke-dasharray="6,3"/>
        <text x="765" y="222" font-size="8.5" fill="#0D5580">Revenue</text>
        <text x="765" y="232" font-size="8.5" fill="#0D5580">ramp</text>
        <!-- Axis label -->
        <text x="400" y="368" text-anchor="middle" font-size="9.5" font-weight="600" fill="#374151">Months from FDA Approval (T=0)</text>
        <!-- Note -->
        <rect x="10" y="378" width="780" height="32" rx="6" fill="white" stroke="#A8D8D8" stroke-width="1"/>
        <text x="20" y="393" font-size="8.5" fill="#374151">HTA timelines are ranges based on historical averages. Germany (AMNOG) allows immediate launch with free pricing in Year 1 &#8212; NovaCure&#x27;s pricing anchor market. NICE appraisal typically 12&#8211;18 months post-submission; HAS ASMR 6&#8211;9 months. Revenue ramp is illustrative projection.</text>
        <text x="20" y="406" font-size="8.5" fill="#64748B">Pricing reference risks: UK price feeds into Germany AMNOG renegotiation in Year 2. France price is referenced by Spain, Portugal, and several EM markets. Japan NHI price is independent.</text>
      </svg>
    </div>
    <figcaption class="vis-cap">Three-wave global launch sequence &#8212; Wave 1 establishes commercial precedent and pricing anchors; Wave 2 executes EU and Japan HTA; Wave 3 captures expansion markets</figcaption>
  </figure>

  <h2 id="ch13-competitive">Competitive Intelligence &amp; War-Gaming</h2>

  <p>Strategy built without a competitor response assumption is not strategy &#8212; it is a plan built in a vacuum. Every positioning decision, every pricing decision, every launch timing decision generates a response from competitors. Good strategy anticipates those responses and builds contingencies before they become emergencies.</p>

  <p>NovaCure ran a structured war-game six months before Meridian&#x27;s US launch. Four teams played the roles of NovaCure, Pfizer (Ibrance), Eli Lilly (Verzenio), and Novartis (Kisqali). Each team was given identical market data and tasked with presenting their three-year strategy to a panel of independent oncologists who judged which strategies they would most likely respond to in clinical practice. The exercise produced three insights that changed NovaCure&#x27;s launch plan: Pfizer would respond with a DTC campaign emphasising Ibrance&#x27;s long safety track record; Lilly would respond by accelerating their neoadjuvant early breast cancer filing (directly competing with Meridian&#x27;s planned Indication 2); and the oncologist panel ranked dosing convenience above efficacy delta when drugs were perceived as class-equivalent.</p>

  <p>That last insight reshaped the sales force messaging hierarchy entirely. The original message architecture led with PFS benefit. After the war-game, it led with dosing convenience and haematological safety &#8212; and the PFS data was repositioned as the proof point rather than the headline. The MLR team was not thrilled about revising six months of already-approved promotional materials, but the commercial team was adamant: the market research said convenience mattered most to the prescriber making a switch decision, and strategy had to follow the evidence.</p>

  <h2 id="ch13-stakeholder">Patient &amp; Stakeholder Strategy</h2>

  <p>The prescriber is not the only decision-maker in whether a patient receives Meridian. The payer decides whether it is covered. The hospital P&amp;T committee decides whether it is on the formulary. The patient advocacy organisation decides whether to recommend it to their community. The KOL decides whether to publish data supporting its use. And the patient herself decides whether to start, stay on, or discontinue treatment &#8212; influenced by side effect experience, copay burden, and the information her oncologist provides at each visit.</p>

  <p>Stakeholder strategy maps each of these decision-makers, identifies what they need to believe to act in a way that is favourable for patients, and assigns accountability for building those beliefs to specific functions. For Meridian:</p>

  <div class="crm-obj-grid" style="grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:14px;margin:24px 0;">
    <div class="crm-obj-card comm">
      <div class="crm-obj-name comm">Prescribing Oncologists</div>
      <div class="crm-obj-desc">Need to believe Meridian is clinically differentiated enough to justify a switch from their current CDK4/6 inhibitor. Key messages: tolerability profile, manageable dose adjustments, comparable or superior efficacy. Owner: Sales force (Veeva CRM) + MSL scientific exchange. Touchpoints: rep visits, congress symposia, peer publications.</div>
    </div>
    <div class="crm-obj-card med">
      <div class="crm-obj-name med">Payers &amp; P&amp;T Committees</div>
      <div class="crm-obj-desc">Need to believe Meridian delivers value proportional to price. Key evidence: ICER cost-effectiveness model, budget impact analysis, real-world adherence data showing tolerability reduces dose reductions and discontinuations (which generate hidden costs). Owner: Market Access. Touchpoints: dossier submissions, formulary presentations, outcomes-based contract proposals.</div>
    </div>
    <div class="crm-obj-card shared">
      <div class="crm-obj-name shared">Key Opinion Leaders (KOLs)</div>
      <div class="crm-obj-desc">Need to believe Meridian represents genuine scientific advancement worth discussing in publications and at congresses. Key engagement: MSL-led scientific discussions starting in Phase III, investigator-initiated study support, advisory board participation, early-access data sharing. Owner: Medical Affairs. Touchpoints: MSL visits, advisory boards, data publications in NEJM/JCO/Lancet Oncology.</div>
    </div>
    <div class="crm-obj-card comm">
      <div class="crm-obj-name comm">Patient Advocacy Organisations</div>
      <div class="crm-obj-desc">Need to believe Meridian improves quality of life meaningfully for the patients they represent. Key evidence: patient-reported outcomes (PRO) data from MERIDIAN-3, patient support programme design (co-pay assistance, nurse navigator, adherence support), plain-language disease information. Owner: Medical Affairs + Patient Affairs. Touchpoints: congress patient track, organisation-specific briefings, PAP programme announcements.</div>
    </div>
  </div>

  <h2 id="ch13-omnichannel">Omnichannel &amp; Digital Strategy</h2>

  <p>The era of pharmaceutical sales strategy as synonymous with rep call frequency ended sometime around 2018. Today, an oncologist&#x27;s decision to prescribe is shaped by a complex sequence of touchpoints: a journal article read on PubMed, a congress oral presentation, a rep visit that referenced that presentation, a Veeva CLM slide deck shown on an iPad, a follow-up approved email, a webinar hosted by a KOL, and &#8212; sometimes &#8212; a patient asking about a drug by name after reading a disease awareness article. The commercial strategy team&#x27;s job is to orchestrate all of these touchpoints into a coherent journey, not to manage them as separate line items in a marketing budget.</p>

  <p>For Meridian, the omnichannel strategy was built around three HCP segments identified through prescription analysis and digital engagement data: <strong>Champions</strong> (high-volume oncologists already familiar with CDK4/6 inhibitors, receptive to peer-to-peer scientific exchange &#8212; primarily MSL-led), <strong>Considerers</strong> (moderate prescribers who needed clinical trial data reinforcement &#8212; rep + digital content), and <strong>Emerging Prescribers</strong> (community oncologists new to CDK4/6 therapy &#8212; digital education, virtual nurse educator support, and patient support programme enrolment). Each segment had a different channel mix, a different message sequence, and a different frequency of human versus digital touchpoints.</p>

  <p>Veeva CRM&#x27;s Next Best Action engine was configured with Meridian-specific rules: a Champion who had not had an MSL scientific exchange in sixty days was flagged for MSL outreach. A Considerer who had opened three approved emails about the MERIDIAN-3 data but had not had a rep visit was flagged for priority call scheduling. An Emerging Prescriber who had not yet prescribed was triggered for a peer-to-peer education programme invitation. The CLM data &#8212; which slides each HCP engaged with, which key messages generated positive reactions &#8212; fed directly into the next call plan. Every interaction improved the model. The model improved every interaction.</p>

  <h2 id="ch13-ibp">The Integrated Brand Plan &#8212; Where Strategy Becomes Execution</h2>

  <p>Twelve months after that January meeting, Sarah Chen stood in the same conference room with a document: the Meridian Integrated Brand Plan, Year 1. It was 84 pages long. It covered brand positioning, the target patient profile, the value narrative, the competitive response strategy, the evidence generation plan, the medical affairs strategy, the commercial field plan, the market access dossier plan, the launch sequencing rationale, the omnichannel touchpoint model, the stakeholder engagement map, and the KPIs that each function would be held to. Every function head had reviewed it, challenged it, and signed off on it.</p>

  <p>The IBP is not a collection of individual functional plans stapled together. It is a single document derived from a single set of strategic choices, from which each function&#x27;s plan is derived. The test of a real IBP is simple: if you remove any one function&#x27;s section, the remaining sections should not make sense &#8212; because each function&#x27;s activities exist to support the same strategic objective, and they are designed to be interdependent. Medical Affairs generates the evidence that Market Access uses in payer dossiers, which creates the access that the commercial team&#x27;s field plan is premised upon, which targets the HCP segments that the MSL engagement plan supports. Pull any thread and the whole fabric loosens.</p>

  <figure class="vis-embed" id="ch13-ibp-svg" aria-label="Integrated Brand Plan Architecture">
    <div class="vis-label"><span class="vis-icon">&#9670;</span> Integrated Brand Plan &#8212; Cross-Functional Alignment Architecture</div>
    <div class="vis-inner">
      <svg viewBox="0 0 800 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-height:460px;">
        <defs>
          <marker id="s4a" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto">
            <path d="M0,0 L0,6 L7,3 z" fill="#64B5B5"/>
          </marker>
          <marker id="s4b" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto">
            <path d="M0,0 L0,6 L7,3 z" fill="#0D8B8B"/>
          </marker>
        </defs>
        <rect width="800" height="420" fill="#EAF6F6"/>
        <!-- LEFT COLUMN: INPUTS -->
        <text x="100" y="30" text-anchor="middle" font-size="11" font-weight="700" fill="#0A3D62">STRATEGIC INPUTS</text>
        <!-- Input 1: Scientific Evidence -->
        <rect x="18" y="44" width="164" height="80" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="18" y="44" width="164" height="24" rx="8" fill="#A8DADC"/>
        <rect x="18" y="56" width="164" height="12" fill="#A8DADC"/>
        <text x="100" y="60" text-anchor="middle" font-size="10" font-weight="700" fill="#0A3D62">Scientific Evidence</text>
        <text x="30" y="80" font-size="8.5" fill="#374151">&#9658; Phase III clinical data</text>
        <text x="30" y="92" font-size="8.5" fill="#374151">&#9658; RWE &amp; outcomes data</text>
        <text x="30" y="104" font-size="8.5" fill="#374151">&#9658; HEOR cost models</text>
        <!-- Input 2: Market Research -->
        <rect x="18" y="136" width="164" height="80" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="18" y="136" width="164" height="24" rx="8" fill="#F5D58A"/>
        <rect x="18" y="148" width="164" height="12" fill="#F5D58A"/>
        <text x="100" y="152" text-anchor="middle" font-size="10" font-weight="700" fill="#0A3D62">Market Intelligence</text>
        <text x="30" y="172" font-size="8.5" fill="#374151">&#9658; HCP perception research</text>
        <text x="30" y="184" font-size="8.5" fill="#374151">&#9658; Payer/HTA landscape</text>
        <text x="30" y="196" font-size="8.5" fill="#374151">&#9658; Competitive analysis</text>
        <!-- Input 3: Patient Insights -->
        <rect x="18" y="228" width="164" height="80" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="18" y="228" width="164" height="24" rx="8" fill="#BBF7D0"/>
        <rect x="18" y="240" width="164" height="12" fill="#BBF7D0"/>
        <text x="100" y="244" text-anchor="middle" font-size="10" font-weight="700" fill="#0A3D62">Patient Insights</text>
        <text x="30" y="264" font-size="8.5" fill="#374151">&#9658; Journey &amp; decision points</text>
        <text x="30" y="276" font-size="8.5" fill="#374151">&#9658; PRO data from trials</text>
        <text x="30" y="288" font-size="8.5" fill="#374151">&#9658; Advocacy org feedback</text>
        <!-- Arrows LEFT to CENTER -->
        <line x1="183" y1="84" x2="280" y2="150" stroke="#64B5B5" stroke-width="1.8" marker-end="url(#s4a)"/>
        <line x1="183" y1="176" x2="280" y2="190" stroke="#64B5B5" stroke-width="1.8" marker-end="url(#s4a)"/>
        <line x1="183" y1="268" x2="280" y2="230" stroke="#64B5B5" stroke-width="1.8" marker-end="url(#s4a)"/>
        <!-- CENTER: BRAND PLAN -->
        <rect x="280" y="80" width="240" height="240" rx="12" fill="white" stroke="#0D8B8B" stroke-width="2.5"/>
        <rect x="280" y="80" width="240" height="38" rx="12" fill="#A8DADC"/>
        <rect x="280" y="106" width="240" height="12" fill="#A8DADC"/>
        <text x="400" y="100" text-anchor="middle" font-size="11" font-weight="700" fill="#0A3D62">INTEGRATED BRAND PLAN</text>
        <text x="400" y="114" text-anchor="middle" font-size="9" fill="#0A5555">The single source of cross-functional truth</text>
        <!-- IBP sub-elements -->
        <text x="296" y="136" font-size="9" font-weight="700" fill="#0A3D62">Brand Positioning Statement</text>
        <text x="296" y="148" font-size="8.5" fill="#374151">Who we are for &amp; why we win</text>
        <line x1="296" y1="155" x2="508" y2="155" stroke="#E2E8F0" stroke-width="0.8"/>
        <text x="296" y="168" font-size="9" font-weight="700" fill="#0A3D62">Target Patient Profile</text>
        <text x="296" y="180" font-size="8.5" fill="#374151">Demographic, clinical, behavioural</text>
        <line x1="296" y1="187" x2="508" y2="187" stroke="#E2E8F0" stroke-width="0.8"/>
        <text x="296" y="200" font-size="9" font-weight="700" fill="#0A3D62">Value Narrative</text>
        <text x="296" y="212" font-size="8.5" fill="#374151">Clinical + economic + QoL evidence</text>
        <line x1="296" y1="219" x2="508" y2="219" stroke="#E2E8F0" stroke-width="0.8"/>
        <text x="296" y="232" font-size="9" font-weight="700" fill="#0A3D62">Competitive Response Strategy</text>
        <text x="296" y="244" font-size="8.5" fill="#374151">Differentiation vs each competitor</text>
        <line x1="296" y1="251" x2="508" y2="251" stroke="#E2E8F0" stroke-width="0.8"/>
        <text x="296" y="264" font-size="9" font-weight="700" fill="#0A3D62">Function KPIs &amp; Milestones</text>
        <text x="296" y="276" font-size="8.5" fill="#374151">Shared metrics across all functions</text>
        <line x1="296" y1="283" x2="508" y2="283" stroke="#E2E8F0" stroke-width="0.8"/>
        <text x="296" y="296" font-size="9" font-weight="700" fill="#0A3D62">Annual Operating Budget</text>
        <text x="296" y="308" font-size="8.5" fill="#374151">Allocated by function &amp; quarter</text>
        <!-- Arrows CENTER to RIGHT -->
        <line x1="521" y1="150" x2="612" y2="110" stroke="#0D8B8B" stroke-width="1.8" marker-end="url(#s4b)"/>
        <line x1="521" y1="185" x2="612" y2="185" stroke="#0D8B8B" stroke-width="1.8" marker-end="url(#s4b)"/>
        <line x1="521" y1="220" x2="612" y2="260" stroke="#0D8B8B" stroke-width="1.8" marker-end="url(#s4b)"/>
        <line x1="521" y1="250" x2="612" y2="330" stroke="#0D8B8B" stroke-width="1.8" marker-end="url(#s4b)"/>
        <!-- RIGHT COLUMN: FUNCTION PLANS -->
        <text x="690" y="30" text-anchor="middle" font-size="11" font-weight="700" fill="#0A3D62">FUNCTION PLANS</text>
        <!-- Commercial -->
        <rect x="616" y="44" width="168" height="56" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="616" y="44" width="168" height="20" rx="8" fill="#DCECf8"/>
        <rect x="616" y="52" width="168" height="12" fill="#DCECf8"/>
        <text x="700" y="58" text-anchor="middle" font-size="9.5" font-weight="700" fill="#0A3D62">Commercial Field Plan</text>
        <text x="628" y="74" font-size="8.5" fill="#374151">Target HCPs, call plans, CLM</text>
        <text x="628" y="86" font-size="8.5" fill="#374151">content, DTC, SFE metrics</text>
        <!-- Market Access -->
        <rect x="616" y="112" width="168" height="56" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="616" y="112" width="168" height="20" rx="8" fill="#FDF0D8"/>
        <rect x="616" y="120" width="168" height="12" fill="#FDF0D8"/>
        <text x="700" y="126" text-anchor="middle" font-size="9.5" font-weight="700" fill="#0A3D62">Market Access Strategy</text>
        <text x="628" y="142" font-size="8.5" fill="#374151">HTA dossiers, formulary</text>
        <text x="628" y="154" font-size="8.5" fill="#374151">contracting, rebate model</text>
        <!-- Medical Affairs -->
        <rect x="616" y="180" width="168" height="56" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="616" y="180" width="168" height="20" rx="8" fill="#D6F0F0"/>
        <rect x="616" y="188" width="168" height="12" fill="#D6F0F0"/>
        <text x="700" y="194" text-anchor="middle" font-size="9.5" font-weight="700" fill="#0A3D62">Medical Affairs MSL Plan</text>
        <text x="628" y="210" font-size="8.5" fill="#374151">KOL engagement, IIS,</text>
        <text x="628" y="222" font-size="8.5" fill="#374151">publications, evidence gaps</text>
        <!-- Regulatory -->
        <rect x="616" y="248" width="168" height="56" rx="8" fill="white" stroke="#A8D8D8" stroke-width="1.5"/>
        <rect x="616" y="248" width="168" height="20" rx="8" fill="#FFE8E4"/>
        <rect x="616" y="256" width="168" height="12" fill="#FFE8E4"/>
        <text x="700" y="262" text-anchor="middle" font-size="9.5" font-weight="700" fill="#0A3D62">Regulatory Submissions</text>
        <text x="628" y="278" font-size="8.5" fill="#374151">Ind 2 trial protocols,</text>
        <text x="628" y="290" font-size="8.5" fill="#374151">variation filings, label updates</text>
        <!-- Feedback loop arrow at bottom -->
        <path d="M690,360 Q690,390 400,395 Q110,390 110,360" fill="none" stroke="#80C8C8" stroke-width="1.5" stroke-dasharray="5,4" marker-end="url(#s4a)"/>
        <text x="400" y="410" text-anchor="middle" font-size="9" fill="#0A6B6B">Execution results feed back into DISCOVER &#8212; the cycle continues every 12 months</text>
      </svg>
    </div>
    <figcaption class="vis-cap">The Integrated Brand Plan &#8212; three inputs flow into a shared strategic centre; four function plans flow out. Remove any element and the others stop making sense.</figcaption>
  </figure>

  <p>By Month 18 post-launch, Meridian had reached $412M in global net revenue. Palbociclib prescriptions in the target HCP segment (patients with prior toxicity concerns) had declined 14% in accounts where NovaCure reps had three or more calls with supporting CLM data. NICE had approved Meridian with an unrestricted recommendation &#8212; the first CDK4/6 inhibitor to achieve that outcome at first submission. The Phase III neoadjuvant trial had enrolled 40% of its target population. And Sarah Chen was back in the conference room, asking the next question: <em>"Now that we know who Meridian is for and that they choose it &#8212; what is our plan for the 67% of eligible patients who aren&#x27;t receiving it yet?"</em></p>

  <p>Strategy, as Sarah had always said, is not a destination. It is the question you never stop asking.</p>
"""

HTML = f'''<!DOCTYPE html>
<!-- ============================================================
     Pharma R&D, Commercial, Medical Affairs & Market Access — The Complete Visual Guide
     Author  : Deepak Kumar — Pharma & MedTech Consultant
     Version : May 2026 Edition
     URL     : https://veevasystem.github.io/Pharma_Commercial_Medical_Affairs/
     Copyright © 2026 Deepak Kumar. All rights reserved.
     This work is published for educational and professional reference.
...
<meta name="copyright" content="Copyright © 2026 Deepak Kumar. All rights reserved.">
<meta name="description" content="Pharma R&amp;D, Commercial, Medical Affairs &amp; Market Access — The Complete Visual Guide by Deepak Kumar. Covers drug discovery, R&amp;D regulatory affairs, clinical development, FDA regulations, Veeva systems, commercial operations, medical affairs, market access, Model N, and Anaplan.">
<meta property="og:title" content="Pharma R&amp;D, Commercial, Medical Affairs &amp; Market Access — The Complete Visual Guide">
<meta property="og:description" content="A complete, story-driven reference covering every function, every role, every platform, and every regulation across pharma R&amp;D, commercial, medical affairs, and market access.">
<meta property="og:url" content="https://veevasystem.github.io/Pharma_Commercial_Medical_Affairs/">
<meta property="og:type" content="website">
<title>Pharma R&amp;D, Commercial, Medical Affairs &amp; Market Access — The Complete Visual Guide · Deepak Kumar</title>
...
.crm-obj-card:hover {{
  box-shadow: 0 0 0 2px #0D8B8B, 0 4px 18px rgba(13,139,139,.13);
  border-color: #0D8B8B;
}}
.crm-card-expand-badge {{
  position: absolute; top: 8px; right: 10px;
  font-family: var(--ui-font); font-size: 9px; font-weight: 700;
  letter-spacing: .7px; text-transform: uppercase;
  color: #0D8B8B; opacity: 0;
  transition: opacity .18s;
  pointer-events: none;
  user-select: none;
}}
.crm-obj-card:hover .crm-card-expand-badge {{ opacity: 1; }}
.crm-obj-card.comm {{
  border-left: 4px solid #0D5580;
  border-top: 1px solid #B8D8EE; border-right: 1px solid #B8D8EE; border-bottom: 1px solid #B8D8EE;
}}
.crm-obj-card.med {{
  border-left: 4px solid #0D8B8B;
  border-top: 1px solid #A8D8D8; border-right: 1px solid #A8D8D8; border-bottom: 1px solid #A8D8D8;
}}
.crm-obj-card.shared {{
  border-left: 4px solid #C4851A;
  border-top: 1px solid #F5D58A; border-right: 1px solid #F5D58A; border-bottom: 1px solid #F5D58A;
}}
.crm-section-label {{
  font-family: var(--ui-font); font-size: 9px; font-weight: 700;
...
.crm-section-label.comm {{ color: #0D5580; border-color: #0A3D62; }}
.crm-section-label.med  {{ color: #0D8B8B; border-color: #0A6060; }}
.crm-obj-name {{ font-size: 12.5px; font-weight: 700; margin-bottom: 3px; color: #0A3D62; }}
.crm-obj-name.comm   {{ color: #0A3D62; }}
.crm-obj-name.med    {{ color: #0A6B6B; }}
.crm-obj-name.shared {{ color: #9A6412; }}
.crm-obj-api  {{ font-size: 9px; font-family: monospace; color: #0D5580; margin-bottom: 8px; letter-spacing: .3px; }}
.crm-obj-api.med {{ color: #0D8B8B; }}
.crm-obj-desc {{ font-size: 11.5px; color: #374151; line-height: 1.65; }}
.crm-obj-fields {{ margin-top: 8px; }}
.crm-field-pill {{
  display: inline-block; background: #E8F8F8; border: 1px solid #80D5D5;
  border-radius: 3px; padding: 2px 7px; font-size: 9.5px;
  color: #0A5555; margin: 2px 3px 2px 0; font-family: monospace;
}}
...
#reader-controls.collapsed #ctrl-inner {{
  max-width: 0; opacity: 0; pointer-events: none;
}}
#ctrl-toggle {{
  font-size: 16px !important; padding: 2px 6px !important;
  color: var(--ink-2) !important; line-height: 1;
  transition: transform .25s ease;
  flex-shrink: 0;
}}
#reader-controls.collapsed #ctrl-toggle {{
...
.dict-modal-overlay.open {{ display: flex; }}
.dict-modal-panel {{
...
.dict-modal-input:focus {{ border-color: #7EC8C8; }}
.dict-modal-go {{
...
.dict-modal-go:hover {{ background: rgba(126,200,200,.22); }}
.dict-modal-close {{
...
.dict-modal-close:hover {{ background: #c0392b; color: #fff; border-color: #c0392b; }}
.dict-engines {{
...
.dce-btn {{
  ...
  border: 1px solid var(--border); background: var(--bg-alt);
  color: var(--ink); font-size: 13px; font-family: var(--ui-font);
  cursor: pointer; text-align: left;
  transition: border-color .15s, background .15s;
}}
.dce-btn:hover {{ border-color: #7EC8C8; background: rgba(126,200,200,.12); }}
.dict-note {{
  padding: 0 20px 14px; font-size: 11.5px; color: #888;
}}
@media print {{
  .dict-modal-overlay, .dict-wrap {{ display: none !important; }}
}}
...
.toc-copyright {{
  ...
  letter-spacing: .8px; margin-top: 6px; opacity: .6;
}}
...
.vis-embed {{
  ...
  border: 1px solid #A8D8D8;
  box-shadow: 0 4px 20px rgba(10,61,98,.10);
}}
.vis-label {{
  background: #0A3D62; color: #A8DADC;
  font-family: var(--ui-font); font-size: 10.5px; font-weight: 700;
  letter-spacing: 1px; padding: 11px 22px;
  text-transform: uppercase; display: flex; align-items: center; gap: 10px;
}}
.vis-icon {{ font-size: 12px; color: #64B5B5; }}
.vis-inner {{
  background: #EAF6F6; overflow-x: auto; padding: 24px;
}}
.vis-cap {{
  background: #D0EEEE; color: #0A3D62;
  font-family: var(--ui-font); font-size: 10px;
  text-align: center; padding: 8px; font-style: italic;
  border-top: 1px solid #80C8C8;
}}
.vis-inner .sec {{
...
.vis-inner .dbox {{
  background: #EAF6F6; border-radius: 8px;
  border: 1px solid #A8D8D8; padding: 16px; overflow-x: auto;
}}
...
@media print {{
  ...
  @page :left  {{ @top-left   {{ content: "Pharma R\0026D, Commercial, Medical Affairs \0026 Market Access"; font-size: 8pt; }} }}
...
<div id="reader-controls" role="toolbar" aria-label="Reading controls">
  <div id="ctrl-inner">
    ...
    <div class="ctrl-sep"></div>
    <div class="dict-wrap">
      <input id="dictInput" class="dict-input" type="search"
             placeholder="📖 Define…" aria-label="Dictionary lookup"
             onkeydown="if(event.key==='Enter')openDict(this.value)" />
      <button class="dict-btn" onclick="openDict(document.getElementById('dictInput').value)" title="Look up definition">→</button>
    </div>
  </div>
  <button id="ctrl-toggle" onclick="toggleControls()" title="Collapse / expand toolbar">‹</button>
</div>
...
<!-- ══════════════ DICTIONARY MODAL ══════════════ -->
<div id="dictModal" class="dict-modal-overlay" role="dialog" aria-modal="true" aria-label="Dictionary">
  <div class="dict-modal-panel">
    <div class="dict-modal-bar">
      <span class="dict-modal-title">📖 Dictionary</span>
      <input id="dictModalInput" class="dict-modal-input" type="search"
             placeholder="Type a word and press Enter or choose a dictionary…"
             onkeydown="if(event.key==='Enter')launchDict('mw',this.value)" />
      <button class="dict-modal-go" onclick="launchDict('mw',document.getElementById('dictModalInput').value)" title="Look up in Merriam-Webster">→</button>
      <button class="dict-modal-close" onclick="closeDict()" title="Close (Esc)">✕</button>
    </div>
    <div class="dict-engines">
      <button class="dce-btn dce-mw"        onclick="launchDict('mw',document.getElementById('dictModalInput').value)">📘 Merriam-Webster</button>
      <button class="dce-btn dce-cambridge"  onclick="launchDict('cambridge',document.getElementById('dictModalInput').value)">🎓 Cambridge</button>
      <button class="dce-btn dce-oxford"     onclick="launchDict('oxford',document.getElementById('dictModalInput').value)">📚 Oxford</button>
      <button class="dce-btn dce-lexico"     onclick="launchDict('lexico',document.getElementById('dictModalInput').value)">🌐 Collins</button>
      <button class="dce-btn dce-thesaurus"  onclick="launchDict('thesaurus',document.getElementById('dictModalInput').value)">🔀 Thesaurus</button>
    </div>
    <div class="dict-note">
      Opens in a popup window. Type a word above and press Enter, or click a dictionary.
    </div>
  </div>
</div>

<!-- ══════════════ FLASHCARD EXPAND MODAL ══════════════ -->
<div id="cardModal" role="dialog" aria-modal="true" aria-label="Flashcard detail">
  <div id="cardModal-panel">
    <div id="cardModal-topbar">
      <div id="cardModal-icon"></div>
      <div id="cardModal-titles">
        <div id="cardModal-name"></div>
        <div id="cardModal-api"></div>
      </div>
      <button id="cardModal-close" onclick="closeCard()" title="Close (Esc)">✕</button>
    </div>
    <div id="cardModal-body"></div>
  </div>
</div>
...
<div class="cover" role="banner">
  <div class="cover-badge">Volume 1 · The Complete Visual Reference · 2026</div>
  <div class="cover-ornament"></div>
  <h1>Pharma <em>R&amp;D,</em> Commercial, Medical Affairs <em>&amp;</em> Market Access</h1>
  <p class="subtitle">A complete, story-driven guide with visual process maps — spanning drug discovery, R&D regulatory affairs, clinical development, commercial operations, medical affairs, and market access strategy — covering every function, every role, every platform, and every regulation from laboratory to patient.</p>
  ...
  <p class="cover-copyright">&copy; 2026 Deepak Kumar &nbsp;·&nbsp; All rights reserved &nbsp;·&nbsp; <a href="https://veevasystem.github.io/Pharma_Commercial_Medical_Affairs/" style="color:#7EC8C8;text-decoration:none;">veevasystem.github.io</a></p>
  <div class="cover-pills">
    ...
    <span class="cover-pill">Strategy</span>
  </div>
  <div class="cover-meta">
    14 Chapters · Visual SVG Process Maps · Interactive Glossary · Hover Tooltips<br>
    R&amp;D Regulatory · eTMF · Veeva Vault RIM · Clinical Operations · Market Access<br>
    Commercial Affairs · Medical Affairs · Model N · Anaplan · Veeva Platform Reference<br>
    FDA &amp; ICH Regulatory Frameworks · GxP · 21 CFR · MDRP · 340B · IRA 2022<br>
...
<nav class="toc" id="toc" aria-label="Table of contents">
  ...
  <a href="#ch2-rd-regulatory"  class="sub">R&amp;D Regulatory</a>
  <a href="#ch2-reg-strategy"   class="sub" style="padding-left:28px;">↳ Regulatory Strategy</a>
  <a href="#ch2-reg-clinical-ops" class="sub" style="padding-left:28px;">↳ Regulatory Operations</a>
  <a href="#ch2-post-approval"  class="sub" style="padding-left:28px;">↳ Post-Approval</a>
  <a href="#ch2-etmf"           class="sub" style="padding-left:28px;">↳ Veeva eTMF</a>
  <a href="#ch2-veeva-rim"      class="sub" style="padding-left:28px;">↳ Veeva RIM</a>
  <a href="#ch2-etmf-rim-flow"  class="sub" style="padding-left:28px;">↳ eTMF ↔ RIM Flow</a>
  ...
  <div class="toc-section">Part IV — Market Access</div>
  <a href="#ch-ma" class="ch">Ch 5 · Market Access</a>
  <a href="#ma-payer-landscape" class="sub">Payer Landscape</a>
  <a href="#ma-pricing"         class="sub">Pricing &amp; GTN</a>
  <a href="#ma-heor"            class="sub">HEOR &amp; Value</a>
  <a href="#ma-patient-access"  class="sub">Patient Access</a>
  <a href="#ma-model-n"         class="sub">Model N</a>
  <a href="#ma-anaplan"         class="sub">Anaplan</a>

  <div class="toc-section">Part V — Integration</div>
  <a href="#ch6" class="ch">Ch 6 · The Firewall</a>
  <a href="#ch7" class="ch">Ch 7 · R&amp;D Bridge</a>
  <a href="#ch8" class="ch">Ch 8 · The Launch!</a>
  ...
  <div class="toc-section">Part VI — People &amp; Rules</div>
  <a href="#ch9"    class="ch">Ch 9 · The People</a>
  <a href="#ch10"    class="ch">Ch 10 · The Rules</a>
  <a href="#ch11"   class="ch">Ch 11 · Putting It Together</a>

  <div class="toc-section">Part VII — Systems</div>
  <a href="#ch12"         class="ch">Ch 12 · Veeva Systems</a>
  ...
  <div class="toc-section">Part VIII &#8212; Vault CRM</div>
  <a href="#ch-vault-crm"              class="ch">Ch 13 · Vault CRM</a>
  <a href="#vcrm-why-migrate"          class="sub">Why Migrate?</a>
  <a href="#vcrm-architecture"         class="sub">Platform Architecture</a>
  <a href="#vcrm-modules"              class="sub">Modules &amp; Objects</a>
  <a href="#vcrm-architecture-detail"  class="sub">Object Architecture</a>
  <a href="#vcrm-commercial"           class="sub">Commercial Workflow</a>
  <a href="#vcrm-msl"                  class="sub">MSL Workflow</a>
  <a href="#vcrm-sample"               class="sub">Sample Management</a>
  <a href="#vcrm-territory"            class="sub">Territory (Vault Align)</a>
  <a href="#vcrm-analytics"            class="sub">Analytics &amp; SFE</a>
  <a href="#vcrm-admin"                class="sub">Admin Setup</a>
  <a href="#vcrm-user-mgmt"            class="sub">User Management</a>
  <a href="#vcrm-permissions"          class="sub">Permission Sets</a>
  <a href="#vcrm-promomats"            class="sub">PromoMats Integration</a>
  <a href="#vcrm-medcomm"              class="sub">MedComm Integration</a>
  <a href="#vcrm-network"              class="sub">Network Integration</a>
  <a href="#vcrm-migration"            class="sub">Migration Roadmap</a>

  <div class="toc-section">Part IX &#8212; Strategy</div>
  <a href="#ch14"                  class="ch">Ch 14 · Strategy</a>
  <a href="#ch13-framework"        class="sub">Strategy Framework</a>
  <a href="#ch13-positioning"      class="sub">Brand Positioning</a>
  <a href="#ch13-portfolio"        class="sub">Portfolio Strategy</a>
  <a href="#ch13-lifecycle"        class="sub">Lifecycle Management</a>
  <a href="#ch13-launch-sequence"  class="sub">Launch Sequencing</a>
  <a href="#ch13-competitive"      class="sub">Competitive Intel</a>
  <a href="#ch13-stakeholder"      class="sub">Stakeholder Strategy</a>
  <a href="#ch13-omnichannel"      class="sub">Omnichannel</a>
  <a href="#ch13-ibp"              class="sub">Integrated Brand Plan</a>
...
<div class="ch-divider" style="background:linear-gradient(90deg,#0a3a1a,#1B6B3A,#0a3a1a);"></div>
{CH_MA}
{nav_ch_ma}
...
<div class="chapter" id="ch12">
  <div class="ch-running">Chapter Twelve · Part VI — Systems</div>
  <div class="ch-decorator">
    <div class="ch-big-num">12</div>
    <div class="ch-heading-block">
      <div class="ch-label">
        <span class="ch-pill" style="background:#E05A00;">Ch 12</span>
        <span style="color:#E05A00;">Chapter Twelve</span>
      </div>
  ...
  <figure class="vis-embed" aria-label="Veeva CRM Object Architecture">
    ...
    <div class="vis-inner" style="padding:24px 20px;">
      <svg viewBox="0 0 960 510" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:700px;display:block;">
        ...
        <rect width="960" height="510" fill="#F8FAFC"/>
        <!-- Legend -->
        <rect x="20" y="12" width="10" height="10" rx="2" fill="#1A1030" stroke="#4A2080" stroke-width="1.5"/>
        <text x="34" y="21" fill="#4A5568" font-size="9.5">Foundation</text>
        <rect x="110" y="12" width="10" height="10" rx="2" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="124" y="21" fill="#4A5568" font-size="9.5">Commercial</text>
        <rect x="210" y="12" width="10" height="10" rx="2" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="224" y="21" fill="#4A5568" font-size="9.5">Medical Affairs</text>
        ...
        <text x="113" y="126" text-anchor="middle" fill="#4A5568" font-size="9">NPI · Specialty · Target Status · Segment</text>
        <text x="113" y="139" text-anchor="middle" fill="#4A5568" font-size="9">Territory · Decile · Last Call Date</text>
        <!-- Contact -->
        ...
        <text x="328" y="126" text-anchor="middle" fill="#4A5568" font-size="9">License # · DEA · Address · Email</text>
        <text x="328" y="139" text-anchor="middle" fill="#4A5568" font-size="9">Consent Status · Opt-out Flags</text>
        <!-- Territory -->
        <rect x="438" y="75" width="200" height="72" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="538" y="96" text-anchor="middle" fill="#0B6B6B" font-size="12" font-weight="700">Territory2</text>
        <text x="538" y="111" text-anchor="middle" fill="#3A6090" font-size="8.5" font-family="monospace">Territory2 (Salesforce)</text>
        <text x="538" y="126" text-anchor="middle" fill="#4A5568" font-size="9">Geo / Brick / Zip alignment</text>
        <text x="538" y="139" text-anchor="middle" fill="#4A5568" font-size="9">Rep assignment · Rollup rules</text>
        <!-- Veeva Network -->
        ...
        <text x="798" y="126" text-anchor="middle" fill="#4A5568" font-size="9">NPI validation · OIG exclusion check</text>
        <text x="798" y="139" text-anchor="middle" fill="#4A5568" font-size="9">Data Change Request (DCR) workflow</text>

        <!-- ── ROW 2: PLANNING ── -->
        <text x="8" y="172" fill="#4A5568" font-size="8" font-weight="700" letter-spacing="1.5">PLANNING</text>
        <!-- Cycle Plan -->
        <rect x="8" y="179" width="200" height="72" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="108" y="200" text-anchor="middle" fill="#0B6B6B" font-size="12" font-weight="700">Cycle Plan</text>
        <text x="108" y="215" text-anchor="middle" fill="#3A6090" font-size="8.5" font-family="monospace">Cycle_Plan_vod__c</text>
        <text x="108" y="230" text-anchor="middle" fill="#4A5568" font-size="9">HCP target list · Call freq. goal</text>
        <text x="108" y="243" text-anchor="middle" fill="#4A5568" font-size="9">Segment priority · Window dates</text>
        <!-- CLM Presentation -->
        <rect x="218" y="179" width="210" height="72" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="323" y="200" text-anchor="middle" fill="#0B6B6B" font-size="12" font-weight="700">CLM Presentation</text>
        <text x="323" y="215" text-anchor="middle" fill="#3A6090" font-size="8.5" font-family="monospace">Clm_Presentation_vod__c</text>
        <text x="323" y="230" text-anchor="middle" fill="#4A5568" font-size="9">iPad visual aid · Slide sequence</text>
        <text x="323" y="243" text-anchor="middle" fill="#4A5568" font-size="9">From Vault PromoMats (MLR-approved)</text>
        <!-- Call Objective (planning) -->
        <rect x="438" y="179" width="200" height="72" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="538" y="200" text-anchor="middle" fill="#0B6B6B" font-size="12" font-weight="700">Call Objective</text>
        <text x="538" y="215" text-anchor="middle" fill="#3A6090" font-size="8.5" font-family="monospace">Call_Objective_vod__c</text>
        <text x="538" y="230" text-anchor="middle" fill="#4A5568" font-size="9">Pre-call goal · Next Best Action</text>
        <text x="538" y="243" text-anchor="middle" fill="#4A5568" font-size="9">AI-suggested from analytics</text>
        <!-- Medical Event -->
        <rect x="648" y="179" width="300" height="72" rx="6" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="798" y="200" text-anchor="middle" fill="#0B6060" font-size="12" font-weight="700">Medical Event</text>
        <text x="798" y="215" text-anchor="middle" fill="#1A5050" font-size="8.5" font-family="monospace">Medical_Event_vod__c</text>
        <text x="798" y="230" text-anchor="middle" fill="#4A5568" font-size="9">Congress · Advisory Board · Symposium</text>
        <text x="798" y="243" text-anchor="middle" fill="#4A5568" font-size="9">FMV caps · TOV pre-approval</text>

        <!-- ── ROW 3: ACTIVITY ── -->
        <text x="8" y="276" fill="#4A5568" font-size="8" font-weight="700" letter-spacing="1.5">FIELD ACTIVITY</text>
        <!-- Call Report -->
        <rect x="8" y="283" width="200" height="72" rx="6" fill="#EBF0F8" stroke="#4A7ABF" stroke-width="2"/>
        <text x="108" y="304" text-anchor="middle" fill="#0B6B6B" font-size="12" font-weight="700">Call Report</text>
        <text x="108" y="319" text-anchor="middle" fill="#3A6090" font-size="8.5" font-family="monospace">EM_Call_vod__c</text>
        <text x="108" y="334" text-anchor="middle" fill="#4A5568" font-size="9">Date · Channel · Duration · Status</text>
        <text x="108" y="347" text-anchor="middle" fill="#4A5568" font-size="9">Primary commercial activity record</text>
        <!-- Approved Email -->
        <rect x="218" y="283" width="210" height="72" rx="6" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="323" y="304" text-anchor="middle" fill="#0B6B6B" font-size="12" font-weight="700">Approved Email</text>
        <text x="323" y="319" text-anchor="middle" fill="#3A6090" font-size="8.5" font-family="monospace">Sent_Email_vod__c</text>
        <text x="323" y="334" text-anchor="middle" fill="#4A5568" font-size="9">MLR template · Open/Click rate</text>
        <text x="323" y="347" text-anchor="middle" fill="#4A5568" font-size="9">Consent-gated · Cadence-limited</text>
        <!-- Medical Inquiry -->
        <rect x="438" y="283" width="200" height="72" rx="6" fill="#E0F7F7" stroke="#2A9A9A" stroke-width="2"/>
        <text x="538" y="304" text-anchor="middle" fill="#0B6060" font-size="12" font-weight="700">Medical Inquiry</text>
        <text x="538" y="319" text-anchor="middle" fill="#1A5050" font-size="8.5" font-family="monospace">Medical_Inquiry_vod__c</text>
        <text x="538" y="334" text-anchor="middle" fill="#4A5568" font-size="9">On-label / Off-label / AE flag</text>
        <text x="538" y="347" text-anchor="middle" fill="#4A5568" font-size="9">Triggers SRL retrieval from Vault</text>
        <!-- MSL Call -->
        <rect x="648" y="283" width="300" height="72" rx="6" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="798" y="304" text-anchor="middle" fill="#0B6060" font-size="12" font-weight="700">MSL Call Report</text>
        <text x="798" y="319" text-anchor="middle" fill="#1A5050" font-size="8.5" font-family="monospace">Call_vod__c (Medical record type)</text>
        <text x="798" y="334" text-anchor="middle" fill="#4A5568" font-size="9">Non-promotional · No sample drop</text>
        <text x="798" y="347" text-anchor="middle" fill="#4A5568" font-size="9">Scientific topics · Insights captured</text>
        ...
        <!-- Medical Insight -->
        <rect x="650" y="387" width="148" height="60" rx="5" fill="#F8FAFC" stroke="#99E6E6" stroke-width="1"/>
        ...
        <!-- Event Attendance -->
        <rect x="808" y="387" width="145" height="60" rx="5" fill="#F8FAFC" stroke="#99E6E6" stroke-width="1"/>
        ...
        <line x1="440" y1="147" x2="538" y2="283" stroke="#99E6E6" stroke-width="1" stroke-dasharray="3,3" marker-end="url(#arrm)"/>
        <!-- Contact → MSL Call -->
        <line x1="428" y1="111" x2="648" y2="319" stroke="#99E6E6" stroke-width="1" stroke-dasharray="3,3" marker-end="url(#arrm)"/>
        <!-- CLM → Call Report -->
        ...
        <line x1="798" y1="251" x2="798" y2="283" stroke="#99E6E6" stroke-width="1" stroke-dasharray="3,3" marker-end="url(#arrm)"/>
        ...
        <line x1="750" y1="355" x2="724" y2="387" stroke="#99E6E6" stroke-width="1" marker-end="url(#arrm)"/>
        <line x1="820" y1="355" x2="860" y2="387" stroke="#99E6E6" stroke-width="1" marker-end="url(#arrm)"/>
      </svg>
    </div>
  ...
  <figure class="vis-embed" aria-label="Commercial Rep Daily Workflow">
    ...
    <div class="vis-inner" style="padding:20px;">
      <svg viewBox="0 0 960 320" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:700px;display:block;">
        ...
        <!-- Phase columns -->
        <!-- PRE-CALL (x=0–240) -->
        <rect x="0" y="0" width="240" height="30" fill="#EBF0F8"/>
        <text x="120" y="20" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700" letter-spacing="1">PRE-CALL</text>
        <!-- CALL EXECUTION (x=240–560) -->
        <rect x="240" y="0" width="320" height="30" fill="#EBF0F8"/>
        ...
        <!-- Object labels -->
        <rect x="10" y="55" width="220" height="52" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1"/>
        <text x="120" y="74" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">Cycle Plan Account</text>
        <text x="120" y="89" text-anchor="middle" fill="#4A5568" font-size="9">Prioritised HCP list · Target call</text>
        <text x="120" y="100" text-anchor="middle" fill="#4A5568" font-size="9">count · Last-call date visible</text>

        <rect x="250" y="55" width="145" height="52" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1"/>
        <text x="322" y="74" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">Call Report</text>
        <text x="322" y="89" text-anchor="middle" fill="#4A5568" font-size="9">New record created</text>
        <text x="322" y="100" text-anchor="middle" fill="#4A5568" font-size="9">Status = Draft</text>

        <rect x="405" y="55" width="145" height="52" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1"/>
        <text x="477" y="74" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">CLM Presentation</text>
        <text x="477" y="89" text-anchor="middle" fill="#4A5568" font-size="9">iPad visual aid launched</text>
        <text x="477" y="100" text-anchor="middle" fill="#4A5568" font-size="9">Slide timing tracked</text>

        <rect x="570" y="55" width="180" height="52" rx="5" fill="#0F1835" stroke="#1B3A6B" stroke-width="1"/>
        <text x="660" y="74" text-anchor="middle" fill="#0B6B6B" font-size="11" font-weight="700">Call Report → Submit</text>
        <text x="660" y="89" text-anchor="middle" fill="#4A5568" font-size="9">Status: Draft → Submitted</text>
        <text x="660" y="100" text-anchor="middle" fill="#4A5568" font-size="9">Locked · PDMA receipt sent</text>
        ...
        <text x="860" y="89" text-anchor="middle" fill="#4A5568" font-size="9">Call rate · Reach · Freq.</text>
        <text x="860" y="100" text-anchor="middle" fill="#4A5568" font-size="9">Sample utilisation rate</text>

        <!-- ROW 2: Rep Action (y=115–175) -->
        <rect x="0" y="115" width="960" height="16" fill="#F8FAFC"/>
        ...
        <text x="120" y="153" text-anchor="middle" fill="#1B3A6B" font-size="10.5">Opens Veeva CRM → reviews</text>
        <text x="120" y="167" text-anchor="middle" fill="#1B3A6B" font-size="10.5">today's call list → sets route</text>
        <text x="120" y="178" text-anchor="middle" fill="#4A5568" font-size="9">Sets pre-call objective</text>

        <rect x="250" y="135" width="300" height="48" rx="5" fill="#0D0D0D" stroke="#21262D" stroke-width="1"/>
        <text x="400" y="153" text-anchor="middle" fill="#1B3A6B" font-size="10.5">Launches CLM → details product → captures</text>
        <text x="400" y="167" text-anchor="middle" fill="#1B3A6B" font-size="10.5">key message reaction → drops sample</text>
        <text x="400" y="178" text-anchor="middle" fill="#4A5568" font-size="9">Captures HCP e-signature for PDMA compliance</text>

        <rect x="570" y="135" width="180" height="48" rx="5" fill="#0D0D0D" stroke="#21262D" stroke-width="1"/>
        <text x="660" y="153" text-anchor="middle" fill="#1B3A6B" font-size="10.5">Completes call report →</text>
        <text x="660" y="167" text-anchor="middle" fill="#1B3A6B" font-size="10.5">adds next call objective</text>
        <text x="660" y="178" text-anchor="middle" fill="#4A5568" font-size="9">Submits → triggers AE check</text>

        <rect x="770" y="135" width="180" height="48" rx="5" fill="#0D0D0D" stroke="#21262D" stroke-width="1"/>
        <text x="860" y="153" text-anchor="middle" fill="#1B3A6B" font-size="10.5">Views personal dashboard</text>
        <text x="860" y="167" text-anchor="middle" fill="#1B3A6B" font-size="10.5">→ adjusts next cycle plan</text>
        <text x="860" y="178" text-anchor="middle" fill="#4A5568" font-size="9">Manager views team rollup</text>

        <!-- ROW 3: System Action (y=190–260) -->
        <rect x="0" y="190" width="960" height="16" fill="#F8FAFC"/>
  ...
  <figure class="vis-embed" aria-label="MSL Scientific Exchange Workflow">
    ...
    <div class="vis-inner" style="padding:20px;">
      <svg viewBox="0 0 960 280" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:700px;display:block;">
        <rect width="960" height="280" fill="#F8FAFC"/>
        <!-- Phase columns -->
        <rect x="0" y="0" width="240" height="30" fill="#E0F7F7"/>
        <text x="120" y="20" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700" letter-spacing="1">PRE-MEETING</text>
        <rect x="240" y="0" width="320" height="30" fill="#F8FAFC"/>
        <text x="400" y="20" text-anchor="middle" fill="#1A7A7A" font-size="11" font-weight="700" letter-spacing="1">SCIENTIFIC EXCHANGE</text>
        <rect x="560" y="0" width="200" height="30" fill="#E0F7F7"/>
        <text x="660" y="20" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700" letter-spacing="1">DOCUMENTATION</text>
        ...
        <!-- Row 1: Objects -->
        <rect x="0" y="30" width="960" height="16" fill="#F8FAFC"/>
        <text x="480" y="42" text-anchor="middle" fill="#4A5568" font-size="8" font-weight="600" letter-spacing="1">CRM OBJECTS USED</text>

        <rect x="10" y="50" width="220" height="52" rx="5" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1"/>
        <text x="120" y="69" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">Account + KOL Profile</text>
        <text x="120" y="84" text-anchor="middle" fill="#4A5568" font-size="9">Past scientific exchanges · Tier</text>
        <text x="120" y="95" text-anchor="middle" fill="#4A5568" font-size="9">Publications · Advisory board history</text>

        <rect x="250" y="50" width="145" height="52" rx="5" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1"/>
        <text x="322" y="69" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">MSL Call Report</text>
        <text x="322" y="84" text-anchor="middle" fill="#4A5568" font-size="9">Call_vod__c (Medical RT)</text>
        <text x="322" y="95" text-anchor="middle" fill="#4A5568" font-size="9">Non-promotional fields only</text>

        <rect x="405" y="50" width="145" height="52" rx="5" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1"/>
        <text x="477" y="69" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">Medical Inquiry</text>
        <text x="477" y="84" text-anchor="middle" fill="#4A5568" font-size="9">If HCP raises question</text>
        <text x="477" y="95" text-anchor="middle" fill="#4A5568" font-size="9">Off-label → SRL triggered</text>

        <rect x="570" y="50" width="180" height="52" rx="5" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1"/>
        <text x="660" y="69" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">Insight_vod__c</text>
        <text x="660" y="84" text-anchor="middle" fill="#4A5568" font-size="9">Scientific observation logged</text>
        <text x="660" y="95" text-anchor="middle" fill="#4A5568" font-size="9">Category · Priority · Area</text>

        <rect x="770" y="50" width="180" height="52" rx="5" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1"/>
        <text x="860" y="69" text-anchor="middle" fill="#0B6060" font-size="11" font-weight="700">Survey / Next Action</text>
        <text x="860" y="84" text-anchor="middle" fill="#4A5568" font-size="9">IIS form if applicable</text>
        <text x="860" y="95" text-anchor="middle" fill="#4A5568" font-size="9">Advisory board nomination</text>

        <!-- Row 2: MSL Action -->
        <rect x="0" y="110" width="960" height="16" fill="#F8FAFC"/>
        <text x="480" y="122" text-anchor="middle" fill="#4A5568" font-size="8" font-weight="600" letter-spacing="1">MSL ACTION</text>

        <rect x="10" y="130" width="220" height="48" rx="5" fill="#F8FAFC" stroke="#99E6E6" stroke-width="1"/>
        <text x="120" y="148" text-anchor="middle" fill="#2D3748" font-size="10">Reviews KOL account: prior calls,</text>
        <text x="120" y="162" text-anchor="middle" fill="#2D3748" font-size="10">publications, insights history</text>
        <text x="120" y="174" text-anchor="middle" fill="#4A5568" font-size="9">Pulls scientific deck from Vault Medical</text>

        <rect x="250" y="130" width="300" height="48" rx="5" fill="#F8FAFC" stroke="#99E6E6" stroke-width="1"/>
        <text x="400" y="148" text-anchor="middle" fill="#2D3748" font-size="10">Opens MSL Call → on-label scientific discussion</text>
        <text x="400" y="162" text-anchor="middle" fill="#2D3748" font-size="10">→ if unsolicited off-label → opens Med Inquiry</text>
        <text x="400" y="174" text-anchor="middle" fill="#4A5568" font-size="9">Cannot show promotional CLM content — system blocked</text>

        <rect x="570" y="130" width="180" height="48" rx="5" fill="#F8FAFC" stroke="#99E6E6" stroke-width="1"/>
        <text x="660" y="148" text-anchor="middle" fill="#2D3748" font-size="10">Submits MSL call report →</text>
        <text x="660" y="162" text-anchor="middle" fill="#2D3748" font-size="10">logs insight categories</text>
        <text x="660" y="174" text-anchor="middle" fill="#4A5568" font-size="9">Record invisible to commercial reps</text>

        <rect x="770" y="130" width="180" height="48" rx="5" fill="#F8FAFC" stroke="#99E6E6" stroke-width="1"/>
        <text x="860" y="148" text-anchor="middle" fill="#2D3748" font-size="10">SRL sent via Vault Medical</text>
        <text x="860" y="162" text-anchor="middle" fill="#2D3748" font-size="10">if Med Inquiry was raised</text>
        <text x="860" y="174" text-anchor="middle" fill="#4A5568" font-size="9">Insights reviewed by MSL Director</text>

        <!-- Row 3: Compliance guardrails -->
        <rect x="0" y="186" width="960" height="16" fill="#F8FAFC"/>
        ...
        <rect x="10" y="206" width="220" height="34" rx="4" fill="#FAFAF8" stroke="#FDE68A" stroke-width="1"/>
        <text x="120" y="221" text-anchor="middle" fill="#5A4A10" font-size="9">✓ No commercial call list access</text>
        <text x="120" y="234" text-anchor="middle" fill="#5A4A10" font-size="9">✓ No prescribing data visible</text>
        <rect x="250" y="206" width="300" height="34" rx="4" fill="#FAFAF8" stroke="#FDE68A" stroke-width="1"/>
        <text x="400" y="221" text-anchor="middle" fill="#5A4A10" font-size="9">✓ No sample drop field · ✓ No CLM promotional content</text>
        <text x="400" y="234" text-anchor="middle" fill="#5A4A10" font-size="9">✓ Off-label only on unsolicited inbound — validation enforced</text>
        <rect x="570" y="206" width="380" height="34" rx="4" fill="#FAFAF8" stroke="#FDE68A" stroke-width="1"/>
        <text x="760" y="221" text-anchor="middle" fill="#5A4A10" font-size="9">✓ MSL IC plan cannot be tied to Rx volume · ✓ Insight data not accessible to Sales</text>
        <text x="760" y="234" text-anchor="middle" fill="#5A4A10" font-size="9">✓ All records 21 CFR Part 11 compliant · timestamped · immutable</text>
      </svg>
    </div>
  ...
  <figure class="vis-embed" aria-label="PDMA Sample Management Flow">
    ...
    <div class="vis-inner" style="padding:24px 20px;">
      <svg viewBox="0 0 960 200" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:700px;display:block;">
        <rect width="960" height="200" fill="#F8FAFC"/>
        <!-- 8 steps horizontal -->
        ...
        <rect x="4" y="30" width="95" height="80" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="51" y="56" text-anchor="middle" fill="#4A7ABF" font-size="18">⊞</text>
        <text x="51" y="73" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">Sample Lot</text>
        <text x="51" y="86" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">Received</text>
        <text x="51" y="103" text-anchor="middle" fill="#4A5568" font-size="8">Lot # · Expiry</text>

        <!-- 2: Territory Assignment -->
        <rect x="111" y="30" width="95" height="80" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="158" y="56" text-anchor="middle" fill="#4A7ABF" font-size="18">◎</text>
        <text x="158" y="73" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">Territory</text>
        <text x="158" y="86" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">Allocation</text>
        <text x="158" y="103" text-anchor="middle" fill="#4A5568" font-size="8">Qty per rep</text>

        <!-- 3: Rep Inventory -->
        <rect x="218" y="30" width="95" height="80" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="265" y="56" text-anchor="middle" fill="#4A7ABF" font-size="18">≡</text>
        <text x="265" y="73" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">Rep Inventory</text>
        <text x="265" y="86" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">In CRM</text>
        <text x="265" y="103" text-anchor="middle" fill="#4A5568" font-size="8">Live balance</text>

        <!-- 4: HCP Sample Request -->
        <rect x="325" y="30" width="95" height="80" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="372" y="56" text-anchor="middle" fill="#4A7ABF" font-size="18">✉</text>
        <text x="372" y="73" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">HCP Sample</text>
        <text x="372" y="86" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">Request</text>
        ...
        <rect x="646" y="30" width="95" height="80" rx="5" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="693" y="56" text-anchor="middle" fill="#4A7ABF" font-size="18">↓</text>
        <text x="693" y="73" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">Lot Qty</text>
        <text x="693" y="86" text-anchor="middle" fill="#0B6B6B" font-size="9.5" font-weight="700">Decremented</text>
        ...
        <!-- Connecting arrows -->
        <line x1="99" y1="70" x2="111" y2="70" stroke="#CBD5E1" stroke-width="1.5" marker-end="url(#arrd)"/>
        <line x1="206" y1="70" x2="218" y2="70" stroke="#CBD5E1" stroke-width="1.5" marker-end="url(#arrd)"/>
        <line x1="313" y1="70" x2="325" y2="70" stroke="#CBD5E1" stroke-width="1.5" marker-end="url(#arrd)"/>
        <line x1="420" y1="70" x2="432" y2="70" stroke="#CBD5E1" stroke-width="1.5" marker-end="url(#arrd)"/>
        ...
        <line x1="741" y1="70" x2="753" y2="70" stroke="#CBD5E1" stroke-width="1.5" marker-end="url(#arrd)"/>
        <line x1="848" y1="70" x2="860" y2="70" stroke="#CBD5E1" stroke-width="1.5" marker-end="url(#arrd)"/>

        <!-- Step numbers -->
        <circle cx="51" cy="30" r="9" fill="#1B3A6B"/>
        <text x="51" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">1</text>
        <circle cx="158" cy="30" r="9" fill="#1B3A6B"/>
        <text x="158" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">2</text>
        <circle cx="265" cy="30" r="9" fill="#1B3A6B"/>
        <text x="265" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">3</text>
        <circle cx="372" cy="30" r="9" fill="#1B3A6B"/>
        <text x="372" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">4</text>
        <circle cx="479" cy="30" r="9" fill="#4A6A10"/>
        <text x="479" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">5</text>
        <circle cx="586" cy="30" r="9" fill="#4A6010"/>
        <text x="586" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">6</text>
        <circle cx="693" cy="30" r="9" fill="#1B3A6B"/>
        <text x="693" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">7</text>
        <circle cx="800" cy="30" r="9" fill="#4A2080"/>
        <text x="800" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">8</text>
        <circle cx="907" cy="30" r="9" fill="#7A3000"/>
        <text x="907" y="34" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">9</text>
  ...
  <figure class="vis-embed" aria-label="CLM Closed-Loop Marketing Cycle">
    ...
    <div class="vis-inner" style="padding:28px 20px;">
      <svg viewBox="0 0 960 380" xmlns="http://www.w3.org/2000/svg" style="font-family:Inter,sans-serif;min-width:640px;display:block;">
        ...
        <rect x="415" y="10" width="130" height="62" rx="7" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="480" y="32" text-anchor="middle" fill="#4A9AEA" font-size="9.5" font-weight="700">① Brand Team</text>
        <text x="480" y="46" text-anchor="middle" fill="#0B6B6B" font-size="10" font-weight="600">Creates Content</text>
        ...
        <text x="480" y="14" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">1</text>
        ...
        <text x="750" y="46" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">2</text>

        <!-- Node 3: 90° (right) cx=480+165=645, cy=190 -->
        <rect x="800" y="160" width="148" height="62" rx="7" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="874" y="182" text-anchor="middle" fill="#4A9AEA" font-size="9.5" font-weight="700">③ Auto-Publish</text>
        <text x="874" y="196" text-anchor="middle" fill="#0B6B6B" font-size="10" font-weight="600">CRM Content Library</text>
        ...
        <text x="948" y="164" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">3</text>

        <!-- Node 4: 135° (bottom-right) cx=480+117=597, cy=190+117=307 -->
        <rect x="622" y="295" width="130" height="62" rx="7" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="687" y="317" text-anchor="middle" fill="#4A9AEA" font-size="9.5" font-weight="700">④ Rep Presents</text>
        <text x="687" y="331" text-anchor="middle" fill="#0B6B6B" font-size="10" font-weight="600">iPad CLM Session</text>
        ...
        <text x="752" y="361" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">4</text>

        <!-- Node 5: 180° (bottom) cx=480, cy=190+165=355 -->
        <rect x="415" y="310" width="130" height="62" rx="7" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="480" y="332" text-anchor="middle" fill="#0B6060" font-size="9.5" font-weight="700">⑤ Engagement</text>
        <text x="480" y="346" text-anchor="middle" fill="#0B6060" font-size="10" font-weight="600">Data Captured</text>
        ...
        <text x="480" y="376" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">5</text>

        <!-- Node 6: 225° (bottom-left) cx=480-117=363, cy=190+117=307 -->
        <rect x="212" y="295" width="130" height="62" rx="7" fill="#E0F7F7" stroke="#99E6E6" stroke-width="1.5"/>
        <text x="277" y="317" text-anchor="middle" fill="#0B6060" font-size="9.5" font-weight="700">⑥ Analytics</text>
        <text x="277" y="331" text-anchor="middle" fill="#0B6060" font-size="10" font-weight="600">SFE Dashboard</text>
        ...
        <text x="212" y="361" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">6</text>
        ...
        <text x="14" y="164" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">7</text>

        <!-- Node 8: 315° (top-left) cx=480-117=363, cy=190-117=73 -->
        <rect x="212" y="42" width="130" height="62" rx="7" fill="#EBF0F8" stroke="#1B3A6B" stroke-width="1.5"/>
        <text x="277" y="64" text-anchor="middle" fill="#4A9AEA" font-size="9.5" font-weight="700">⑧ Content Update</text>
        <text x="277" y="78" text-anchor="middle" fill="#0B6B6B" font-size="10" font-weight="600">Re-submit to MLR</text>
        ...
        <text x="212" y="46" text-anchor="middle" fill="#1B3A6B" font-size="9" font-weight="700">8</text>
        ...
        <line x1="687" y1="357" x2="545" y2="370" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#arrm)"/>
        <line x1="415" y1="370" x2="277" y2="357" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#arrm)"/>
        <line x1="212" y1="312" x2="162" y2="222" stroke="#99E6E6" stroke-width="1.5" marker-end="url(#arrm)"/>
...
<div class="ch-divider ch-veeva"></div>
<div class="chapter" id="ch-vault-crm">
{CH13_VAULT_CRM}
  {nav_ch_vault_crm}
</div>
...
<div class="chapter" id="glossary">
  ...
  <dl class="glossary" id="glossDL">
    ...
    <dd>Physician Payments Sunshine Act (42 USC §1320a-7h). All transfers of value ≥10 to physicians and teaching hospitals must be reported to CMS annually (filing deadline: March 31; published: June 30). Extended (2022) to include PAs, NPs, CNSs, CRNAs, CNMs.</dd>
    ...
    <dt id="g-amp">AMP — Average Manufacturer Price</dt>
    <dd>The average price manufacturers receive from wholesalers and retail pharmacies for drugs distributed in the US, net of chargebacks, cash discounts, and certain fees. Reported quarterly to CMS. AMP is the basis for: Medicaid base rebate calculation, 340B ceiling price (AMP × 23.1% discount), and the Federal Supply Schedule Non-FAMP calculation. <em>→ See: Model N, Government Pricing (Ch 5)</em></dd>

    <dt id="g-anaplan">Anaplan</dt>
    <dd>Cloud-based connected planning platform used by pharmaceutical market access, finance, and commercial teams. Anaplan’s in-memory calculation engine enables real-time scenario modelling across gross-to-net planning, formulary contracting strategy, brand revenue forecasting, LOE planning, and quota setting. <em>→ See: Market Access (Ch 5), Model N</em></dd>

    <dt id="g-best-price">Best Price</dt>
    <dd>The lowest price a manufacturer charges any US customer in any pricing arrangement. Manufacturers report Best Price quarterly to CMS as part of the MDRP. The Medicaid base rebate equals the greater of 23.1% of AMP or the AMP–Best Price difference. <em>→ See: Model N, AMP, MDRP (Ch 5)</em></dd>

    <dt id="g-btd">BTD — Breakthrough Therapy Designation</dt>
    <dd>FDA designation granted when preliminary clinical evidence shows a drug may offer substantial improvement over available therapy on at least one clinically significant endpoint for a serious condition. Provides intensive FDA guidance across all development aspects, cross-disciplinary rolling review, and organisational commitment of senior FDA staff. <em>→ See: Priority Review, Fast Track Designation, R&amp;D Regulatory (Ch 2)</em></dd>

    <dt id="g-ctd">CTD / eCTD — Common Technical Document</dt>
    <dd>The globally harmonised five-module format for regulatory submissions (NDA, BLA, MAA) developed under ICH M4. The eCTD is the required electronic submission format for FDA, using a structured XML backbone enabling lifecycle management of submission sequences. A typical NDA runs 100,000–300,000 pages equivalent. <em>→ See: NDA, Veeva RIM, R&amp;D Regulatory (Ch 2)</em></dd>

    <dt id="g-etmf">eTMF — Electronic Trial Master File</dt>
    <dd>The electronic system managing the Trial Master File — the collection of essential documents that permits evaluation of a clinical trial’s conduct and data quality, as defined by ICH E6(R2). Veeva Vault eTMF uses the DIA TMF Reference Model to define expected documents, track completeness in real time, and generate inspection-ready dossiers. <em>→ See: TMF, Veeva RIM, R&amp;D Regulatory (Ch 2)</em></dd>

    <dt id="g-formulary-tier">Formulary / Formulary Tier</dt>
    <dd>The list of drugs covered by a health plan and their cost-sharing tier: <strong>Tier 1</strong> (generic, lowest co-pay), <strong>Tier 2</strong> (preferred brand), <strong>Tier 3</strong> (non-preferred brand), <strong>Tier 4</strong> (specialty, highest co-insurance). Preferred tier placement (Tier 2 vs. Tier 3) can drive 3–5× prescription volume differences. <em>→ See: PBM, Market Access (Ch 5)</em></dd>

    <dt id="g-gtm">Gross-to-Net (GTN) Waterfall</dt>
    <dd>The reconciliation between a drug’s WAC (list price) and the net revenue actually realised per unit after all contractual deductions. Major waterfall components: managed care rebates (30–60%+ of WAC for competitive categories), Medicaid statutory rebates, 340B discounts, chargebacks, patient co-pay assistance, distribution fees. GTN ratios have increased from ~15% in 2005 to 40–60%+ for many branded drugs by 2025. <em>→ See: WAC, Rebate, Model N (Ch 5)</em></dd>

    <dt id="g-icer">ICER — Incremental Cost-Effectiveness Ratio</dt>
    <dd>The additional cost per Quality-Adjusted Life Year (QALY) gained by a new therapy versus the current standard of care. Published by ICER (Institute for Clinical and Economic Review), whose independent assessments directly influence PBM formulary negotiations. Commonly cited US willingness-to-pay threshold: $100,000–$150,000 per QALY. <em>→ See: QALY, BIM, HEOR (Ch 5)</em></dd>

    <dt id="g-ira">IRA — Inflation Reduction Act (2022)</dt>
    <dd>Landmark US legislation with three major pharmaceutical pricing provisions: (1) Medicare Drug Price Negotiation — CMS can directly negotiate prices for high-expenditure small-molecule drugs (after 9 years) and biologics (after 13 years); first negotiated prices effective 2026. (2) Inflation Rebate Penalty — manufacturers must pay rebates to CMS if drug prices increase faster than CPI-U. (3) Part D Redesign — $2,000 OOP maximum for Medicare beneficiaries in 2025. <em>→ See: Medicare, WAC, Market Access (Ch 5)</em></dd>

    <dt id="g-loe">LOE — Loss of Exclusivity</dt>
    <dd>The point at which a branded drug’s patent protection and/or regulatory exclusivity expires, enabling generic or biosimilar market entry. Brands typically lose 80–90% of volume within 12 months of first generic entry as PBMs switch formulary coverage. LOE planning encompasses: authorised generic strategy, patient assistance wind-down, contracting transition, and lifecycle management. <em>→ See: Anaplan, Market Access (Ch 5)</em></dd>

    <dt id="g-mdrp">MDRP — Medicaid Drug Rebate Programme</dt>
    <dd>The federal programme requiring pharmaceutical manufacturers to pay rebates to state Medicaid programmes in exchange for Medicaid coverage of their drugs. The federal base rebate is the greater of 23.1% of AMP or the AMP–Best Price difference. Quarterly CMS reporting of AMP and Best Price is the operational backbone of MDRP compliance, managed through Model N. <em>→ See: AMP, Best Price, Model N (Ch 5)</em></dd>

    <dt id="g-model-n">Model N</dt>
    <dd>Enterprise revenue management platform purpose-built for pharmaceutical government pricing compliance, contract management, and rebate administration. Core modules: Government Pricing (automated AMP, Best Price, Non-FAMP, ASP calculation and CMS submission), Contract Management (chargeback processing), Rebate Management, 340B Programme Management, and Gross-to-Net Analytics. Model N creates an audit-ready, 21 CFR Part 11-compliant record of all government pricing calculations. <em>→ See: AMP, Best Price, Chargeback, 340B (Ch 5)</em></dd>

    <dt id="g-qaly">QALY — Quality-Adjusted Life Year</dt>
    <dd>A measure of disease burden combining quantity and quality of life. One QALY = one year of perfect health. QALYs are the standard unit in cost-effectiveness analysis — the ICER (cost per QALY gained) is the primary metric payers and HTA bodies use to evaluate whether a drug’s price is justified by its clinical benefit. Widely used by UK’s NICE, EU HTA bodies, and increasingly by US private payers. <em>→ See: ICER, BIM, HEOR (Ch 5)</em></dd>

    <dt id="g-rebate">Rebate</dt>
    <dd>A retrospective discount paid by a manufacturer to a PBM, health plan, or government programme based on formulary placement, utilisation performance, or statutory obligation. Commercial managed care rebates secure preferred formulary tier access and are the primary driver of gross-to-net deductions. Medicaid rebates are statutory under the MDRP. <em>→ See: Gross-to-Net, MDRP, Model N (Ch 5)</em></dd>

    <dt id="g-veeva-rim">RIM — Veeva Vault RIM</dt>
    <dd>Veeva’s regulatory information management platform managing the complete regulatory record: NDA/BLA/MAA submissions (eCTD authoring, publishing, ESG delivery), global registration database, health authority correspondence, labelling lifecycle, and regulatory commitment tracking. RIM integrates with Vault eTMF and Vault PromoMats. <em>→ See: eTMF, CTD, R&amp;D Regulatory (Ch 2)</em></dd>

    <dt id="g-susar">SUSAR — Suspected Unexpected Serious Adverse Reaction</dt>
    <dd>A serious adverse reaction that is both unexpected (not described in the current Investigator’s Brochure) and reasonably suspected to be causally related to an investigational drug. Fatal or life-threatening SUSARs must be reported to FDA within 7 calendar days; all other SUSARs within 15 calendar days. <em>→ See: DSUR, IND, R&amp;D Regulatory (Ch 2)</em></dd>

    <dt id="g-wac">WAC — Wholesale Acquisition Cost</dt>
    <dd>The manufacturer’s published list price to wholesalers — the anchor price for all downstream pharmaceutical pricing calculations. No major payer pays WAC; every channel receives discounts or rebates below list. Post-IRA 2022, WAC increases for Medicare drugs exceeding CPI-U trigger mandatory inflation rebates to CMS. <em>→ See: Gross-to-Net, Rebate, AMP, Market Access (Ch 5)</em></dd>

    <dt id="g-340b">340B Drug Pricing Programme</dt>
    <dd>Federal programme requiring manufacturers to sell drugs to covered entities (safety-net hospitals, Federally Qualified Health Centres, Ryan White HIV/AIDS clinics) at ceiling prices of approximately 23.1% of AMP. 340B has grown from ~$1B in 2010 to ~$54B in 2023 in drug purchases, making it one of the most consequential and contested programmes in pharmaceutical policy. <em>→ See: AMP, Best Price, Model N (Ch 5)</em></dd>
...
<footer class="book-footer">
  <div class="book-footer-inner">
    <div class="book-footer-title">Pharma R&amp;D, Commercial, Medical Affairs &amp; Market Access — The Complete Visual Guide</div>
    <div class="book-footer-author">Deepak Kumar — Pharma &amp; MedTech Consultant</div>
    <div class="book-footer-rule"></div>
    <div>14 Chapters · SVG Process Diagrams · Interactive Glossary · Veeva Systems · Model N · Anaplan</div>
    <div>FDA &amp; ICH Regulatory Frameworks · GxP · 21 CFR · AKS · Sunshine Act · PDMA · MDRP · 340B · IRA 2022 · PhRMA Code</div>
    <div style="margin-top:12px;opacity:.4;">May 2026 · All regulatory references reflect US FDA frameworks as of May 2026</div>
    <div class="book-footer-rule"></div>
    <div class="book-footer-copyright">
      Copyright &copy; 2026 Deepak Kumar. All rights reserved.<br>
      This guide is published for educational and professional reference purposes.<br>
      No part of this work may be reproduced, distributed, or transmitted in any form without prior written permission from the author.<br>
      <span style="opacity:.6;">Veeva&reg; is a registered trademark of Veeva Systems Inc. FDA&reg; is a registered trademark of the US Food &amp; Drug Administration.</span>
    </div>
  </div>
</footer>
...
function toggleControls() {{
  const rc = document.getElementById('reader-controls');
  rc.classList.toggle('collapsed');
  const btn = document.getElementById('ctrl-toggle');
  if (btn) btn.textContent = rc.classList.contains('collapsed') ? '›' : '‹';
  try {{ localStorage.setItem('pharma-ctrl-collapsed', rc.classList.contains('collapsed')); }} catch(e) {{}}
}}
(function () {{
  try {{
    if (localStorage.getItem('pharma-ctrl-collapsed') === 'true') {{
      const rc = document.getElementById('reader-controls');
      if (rc) {{
        rc.classList.add('collapsed');
        const btn = document.getElementById('ctrl-toggle');
...
# ── Post-process: fix all dark SVG fills in final HTML
import re as _re

def _fix_svgs(html):
    import colorsys as _cs, re as _re
    ...
    def _to_ocean_shape(hex_col):
        rgb = _parse(hex_col)
        if not rgb: return hex_col
        r, g, b = rgb
        lv = _lum(r, g, b)
        if lv >= 0.55: return hex_col
        h, l, s = _cs.rgb_to_hls(r, g, b)
        if lv < 0.04 or s < 0.12: return '#EAF6F6'
        if   h < 0.05 or h >= 0.90: return '#FFE8E4'
        elif h < 0.11:               return '#FFF0E8'
        elif h < 0.19:               return '#FDF0D8'
        elif h < 0.46:               return '#D6F0F0'
        elif h < 0.58:               return '#D0EEEE'
        elif h < 0.72:               return '#DCECf8'
        else:                        return '#E0E8F5'

    def _to_ocean_text(hex_col):
        rgb = _parse(hex_col)
        if not rgb: return hex_col
        r, g, b = rgb
        lv = _lum(r, g, b)
        if lv < 0.35: return hex_col
        h, l, s = _cs.rgb_to_hls(r, g, b)
        if s < 0.15:                     return '#0A3D62'
        if   h < 0.05 or h >= 0.90:     return '#B83224'
        elif h < 0.19:                   return '#9A6412'
        elif h < 0.46:                   return '#0A6B6B'
        elif h < 0.58:                   return '#0A5555'
        elif h < 0.72:                   return '#0A3D62'
        else:                            return '#2D3D6B'
    ...
    def _fix_block(svg):
        ...
        def _fix_shape(m):
            el = m.group(0)
            for fill in _re.findall(r'fill="(#[0-9a-fA-F]{6})"', el):
                new = _to_ocean_shape(fill)
                if new != fill: el = el.replace(f'fill="{fill}"', f'fill="{new}"', 1)
            return el
        t = _re.sub(r'<(?:rect|circle|ellipse)\b[^>]*(?:/>|>)', _fix_shape, t, flags=_re.DOTALL)
        def _fix_poly(m):
            el = m.group(0)
            for fill in _re.findall(r'fill="(#[0-9a-fA-F]{6})"', el):
                new = _to_ocean_shape(fill)
                if new != fill: el = el.replace(f'fill="{fill}"', f'fill="{new}"', 1)
            return el
        t = _re.sub(r'<(?:polygon|path)\b[^>]*(?:/>|>)', _fix_poly, t, flags=_re.DOTALL)
        def _fix_text(m):
            el = m.group(0)
            for fill in _re.findall(r'fill="(#[0-9a-fA-F]{6})"', el):
                new = _to_ocean_text(fill)
                if new != fill: el = el.replace(f'fill="{fill}"', f'fill="{new}"', 1)
            el = el.replace('fill="white"',   'fill="#0A3D62"')
            el = el.replace('fill="#FFFFFF"', 'fill="#0A3D62"')
            el = el.replace('fill="#ffffff"', 'fill="#0A3D62"')
            return el
        t = _re.sub(r'<text\b[^>]*>.*?</text>', _fix_text, t, flags=_re.DOTALL)
        t = _re.sub(r'<tspan\b[^>]*>', _fix_text, t, flags=_re.DOTALL)
        def _fix_stroke(m):
            el = m.group(0)
            for stroke in _re.findall(r'stroke="(#[0-9a-fA-F]{6})"', el):
                rgb = _parse(stroke)
                if not rgb: continue
                if _lum(*rgb) < 0.12: el = el.replace(f'stroke="{stroke}"', 'stroke="#80C8C8"', 1)
            return el
        t = _re.sub(r'<(?:rect|circle|ellipse|line|path|polyline|polygon)\b[^>]*(?:/>|>)',
                    _fix_stroke, t, flags=_re.DOTALL)
        t = _re.sub(r'stop-color="(#[0-9a-fA-F]{6})"',
            lambda m: f'stop-color="{_to_ocean_shape(m.group(1))}"', t)
        for dark_bg in ['#0D1117','#161B22','#0F172A','#1C2526','#0D0D0D']:
            t = t.replace(f'background:{dark_bg}',  'background:#EAF6F6')
            t = t.replace(f'background: {dark_bg}', 'background:#EAF6F6')
        return t

    parts, pos = [], 0
    for m in _re.finditer(r'<svg\b', html):
        end = html.find('</svg>', m.start())
        if end < 0: continue
        end += 6
        parts.append(html[pos:m.start()])
        parts.append(_fix_block(html[m.start():end]))
        pos = end
